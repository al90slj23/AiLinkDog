import { g as et, s as tt } from './chunk-RZ5BOZE2-Dl5yENMm.js';
import {
  _ as f,
  j as st,
  e as F,
            ...
            case 2:
              if (
                ...
                (ve = this.performAction.apply(
                  M,
                  [t, ze, oe, O.yy, S[1], C, e].concat(Je),
                )),
                typeof ve < 'u')
              )
                return ve;
    ...
    ((U = class {
          ...
          l === void 0 &&
            ...
            this.classes.forEach((r) => {
              r.cssClasses.includes(u) &&
                r.styles.push(...a.flatMap((o) => o.split(',')));
            });
        }
      }
      setTooltip(i, a) {
      ...
      getData() {
        ...
        for (const o of this.notes) {
          ...
          i.push(A);
          const g =
            ((r = this.classes.get(o.class)) == null ? void 0 : r.id) ?? '';
          if (g) {
            const k = {
              id: `edgeNote${l}`,
              start: o.id,
        ...
        for (const o of this.relations) {
          l++;
          const A = {
            id: ot(o.id1, o.id2, { prefix: 'id', counter: l }),
            start: o.id1,
            end: o.id2,
            type: 'normal',
            label: o.title,
            ...
            startLabelRight:
              o.relationTitle1 === 'none' ? '' : o.relationTitle1,
...
`,
  ...
  Tt = { getClasses: ft, draw: gt, getDir: At };
export { Et as C, Tt as a, bt as c, yt as s };
