...
import { g as lt, s as ot } from './chunk-RZ5BOZE2-Dl5yENMm.js';
import { c as ct } from './channel-BL7ad_n3.js';
    ...
    ((Pe = class {
      constructor() {
        (this.vertexCounter = 0),
          ...
          (this.funs = []),
          (this.setAccTitle = H1),
          (this.setAccDescription = q1),
          (this.setDiagramTitle = X1),
          (this.getAccTitle = Q1),
          (this.getAccDescription = J1),
          (this.getDiagramTitle = Z1),
      ...
      sanitizeText(i) {
        return $1.sanitizeText(i, this.config);
      }
      lookUpDomId(i) {
        for (const n of this.vertices.values()) if (n.id === i) return n.domId;
        return i;
      }
      addVertex(i, n, a, u, l, f, c = {}, A) {
        var U, T;
...
` +
        ...
        if (b) {
          const d = r;
          (d == null ? void 0 : d.animate) !== void 0 &&
            (b.animate = d.animate),
            (d == null ? void 0 : d.animation) !== void 0 &&
        ...
        if (
          (k === void 0 &&
            ((k = {
              id: i,
              labelType: 'text',
              domId: ht + i + '-' + this.vertexCounter,
              styles: [],
              classes: [],
            }),
            this.vertices.set(i, k)),
          this.vertexCounter++,
          n !== void 0
            ? ((this.config = Ge()),
              (F = this.sanitizeText(n.text.trim())),
              (k.labelType = n.type),
              F.startsWith('"') &&
                F.endsWith('"') &&
                (F = F.substring(1, F.length - 1)),
              (k.text = F))
            : k.text === void 0 && (k.text = i),
          a !== void 0 && (k.type = a),
          u != null &&
            u.forEach((d) => {
              k.styles.push(d);
          ...
          k.props === void 0
            ? (k.props = c)
            : c !== void 0 && Object.assign(k.props, c),
          r !== void 0)
        ) {
          if (r.shape) {
            ...
            if (!st(r.shape)) throw new Error(`No such shape: ${r.shape}.`);
            k.type = r == null ? void 0 : r.shape;
          }
          r != null && r.label && (k.text = r == null ? void 0 : r.label),
            r != null &&
              r.icon &&
              ((k.icon = r == null ? void 0 : r.icon),
              !((U = r.label) != null && U.trim()) &&
                k.text === i &&
                (k.text = '')),
            r != null && r.form && (k.form = r == null ? void 0 : r.form),
            r != null && r.pos && (k.pos = r == null ? void 0 : r.pos),
            r != null &&
              r.img &&
              ((k.img = r == null ? void 0 : r.img),
              !((T = r.label) != null && T.trim()) &&
                k.text === i &&
                (k.text = '')),
            r != null && r.constraint && (k.constraint = r.constraint),
            r.w && (k.assetWidth = Number(r.w)),
            r.h && (k.assetHeight = Number(r.h));
        }
      }
...
You have to call mermaid.initialize.`);
      ...
      addLink(i, n, a) {
        ...
        Z.info('addLink', i, n, u);
        for (const l of i)
          for (const f of n) {
            const c = l === i[i.length - 1],
              A = f === n[0];
            c && A
              ? this.addSingleLink(l, f, a, u)
              : this.addSingleLink(l, f, a, void 0);
          }
      }
      updateLinkInterpolate(i, n) {
        i.forEach((a) => {
          a === 'default'
            ? (this.edges.defaultInterpolate = n)
            : (this.edges[a].interpolate = n);
        });
      }
      updateLink(i, n) {
        i.forEach((a) => {
          ...
          a === 'default'
            ...
            : ((this.edges[a].style = n),
              (((l = (u = this.edges[a]) == null ? void 0 : u.style) == null
                ? void 0
                : l.length) ?? 0) > 0 &&
                !(
                  (c = (f = this.edges[a]) == null ? void 0 : f.style) !=
                    null &&
                  c.some((b) => (b == null ? void 0 : b.startsWith('fill')))
                ) &&
                ((r = (A = this.edges[a]) == null ? void 0 : A.style) == null ||
                  r.push('fill:none')));
        });
      }
      addClass(i, n) {
      ...
      setClass(i, n) {
        for (const a of i.split(',')) {
          ...
          l && l.classes.push(n);
          const f = this.subGraphLookup.get(a);
          f && f.classes.push(n);
        }
      }
      setTooltip(i, n) {
      ...
      setClickFun(i, n, a) {
        ...
        if (Ge().securityLevel !== 'loose' || n === void 0) return;
        let l = [];
        if (typeof a == 'string') {
          l = a.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
      ...
      setLink(i, n, a) {
        i.split(',').forEach((u) => {
          ...
          l !== void 0 &&
            ((l.link = i1.formatUrl(n, this.config)), (l.linkTarget = a));
        }),
      ...
      setupToolTips(i) {
        ...
        (n._groups || n)[0][0] === null &&
          ...
          Ce(i)
            ...
            .on('mouseover', (l) => {
              var r;
              const f = Ce(l.currentTarget);
              if (f.attr('title') === null) return;
              const A =
                (r = l.currentTarget) == null
                  ? void 0
            ...
            .on('mouseout', (l) => {
              n.transition().duration(500).style('opacity', 0),
                Ce(l.currentTarget).classed('hover', !1);
            });
      }
      clear(i = 'gen-2') {
        (this.vertices = new Map()),
      ...
      addSubGraph(i, n, a) {
        ...
        const f = m((b) => {
            const F = { boolean: {}, number: {}, string: {} },
              k = [];
            let U;
            return {
              nodeList: b.filter(function (d) {
                const K = typeof d;
                return d.stmt && d.stmt === 'dir'
                  ? ((U = d.value), !1)
                  : d.trim() === ''
                    ? !1
                    : K in F
                      ? F[K].hasOwnProperty(d)
                        ? !1
                        : (F[K][d] = !0)
                      : k.includes(d)
                        ? !1
          ...
          { nodeList: c, dir: A } = f(n.flat());
        if (this.version === 'gen-1')
          for (let b = 0; b < c.length; b++) c[b] = this.lookUpDomId(c[b]);
        ...
        return (
          Z.info('Adding', r.id, r.nodes, r.dir),
          (r.nodes = this.makeUniq(r, this.subGraphs).nodes),
          this.subGraphs.push(r),
          this.subGraphLookup.set(u, r),
          u
        );
      }
      getPosForId(i) {
      ...
      destructEndLink(i) {
        ...
        switch (n.slice(-1)) {
          case 'x':
            (u = 'arrow_cross'),
              n.startsWith('x') && ((u = 'double_' + u), (a = a.slice(1)));
            break;
          case '>':
            (u = 'arrow_point'),
              n.startsWith('<') && ((u = 'double_' + u), (a = a.slice(1)));
            break;
          case 'o':
            (u = 'arrow_circle'),
              n.startsWith('o') && ((u = 'double_' + u), (a = a.slice(1)));
            break;
        }
        let l = 'normal',
          f = a.length - 1;
        ...
        return (
          c && ((l = 'dotted'), (f = c)), { type: u, stroke: l, length: f }
        );
      }
      destructLink(i, n) {
      ...
      makeUniq(i, n) {
        ...
        return (
          i.nodes.forEach((u, l) => {
            this.exists(n, u) || a.push(i.nodes[l]);
          }),
          { nodes: a }
        );
      }
      ...
      addNodeFromVertex(i, n, a, u, l, f) {
        ...
        if (r)
          ...
          A
            ? n.push({ ...F, isGroup: !0, shape: 'rect' })
            : n.push({ ...F, isGroup: !1, shape: this.getTypeFromVertex(i) });
        }
      }
      getCompiledStyles(i) {
        let n = [];
        for (const a of i) {
          ...
          u != null &&
            u.styles &&
            (n = [...n, ...(u.styles ?? [])].map((l) => l.trim())),
            u != null &&
              u.textStyles &&
              (n = [...n, ...(u.textStyles ?? [])].map((l) => l.trim()));
        }
        return n;
      }
      getData() {
        ...
        for (let r = u.length - 1; r >= 0; r--) {
          ...
          for (const F of b.nodes) l.set(F, b.id);
        }
        for (let r = u.length - 1; r >= 0; r--) {
          const b = u[r];
          n.push({
        ...
        this.getVertices().forEach((r) => {
          this.addNodeFromVertex(r, n, l, f, i, i.look || 'classic');
        });
        const A = this.getEdges();
        return (
          A.forEach((r, b) => {
            var d;
            const { arrowTypeStart: F, arrowTypeEnd: k } =
                this.destructEdgeType(r.type),
              U = [...(A.defaultStyle ?? [])];
            r.style && U.push(...r.style);
            const T = {
              id: s1(r.start, r.end, { counter: b, prefix: 'L' }, r.id),
  ...
  ft = m(async function (s, i, n, a) {
    var U;
    Z.info('REF0:'), Z.info('Drawing state diagram (v2)', i);
    const { securityLevel: u, flowchart: l, layout: f } = Ge();
    let c;
    u === 'sandbox' && (c = Ce('#i' + i));
    ...
    (r.type = a.type),
      ...
      (r.direction = F),
      (r.nodeSpacing = (l == null ? void 0 : l.nodeSpacing) || 50),
      (r.rankSpacing = (l == null ? void 0 : l.rankSpacing) || 50),
      (r.markers = ['point', 'circle', 'cross']),
      (r.diagramId = i),
      Z.debug('REF1:', r),
      await at(r, b);
    const k =
      ((U = r.config.flowchart) == null ? void 0 : U.diagramPadding) ?? 8;
    i1.insertTitle(
      b,
      'flowchartTitleText',
      ...
      ot(b, k, 'flowchart', (l == null ? void 0 : l.useMaxWidth) || !1);
    for (const T of r.nodes) {
      const d = Ce(`#${i} [id="${T.id}"]`);
      if (!d || !T.link) continue;
      const K = A.createElementNS('http://www.w3.org/2000/svg', 'a');
      K.setAttributeNS('http://www.w3.org/2000/svg', 'class', T.cssClasses),
        K.setAttributeNS('http://www.w3.org/2000/svg', 'rel', 'noopener'),
        u === 'sandbox'
          ? K.setAttributeNS('http://www.w3.org/2000/svg', 'target', '_top')
          : T.linkTarget &&
            K.setAttributeNS(
      ...
      const fe = d.insert(function () {
          return K;
        }, ':first-child'),
        ge = d.select('.label-container');
      ge &&
        fe.append(function () {
          return ge.node();
        });
      const be = d.select('.label');
      be &&
        fe.append(function () {
          return be.node();
        });
  ...
  gt = { getClasses: pt, draw: ft },
  r1 = (function () {
    var s = m(function (pe, h, p, g) {
        for (p = p || {}, g = pe.length; g--; p[pe[g]] = h);
        return p;
      }, 'o'),
      i = [1, 4],
      n = [1, 3],
      ...
      Ke = [1, 124],
      Ye = [1, 123],
      o1 = [44, 60, 62, 74, 89, 102, 105, 106, 109, 111, 114, 115, 116],
      c1 = [1, 133],
      h1 = [1, 147],
      d1 = [1, 148],
      p1 = [1, 149],
      ...
      I1 = [10, 106],
      de = [31, 49, 51, 53, 55, 57, 62, 64, 66, 67, 69, 71, 116, 117, 118],
      se = [1, 247],
      ie = [1, 245],
      re = [1, 249],
      ne = [1, 243],
      ...
      Re = [1, 268],
      w1 = [8, 9, 11, 106],
      J = [8, 9, 10, 11, 60, 84, 105, 106, 109, 110, 111, 112],
      Je = {
        ...
        performAction: m(function (h, p, g, o, _, e, Oe) {
          var t = e.length - 1;
          switch (_) {
            case 2:
              this.$ = [];
            ...
            case 76:
              ...
              break;
            case 77:
              var V = o.destructLink(e[t], e[t - 2]);
              this.$ = {
                type: V.type,
                stroke: V.stroke,
                length: V.length,
        ...
        table: [
          ...
          s(u, [2, 10]),
          s(u, [2, 11]),
          { 8: [1, 54], 9: [1, 55], 10: he, 15: 53, 18: 56 },
          s(E, [2, 3]),
          s(E, [2, 4]),
          s(E, [2, 5]),
          s(E, [2, 6]),
          ...
          { 8: $, 9: ee, 11: te, 21: 70 },
          { 8: $, 9: ee, 11: te, 21: 71 },
          { 8: $, 9: ee, 10: [1, 72], 11: te, 21: 73 },
          s(E, [2, 36]),
          { 35: [1, 74] },
          { 37: [1, 75] },
          s(E, [2, 39]),
          s(Se, [2, 50], { 18: 76, 39: 77, 10: he, 40: n1 }),
          { 10: [1, 79] },
          { 10: [1, 80] },
          { 10: [1, 81] },
          { 10: [1, 82] },
          ...
          s(E, [2, 41]),
          s(E, [2, 42]),
          s(Ie, [2, 76], { 73: 116, 62: [1, 118], 74: [1, 117] }),
          { 76: 119, 79: 120, 80: u1, 81: l1, 116: Ke, 119: Ye },
          { 75: [1, 125], 77: [1, 126] },
          s(o1, [2, 83]),
          s(E, [2, 28]),
          s(E, [2, 29]),
          ...
          { 30: 170, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          { 30: 178, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          {
            30: 180,
            50: [1, 179],
            67: C,
          ...
          { 30: 181, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          { 30: 182, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          { 30: 183, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          { 109: [1, 184] },
          { 30: 185, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          {
            30: 186,
            65: [1, 187],
            67: C,
          ...
          { 30: 188, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          { 30: 189, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          { 30: 190, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          s(H, [2, 182]),
          s(u, [2, 20]),
          s(a1, [2, 25]),
          s(Se, [2, 46], { 39: 191, 18: 192, 10: he, 40: n1 }),
          s(Ie, [2, 73], { 10: [1, 193] }),
          { 10: [1, 194] },
          { 30: 195, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          { 77: [1, 196], 79: 197, 116: Ke, 119: Ye },
          s(we, [2, 79]),
          s(we, [2, 81]),
          s(we, [2, 82]),
          s(we, [2, 168]),
          s(we, [2, 169]),
          { 76: 198, 79: 120, 80: u1, 81: l1, 116: Ke, 119: Ye },
          s(o1, [2, 84]),
          {
            8: $,
            9: ee,
          ...
          { 31: [1, 217], 67: C, 82: 218, 116: S, 117: D, 118: x },
          s(de, [2, 86]),
          s(de, [2, 88]),
          s(de, [2, 89]),
          s(de, [2, 153]),
          ...
          s(de, [2, 155]),
          s(de, [2, 156]),
          { 49: [1, 219], 67: C, 82: 218, 116: S, 117: D, 118: x },
          { 30: 220, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          { 51: [1, 221], 67: C, 82: 218, 116: S, 117: D, 118: x },
          { 53: [1, 222], 67: C, 82: 218, 116: S, 117: D, 118: x },
          { 55: [1, 223], 67: C, 82: 218, 116: S, 117: D, 118: x },
          { 57: [1, 224], 67: C, 82: 218, 116: S, 117: D, 118: x },
          { 60: [1, 225] },
          { 64: [1, 226], 67: C, 82: 218, 116: S, 117: D, 118: x },
          { 66: [1, 227], 67: C, 82: 218, 116: S, 117: D, 118: x },
          { 30: 228, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          { 31: [1, 229], 67: C, 82: 218, 116: S, 117: D, 118: x },
          {
            67: C,
            69: [1, 230],
            71: [1, 231],
          ...
          s(Se, [2, 45], { 18: 155, 10: he, 40: v1 }),
          s(Se, [2, 47], { 44: L1 }),
          s(Ie, [2, 75]),
          s(Ie, [2, 74]),
          { 62: [1, 234], 67: C, 82: 218, 116: S, 117: D, 118: x },
          s(Ie, [2, 77]),
          s(we, [2, 80]),
          { 77: [1, 235], 79: 197, 116: Ke, 119: Ye },
          { 30: 236, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          s(Qe, l, { 5: 237 }),
          s(y, [2, 102]),
          s(E, [2, 35]),
          {
          ...
          s(de, [2, 87]),
          s(W, [2, 57]),
          { 51: [1, 262], 67: C, 82: 218, 116: S, 117: D, 118: x },
          s(W, [2, 64]),
          s(W, [2, 59]),
          s(W, [2, 60]),
          s(W, [2, 61]),
          ...
          s(W, [2, 63]),
          s(W, [2, 65]),
          { 66: [1, 264], 67: C, 82: 218, 116: S, 117: D, 118: x },
          s(W, [2, 67]),
          s(W, [2, 68]),
          s(W, [2, 70]),
          s(W, [2, 69]),
          ...
          s(Ie, [2, 78]),
          { 31: [1, 265], 67: C, 82: 218, 116: S, 117: D, 118: x },
          {
            6: 11,
            7: 12,
            8: f,
          ...
          s(B, [2, 120]),
          s(W, [2, 58]),
          { 30: 282, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D, 118: x },
          s(W, [2, 66]),
          s(Qe, l, { 5: 283 }),
          s(w1, [2, 131], {
            108: 269,
          ...
          s(B, [2, 114]),
          { 31: [1, 286], 67: C, 82: 218, 116: S, 117: D, 118: x },
          {
            6: 11,
            7: 12,
            8: f,
        ...
        parse: m(function (h) {
          ...
          var $e = M.yylloc;
          e.push($e);
          var K1 = M.options && M.options.ranges;
          ...
          m(G1, 'lex');
          for (var Y, me, Q, e1, Ne = {}, qe, ce, P1, Xe; ; ) {
            if (
              ((me = g[g.length - 1]),
              this.defaultActions[me]
                ? (Q = this.defaultActions[me])
            ...
            switch (Q[0]) {
              ...
              case 2:
                if (
                  ...
                  (e1 = this.performAction.apply(
                    Ne,
                    [t, R1, V, ke.yy, Q[1], _, e].concat(j1),
                  )),
                  typeof e1 < 'u')
                )
                  return e1;
                ce &&
                  ...
                  _.push(Ne.$),
                  e.push(Ne._$),
                  (P1 = Oe[g[g.length - 2]][g[g.length - 1]]),
                  g.push(P1);
                break;
              case 3:
                return !0;
          ...
          unput: m(function (h) {
            ...
            return (
              (this.yylloc = {
                ...
                last_column: g
                  ? (g.length === o.length ? this.yylloc.first_column : 0) +
                    o[o.length - g.length].length -
                    g[0].length
                  : this.yylloc.first_column - p,
              }),
              this.options.ranges &&
                (this.yylloc.range = [_[0], _[0] + this.yyleng - p]),
          ...
          next: m(function () {
            ...
            for (var _ = this._currentRules(), e = 0; e < _.length; e++)
              if (
                ...
                g && (!p || g[0].length > p[0].length))
              ) {
                if (((p = g), (o = e), this.options.backtrack_lexer)) {
                  if (((h = this.test_match(g, _[e])), h !== !1)) return h;
                  if (this._backtrack) {
                    p = !1;
                    continue;
                  } else return !1;
            ...
            return p
              ? ((h = this.test_match(p, _[o])), h !== !1 ? h : !1)
              : this._input === ''
                ? this.EOF
                : this.parseError(
                    'Lexical error on line ' +
...
` +
          ...
          options: {},
          performAction: m(function (p, g, o, _) {
            switch (o) {
              case 0:
              ...
              case 10:
                const e = /\n\s*/g;
                return (g.yytext = g.yytext.replace(e, '<br/>')), 40;
              case 11:
                return 40;
              case 12:
                this.popState();
    ...
    return m(He, 'Parser'), (He.prototype = Je), (Je.Parser = He), new He();
  })();
r1.parser = r1;
var M1 = r1,
  U1 = Object.assign({}, M1);
...
var bt = U1,
  ...
  .labelBkg {
    background-color: ${At(s.edgeLabelBackground, 0.5)};
    // background-color:
  }
