...
import { l as ee } from './linear-2Ht_xilX.js';
            ...
            case 2:
              if (
                ...
                (Et = this.performAction.apply(
                  lt,
                  [s, Zt, qt, K.yy, N[1], _, e].concat(qe),
                )),
                typeof Et < 'u')
              )
                return Et;
...
` +
  ...
  return o(mt, 'Parser'), (mt.prototype = vt), (vt.Parser = mt), new mt();
})();
Vt.parser = Vt;
var De = Vt,
  V = _e(),
  ...
  ze =
    ((ht = class {
      ...
      getDefaultConfig() {
        var n, u, c, h, p, y, S, a, A, d, T, m, q, b, x, O, Y, G;
        return {
          showXAxis: !0,
          showYAxis: !0,
          showTitle: !0,
          ...
          pointTextPadding:
            ((m = D.quadrantChart) == null ? void 0 : m.pointTextPadding) || 5,
          pointLabelFontSize:
            ((q = D.quadrantChart) == null ? void 0 : q.pointLabelFontSize) ||
            12,
          pointRadius:
      ...
      calculateSpace(n, u, c, h) {
        const p =
          ...
          m = this.config.quadrantPadding + y.top + d.top,
          q =
...
` + t,
    ...
    const T = (
      ...
      q = ((xt = S.quadrantChart) == null ? void 0 : xt.chartWidth) ?? 500,
    ...
    const x = c.db.getQuadrantData(),
      O = m.append('g').attr('class', 'quadrants'),
      Y = m.append('g').attr('class', 'border'),
      G = m.append('g').attr('class', 'data-points'),
      yt = m.append('g').attr('class', 'labels'),
      Tt = m.append('g').attr('class', 'title');
    x.title &&
      Tt.append('text')
        .attr('x', 0)
        .attr('y', 0)
  ...
  Re = { draw: Be },
  Ye = { parser: De, db: we, renderer: Re, styles: o(() => '', 'styles') };
