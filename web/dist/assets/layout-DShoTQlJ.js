import { G as g } from './graph-ByJpsr8c.js';
import {
  bb as Me,
  bc as Te,
  bd as Ie,
...
function y(e) {
  return e && e.length ? pe(e, ce, en) : void 0;
}
function U(e, n) {
  return e && e.length ? pe(e, X(n), qe) : void 0;
}
function nn(e, n) {
  var r = e.length;
...
function an(e, n, r) {
  ...
  var t = -1;
  n = F(n, Fe(X));
  var a = We(e, function (i, o, u) {
    var d = F(n, function (s) {
      return s(i);
    });
    return { criteria: d, index: ++t, value: i };
  });
  return nn(a, function (i, o) {
    return tn(i, o, r);
  });
}
function on(e, n) {
  return Xe(e, n, function (r, t) {
    return De(e, t);
  });
}
var T = Ue(function (e, n) {
    return e == null ? {} : on(e, n);
  }),
  un = Math.ceil,
  dn = Math.max;
function sn(e, n, r, t) {
  for (var a = -1, i = dn(un((n - e) / (r || 1)), 0), o = Array(i); i--; )
    (o[++a] = e), (e += r);
  return o;
}
function fn(e) {
  return function (n, r, t) {
    return (
      t && typeof t != 'number' && $(n, r, t) && (r = t = void 0),
      (n = V(n)),
...
class vn {
  ...
  toString() {
    for (var n = [], r = this._sentinel, t = r._prev; t !== r; )
      n.push(JSON.stringify(t, pn)), (t = t._prev);
    return '[' + n.join(', ') + ']';
  }
}
function ne(e) {
...
function wn(e, n) {
  ...
  var r = mn(e, n),
    t = bn(r.graph, r.buckets, r.zeroIdx);
  return O(
    w(t, function (a) {
...
function bn(e, n, r) {
  for (var t = [], a = n[n.length - 1], i = n[0], o; e.nodeCount(); ) {
    for (; (o = i.dequeue()); ) B(e, n, r, o);
    for (; (o = a.dequeue()); ) B(e, n, r, o);
    if (e.nodeCount()) {
...
function te(e, n, r, t) {
  ...
  return (
    arguments.length >= 4 && ((a.rank = r), (a.order = t)), L(e, 'border', a, n)
  );
}
function me(e) {
  return y(
...
function ye(e) {
  ...
  for (var a, i; jn(n, e) < t; )
    (a = Fn(n, e)), (i = n.hasNode(a.v) ? C(e, a) : -C(e, a)), Vn(n, e, i);
  return n;
}
function jn(e, n) {
  function r(t) {
...
function Pe(e, n, r, t) {
  var a = r.v,
    i = r.w;
  e.removeEdge(a, i), e.setEdge(t.v, t.w, {}), K(e), J(e, n), Dn(e, n);
}
function Dn(e, n) {
...
function er(e, n) {
  for (var r = 0, t = 1; t < n.length; ++t) r += nr(e, n[t - 1], n[t]);
  return r;
}
function nr(e, n, r) {
  for (
...
function de(e, n, r) {
  for (var t; n.length && (t = M(n)).i <= r; ) n.pop(), e.push(t.vs), r++;
  return r;
}
function dr(e) {
  return function (n, r) {
...
function Re(e, n, r, t) {
  ...
  f(s, function (p) {
    if (e.children(p.v).length) {
      var b = Re(e, p.v, r, t);
      (d[p.v] = b),
        Object.prototype.hasOwnProperty.call(b, 'barycenter') && fr(p, b);
    }
  });
  var c = ar(s, r);
  sr(c, d);
        ...
        (h || c === s) &&
          (f(i.slice(u, l + 1), function (p) {
            f(e.predecessors(p), function (b) {
              var N = e.node(b),
                Q = N.order;
              (Q < o || v < Q) && !(N.dummy && e.node(p).dummy) && _e(r, b, p);
            });
          }),
          (u = l + 1),
          (o = v));
...
function Mr(e, n) {
  n('    makeSpaceForEdgeLabels', () => Dr(e)),
    n('    removeSelfEdges', () => Jr(e)),
    n('    acyclic', () => gn(e)),
    n('    nestingGraph.run', () => zn(e)),
    n('    rank', () => qn(be(e))),
    n('    injectEdgeLabelProxies', () => $r(e)),
    n('    removeEmptyRanks', () => On(e)),
    n('    nestingGraph.cleanup', () => Zn(e)),
    n('    normalizeRanks', () => En(e)),
    n('    assignRankMinMax', () => qr(e)),
    n('    removeEdgeLabelProxies', () => Wr(e)),
    n('    normalize.run', () => Tn(e)),
    n('    parentDummyChains', () => hr(e)),
    n('    addBorderSegments', () => Pn(e)),
    n('    order', () => cr(e)),
    n('    insertSelfEdges', () => Kr(e)),
    n('    adjustCoordinateSystem', () => Cn(e)),
    n('    position', () => Rr(e)),
    n('    positionSelfEdges', () => Qr(e)),
    n('    removeBorderNodes', () => Zr(e)),
    n('    normalize.undo', () => Sn(e)),
    n('    fixupEdgeLabelCoords', () => Ur(e)),
    n('    undoCoordinateSystem', () => Rn(e)),
    n('    translateGraph', () => Xr(e)),
    n('    assignNodeIntersects', () => zr(e)),
    n('    reversePoints', () => Hr(e)),
    n('    acyclic.undo', () => kn(e));
}
function Tr(e, n) {
  f(e.nodes(), function (r) {
...
var Ir = ['nodesep', 'edgesep', 'ranksep', 'marginx', 'marginy'],
  Sr = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: 'tb' },
  jr = ['acyclicer', 'ranker', 'rankdir', 'align'],
  Fr = ['width', 'height'],
  Vr = { width: 0, height: 0 },
  Br = ['minlen', 'weight', 'width', 'height', 'labeloffset'],
  Ar = {
    minlen: 1,
    weight: 1,
    width: 0,
...
function Yr(e) {
  var n = new g({ multigraph: !0, compound: !0 }),
    r = D(e.graph());
  return (
    n.setGraph(q({}, Sr, Y(r, Ir), T(r, jr))),
    f(e.nodes(), function (t) {
      var a = D(e.node(t));
      n.setNode(t, ze(Y(a, Fr), Vr)), n.setParent(t, e.parent(t));
    }),
    f(e.edges(), function (t) {
      var a = D(e.edge(t));
      n.setEdge(t, q({}, Ar, Y(a, Br), T(a, Gr)));
    }),
    n
  );
}
  ...
  f(e.nodes(), function (n) {
    if (e.children(n).length) {
      var r = e.node(n),
        ...
        i = e.node(M(r.borderLeft)),
        o = e.node(M(r.borderRight));
