import { g as C, c as b } from './react-core-4ZwCPCju.js';
function G(y, h) {
  ...
  (function () {
    ...
    h.prototype = {
      ...
      volume: function (e) {
        var n = this || u;
        if (
          ((e = parseFloat(e)), n.ctx || A(), e !== void 0 && e >= 0 && e <= 1)
        ) {
          if (((n._volume = e), n._muted)) return n;
          n.usingWebAudio &&
            n.masterGain.gain.setValueAtTime(e, u.ctx.currentTime);
          ...
          var n = function (t) {
            ...
            for (var r = 0; r < e._howls.length; r++)
              if (!e._howls[r]._webAudio)
                for (
                  var d = e._howls[r]._getSoundIds(), a = 0;
                  a < d.length;
                  a++
                ) {
    ...
    f.prototype = {
      ...
      play: function (e, n) {
        ...
        if (!a) return null;
        if (
          (o && !e && (e = a._sprite || '__default'), t._state !== 'loaded')
        ) {
        ...
        if (t._webAudio) {
            ...
            try {
              ...
              e !== '__default' || a._loop
                ...
                : ((t._endTimers[a._id] = function () {
                    t._ended(a),
                      s.removeEventListener('ended', t._endTimers[a._id], !1);
                  }),
          ...
          var F =
            ...
            (!s.readyState && u._navigator.isCocoonJS);
          if (s.readyState >= 3 || F) P();
          else {
            (t._playLock = !0), (t._state = 'loading');
            var L = function () {
              (t._state = 'loaded'),
                P(),
                s.removeEventListener(u._canPlayEvent, L, !1);
            };
      ...
      _stopFade: function (e) {
        ...
        return (
          t &&
            t._interval &&
            (n._webAudio &&
              t._node.gain.cancelScheduledValues(u.ctx.currentTime),
      ...
      rate: function () {
        ...
        var a;
        if (typeof e != 'number')
          return (a = t._soundById(n)), a ? a._rate : t._rate;
        if (t._state !== 'loaded' || t._playLock)
          return (
            t._queue.push({
              event: 'rate',
      ...
      unload: function () {
        ...
        for (t = 0; t < u._howls.length; t++)
          if (
            u._howls[t]._src === e._src ||
            e._src.indexOf(u._howls[t]._src) >= 0
          ) {
            r = !1;
            break;
          }
    ...
    c.prototype = {
      ...
      create: function () {
        ...
        return (
          n._webAudio
            ? ((e._node =
                u.ctx.createGain === void 0
                  ? u.ctx.createGainNode()
                  : u.ctx.createGain()),
    ...
    var p = {},
      ...
      k = function (e, n) {
        var t = function () {
          ...
          o = function (r) {
            r && n._sounds.length > 0 ? ((p[n._src] = r), S(n, r)) : t();
          };
      ...
      A = function () {
        if (u.usingWebAudio) {
          ...
          var e = /iP(hone|od|ad)/.test(u._navigator && u._navigator.platform),
            n =
              u._navigator &&
              u._navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/),
            t = n ? parseInt(n[1], 10) : null;
          if (e && t && t < 9) {
            var o = /safari/.test(
              u._navigator && u._navigator.userAgent.toLowerCase(),
            );
    ...
    (y.Howler = u),
      (y.Howl = f),
      typeof b < 'u'
        ? ((b.HowlerGlobal = h), (b.Howler = u), (b.Howl = f), (b.Sound = c))
        : typeof window < 'u' &&
