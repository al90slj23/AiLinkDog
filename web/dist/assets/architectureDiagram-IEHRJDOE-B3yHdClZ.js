...
import { p as sr } from './chunk-4BMEZGHF-C4FSbg0i.js';
import { I as hr } from './chunk-XZIHB7SX-D1NPzHZs.js';
import { p as lr } from './radar-MK3ICKWK-CR6EA1S0.js';
import { c as Pe } from './cytoscape.esm-BY7v1xhs.js';
import { c as Le, g as fr } from './react-core-4ZwCPCju.js';
      ...
      (function (C, U) {
        (function (G, L) {
          ...
          return (function (A) {
            var G = {};
            function L(u) {
              if (G[u]) return G[u].exports;
              var l = (G[u] = { i: u, l: !1, exports: {} });
              return (
                A[u].call(l.exports, l, l.exports, L), (l.l = !0), l.exports
              );
            }
            return (
              (L.m = A),
                  ...
                  (this.isOverlapingSourceAndTarget = l.getIntersection(
                    ...
                    this.isOverlapingSourceAndTarget ||
                      ...
                      Math.abs(this.lengthX) < 1 &&
                        (this.lengthX = n.sign(this.lengthX)),
                      Math.abs(this.lengthY) < 1 &&
                        (this.lengthY = n.sign(this.lengthY)),
            ...
            function (A, G, L) {
              ...
              function i(t, s, o, c) {
                o == null && c == null && (c = s),
                  ...
                  (this.graphManager = t),
                  o != null && s != null
                    ? (this.rect = new n(s.x, s.y, o.width, o.height))
                    : (this.rect = new n());
              }
            ...
            function (A, G, L) {
              ...
              function s(c, h, T) {
                u.call(this, T),
                  (this.estimatedSize = l.MIN_VALUE),
                  (this.margin = n.DEFAULT_GRAPH_MARGIN),
                  (this.edges = []),
                  (this.nodes = []),
                  (this.isConnected = !1),
                  (this.parent = c),
              ...
              (s.prototype.getNodes = function () {
                ...
                (s.prototype.updateBounds = function (c) {
                  ...
                  h == l.MAX_VALUE &&
                    ...
                    X[0].getParent().paddingLeft != null
                      ...
                      : (K = this.margin),
                    (this.left = a.x - K),
                    (this.right = a.x + a.width + K),
                    (this.top = a.y - K),
                    (this.bottom = a.y + a.height + K);
                }),
                ...
                (s.prototype.calcEstimatedSize = function () {
                  ...
                  return (
                    c == 0
                      ? (this.estimatedSize = n.EMPTY_COMPOUND_NODE_SIZE)
            ...
            function (A, G, L) {
              ...
              (n.prototype.addRoot = function () {
                ...
                (n.prototype.add = function (r, e, f, i, g) {
                ...
                (n.prototype.remove = function (r) {
                  if (r instanceof u) {
                    ...
                    var o;
                    g = s.length;
                    for (var t = 0; t < g; t++) (o = s[t]), e.remove(o);
                ...
                (n.prototype.isOneAncestorOfOther = function (r, e) {
                ...
                (n.prototype.calcLowestCommonAncestor = function (r, e) {
                ...
                (n.prototype.calcInclusionTreeDepths = function (r, e) {
            ...
            function (A, G, L) {
              var u = L(12);
              function l() {}
              (l.calcSeparationAmount = function (n, r, e, f) {
                if (!n.intersects(r)) throw 'assert failed';
                var i = new Array(2);
                this.decideDirectionsForOverlappingNodes(n, r, i),
                  (e[0] =
                    Math.min(n.getRight(), r.getRight()) - Math.max(n.x, r.x)),
                  (e[1] =
                    Math.min(n.getBottom(), r.getBottom()) -
                    Math.max(n.y, r.y)),
                  n.getX() <= r.getX() && n.getRight() >= r.getRight()
                    ? (e[0] += Math.min(
                        r.getX() - n.getX(),
                        n.getRight() - r.getRight(),
                      ))
                    : r.getX() <= n.getX() &&
                      r.getRight() >= n.getRight() &&
                      (e[0] += Math.min(
                        n.getX() - r.getX(),
                        r.getRight() - n.getRight(),
                      )),
                  n.getY() <= r.getY() && n.getBottom() >= r.getBottom()
                    ? (e[1] += Math.min(
                        r.getY() - n.getY(),
                        n.getBottom() - r.getBottom(),
                      ))
                    : r.getY() <= n.getY() &&
                      r.getBottom() >= n.getBottom() &&
                      (e[1] += Math.min(
                        n.getY() - r.getY(),
                        r.getBottom() - n.getBottom(),
                      ));
                var g = Math.abs(
                  (r.getCenterY() - n.getCenterY()) /
                    (r.getCenterX() - n.getCenterX()),
                );
                r.getCenterY() === n.getCenterY() &&
                  r.getCenterX() === n.getCenterX() &&
                  (g = 1);
                ...
                (l.decideDirectionsForOverlappingNodes = function (n, r, e) {
                  n.getCenterX() < r.getCenterX() ? (e[0] = -1) : (e[0] = 1),
                    n.getCenterY() < r.getCenterY() ? (e[1] = -1) : (e[1] = 1);
                }),
                (l.getIntersection2 = function (n, r, e) {
                  var f = n.getCenterX(),
                    i = n.getCenterY(),
                    g = r.getCenterX(),
                    t = r.getCenterY();
                ...
                (l.getCardinalDirection = function (n, r, e) {
                  return n > r ? e : 1 + (e % 4);
                }),
                (l.getIntersection = function (n, r, e, f) {
                  if (f == null) return this.getIntersection2(n, r, e);
                  var i = n.x,
                    g = n.y,
                    t = r.x,
                    s = r.y,
                ...
                (l.angleOfVector = function (n, r, e, f) {
                  var i = void 0;
                  return (
                    n !== e
                      ? ((i = Math.atan((f - r) / (e - n))),
                        e < n ? (i += Math.PI) : f < r && (i += this.TWO_PI))
                      : f < r
                ...
                (l.doIntersect = function (n, r, e, f) {
                  var i = n.x,
                    g = n.y,
                    t = r.x,
                    s = r.y,
                ...
                (l.findCircleLineIntersections = function (
                  ...
                  var s = (e - n) * (e - n) + (f - r) * (f - r),
                    o = 2 * ((n - i) * (e - n) + (r - g) * (f - r)),
                    c = (n - i) * (n - i) + (r - g) * (r - g) - t * t,
                    h = o * o - 4 * s * c;
                  if (h >= 0) {
            ...
            function (A, G, L) {
              function u(l, n, r) {
                (this.x = null),
                  (this.y = null),
                  l == null && n == null && r == null
                    ? ((this.x = 0), (this.y = 0))
                    : typeof l == 'number' && typeof n == 'number' && r == null
                      ? ((this.x = l), (this.y = n))
              ...
              (u.prototype.getX = function () {
                ...
                (u.prototype.setLocation = function (l, n, r) {
                  l.constructor.name == 'Point' && n == null && r == null
                    ? ((r = l), this.setLocation(r.x, r.y))
                    : typeof l == 'number' &&
                      typeof n == 'number' &&
                      r == null &&
                      (parseInt(l) == l && parseInt(n) == n
                        ? this.move(l, n)
                        : ((this.x = Math.floor(l + 0.5)),
                          (this.y = Math.floor(n + 0.5))));
                }),
                (u.prototype.move = function (l, n) {
                  (this.x = l), (this.y = n);
                }),
                (u.prototype.translate = function (l, n) {
                  (this.x += l), (this.y += n);
                }),
            ...
            function (A, G, L) {
              ...
              function l() {}
              (l.lastID = 0),
                (l.createID = function (n) {
                  return l.isPrimitive(n)
                    ? n
                    : (n.uniqueID != null ||
                        ((n.uniqueID = l.getString()), l.lastID++),
                      n.uniqueID);
                }),
                ...
                (l.isPrimitive = function (n) {
                  var r = typeof n > 'u' ? 'undefined' : u(n);
            ...
            function (A, G, L) {
              ...
              (u.seed = 1),
                ...
                (u.nextDouble = function () {
                  return (
                    (u.x = Math.sin(u.seed++) * 1e4), u.x - Math.floor(u.x)
                  );
                }),
                (A.exports = u);
            },
                ...
                (l.prototype.transformX = function (n) {
                  ...
                  return (
                    e != 0 &&
                      (r =
                        this.ldeviceOrgX +
                        ((n - this.lworldOrgX) * this.ldeviceExtX) / e),
                    r
                  );
                }),
                (l.prototype.transformY = function (n) {
                  ...
                  return (
                    e != 0 &&
                      (r =
                        this.ldeviceOrgY +
                        ((n - this.lworldOrgY) * this.ldeviceExtY) / e),
                    r
                  );
                }),
                (l.prototype.inverseTransformX = function (n) {
                  ...
                  return (
                    e != 0 &&
                      (r =
                        this.lworldOrgX +
                        ((n - this.ldeviceOrgX) * this.lworldExtX) / e),
                    r
                  );
                }),
                (l.prototype.inverseTransformY = function (n) {
                  ...
                  return (
                    e != 0 &&
                      (r =
                        this.lworldOrgY +
                        ((n - this.ldeviceOrgY) * this.lworldExtY) / e),
                    r
                  );
                }),
                (l.prototype.inverseTransformPoint = function (n) {
                  var r = new u(
                    this.inverseTransformX(n.x),
                    this.inverseTransformY(n.y),
                  );
                  return r;
                }),
                (A.exports = l);
              ...
              (i.prototype.initParameters = function () {
                ...
                (i.prototype.calcRepulsionForce = function (t, s) {
                  var o = t.getRect(),
                    ...
                    K;
                  if (o.intersects(c)) {
                    e.calcSeparationAmount(o, c, h, n.DEFAULT_EDGE_LENGTH / 2),
                      (P = 2 * h[0]),
                      (K = 2 * h[1]);
                    var X =
                      (t.noOfChildren * s.noOfChildren) /
                      (t.noOfChildren + s.noOfChildren);
                    (t.repulsionForceX -= X * P),
                      (t.repulsionForceY -= X * K),
                      (s.repulsionForceX += X * P),
                    ...
                    s.getChild() == null
                      ...
                      : (e.getIntersection(o, c, T),
                        (v = T[2] - T[0]),
                        (d = T[3] - T[1])),
                      Math.abs(v) < n.MIN_REPULSION_DIST &&
                        (v = f.sign(v) * n.MIN_REPULSION_DIST),
                      Math.abs(d) < n.MIN_REPULSION_DIST &&
                        (d = f.sign(d) * n.MIN_REPULSION_DIST),
                      (N = v * v + d * d),
                      (S = Math.sqrt(N)),
                      (M =
            ...
            function (A, G, L) {
              ...
              n.prototype = Object.create(u.prototype);
              for (var r in u) n[r] = u[r];
              (n.prototype.setGridCoordinates = function (e, f, i, g) {
                (this.startX = e),
                  (this.finishX = f),
                  (this.startY = i),
                  (this.finishY = g);
            ...
            function (A, G, L) {
              ...
              (l.prototype.put = function (n, r) {
                var e = u.createID(n);
                this.contains(e) || ((this.map[e] = r), this.keys.push(n));
              }),
                (l.prototype.contains = function (n) {
                  return u.createID(n), this.map[n] != null;
                }),
            ...
            function (A, G, L) {
              ...
              (l.prototype.add = function (n) {
                ...
                (l.prototype.remove = function (n) {
                  delete this.set[u.createID(n)];
                }),
                (l.prototype.clear = function () {
                  this.set = {};
                }),
                (l.prototype.contains = function (n) {
                  return this.set[u.createID(n)] == n;
                }),
              ...
              (u.multMat = function (l, n) {
                ...
                (u.transpose = function (l) {
                  for (var n = [], r = 0; r < l[0].length; r++) {
                    n[r] = [];
                    for (var e = 0; e < l.length; e++) n[r][e] = l[e][r];
                  }
                  return n;
                }),
                (u.multCons = function (l, n) {
                  for (var r = [], e = 0; e < l.length; e++) r[e] = l[e] * n;
                  return r;
                }),
                (u.minusOp = function (l, n) {
                  for (var r = [], e = 0; e < l.length; e++) r[e] = l[e] - n[e];
                  return r;
                }),
                (u.dotProduct = function (l, n) {
                  for (var r = 0, e = 0; e < l.length; e++) r += l[e] * n[e];
                  return r;
                }),
                (u.mag = function (l) {
                ...
                (u.normalize = function (l) {
                  for (var n = [], r = this.mag(l), e = 0; e < l.length; e++)
                    n[e] = l[e] / r;
                  return n;
                }),
                (u.multGamma = function (l) {
                  for (var n = [], r = 0, e = 0; e < l.length; e++) r += l[e];
                  r *= -1 / l.length;
                  for (var f = 0; f < l.length; f++) n[f] = r + l[f];
                  return n;
                }),
                (u.multL = function (l, n, r) {
                  for (
                    var e = [], f = [], i = [], g = 0;
                    g < n[0].length;
                    g++
                  ...
                  for (var T = 0; T < n.length; T++) {
                    for (var v = 0, d = 0; d < n[0].length; d++)
                      v += n[T][d] * i[d];
                    e[T] = v;
                  }
                  return e;
              ...
              var n = L(11),
                r = (function () {
                  function e(f, i) {
                    ...
                    var g = void 0;
                    f instanceof n ? (g = f.size()) : (g = f.length),
                  ...
                  return (
                    u(e, [
                      ...
                      },
                      {
                        key: '_get',
                        value: function (i, g) {
                          return i instanceof n ? i.get_object_at(g) : i[g];
                        },
                      },
                      {
                        key: '_set',
                        value: function (i, g, t) {
                          i instanceof n ? i.set_object_at(g, t) : (i[g] = t);
                        },
                      },
                      {
                        key: '_swap',
            ...
            function (A, G, L) {
              ...
              (u.svd = function (l) {
                ...
                for (
                  var B = a - 1, _ = Math.pow(2, -52), lt = Math.pow(2, -966);
                  a > 0;
                  ...
                  if (J === a - 2) Rt = 4;
                    ...
                    var Lt = void 0;
                    for (Lt = a - 1; Lt >= J && Lt !== J; Lt--) {
                      var vt =
                        (Lt !== a ? Math.abs(r[Lt]) : 0) +
                    ...
                    case 1:
                      {
                        var it = r[a - 2];
                        r[a - 2] = 0;
                        for (var gt = a - 2; gt >= J; gt--) {
                          var Tt = u.hypot(this.s[gt], it),
                            At = this.s[gt] / Tt,
                            Dt = it / Tt;
                          (this.s[gt] = Tt),
                            gt !== J &&
                          ...
                          for (var mt = 0; mt < this.n; mt++)
                            (Tt = At * this.V[mt][gt] + Dt * this.V[mt][a - 1]),
                              (this.V[mt][a - 1] =
                                -Dt * this.V[mt][gt] + At * this.V[mt][a - 1]),
                              (this.V[mt][gt] = Tt);
                        }
                      }
                      break;
                    case 2:
                      {
                        var xt = r[J - 1];
                        r[J - 1] = 0;
                        for (var St = J; St < a; St++) {
                          var Vt = u.hypot(this.s[St], xt),
                            Xt = this.s[St] / Vt,
                            Ut = xt / Vt;
                          (this.s[St] = Vt),
                            (xt = -Ut * r[St]),
                          ...
                          for (var bt = 0; bt < this.m; bt++)
                            (Vt = Xt * this.U[bt][St] + Ut * this.U[bt][J - 1]),
                              (this.U[bt][J - 1] =
                    ...
                    case 3:
                      {
                        ...
                        (function (Nt, Mt) {
                          ...
                          (ut = nt / (k + ut)));
                        for (
                          var ot = ($ + Bt) * ($ - Bt) + ut, tt = $ * Q, j = J;
                          j < a - 1;
                          j++
                        ) {
                          var dt = u.hypot(ot, tt),
                            wt = ot / dt,
                            yt = tt / dt;
                          j !== J && (r[j - 1] = dt),
                ...
                (u.hypot = function (l, n) {
                  var r = void 0;
                  return (
                    Math.abs(l) > Math.abs(n)
                      ? ((r = n / l), (r = Math.abs(l) * Math.sqrt(1 + r * r)))
                      : n != 0
                        ? ((r = l / n),
                          (r = Math.abs(n) * Math.sqrt(1 + r * r)))
                        : (r = 0),
                    r
                  );
                }),
            ...
            function (A, G, L) {
              ...
              (l.addListener = function (n, r) {
                this.listeners.push({ event: n, callback: r });
              }),
        ...
        (function (G, L) {
          ...
          return (() => {
                ...
                765: (n, r, e) => {
                  ...
                  (D.prototype.newGraphManager = function () {
                    ...
                    (D.prototype.layout = function () {
                      var a = T.DEFAULT_CREATE_BENDS_AS_NEEDED;
                      return (
                        a &&
                    ...
                    (D.prototype.getPositionsData = function () {
                      for (
                        var a = this.graphManager.getAllNodes(), m = {}, p = 0;
                        p < a.length;
                        p++
                      ) {
                        var E = a[p].rect,
                    ...
                    (D.prototype.moveNodes = function () {
                      for (
                        var a = this.getAllNodes(), m, p = 0;
                        p < a.length;
                        p++
                      )
                        (m = a[p]), m.calculateDisplacement();
                      Object.keys(this.constraints).length > 0 &&
                        this.updateDisplacements();
                      for (var p = 0; p < a.length; p++) (m = a[p]), m.move();
                    }),
                    (D.prototype.initConstraintVariables = function () {
                      ...
                      var y = function O(H) {
                        for (
                          ...
                          (_ = B[J]),
                            _.getChild() == null
                              ? a.fixedNodeSet.has(_.id) && (lt += 100)
                              : (lt += O(_));
                        return lt;
                      };
                      ...
                      if (this.constraints.relativePlacementConstraint) {
                        ...
                        if (
                          ...
                          this.fixedNodeSet.forEach(function (O) {
                            a.fixedNodesOnHorizontal.add(O),
                              a.fixedNodesOnVertical.add(O);
                          }),
                            ...
                            for (
                              ...
                              this.dummyToNodeForVerticalAlignment.set(
                                ...
                                W[p].forEach(function (H) {
                                  w.set(H, 'dummy' + p),
                                    a.dummyToNodeForVerticalAlignment
                                      .get('dummy' + p)
                                      .push(H),
                                    a.fixedNodeSet.has(H) &&
                                      a.fixedNodesOnHorizontal.add('dummy' + p);
                                });
                            ...
                            for (
                              ...
                              this.dummyToNodeForHorizontalAlignment.set(
                                ...
                                x[p].forEach(function (H) {
                                  R.set(H, 'dummy' + p),
                                    a.dummyToNodeForHorizontalAlignment
                                      .get('dummy' + p)
                                      .push(H),
                                    a.fixedNodeSet.has(H) &&
                                      a.fixedNodesOnVertical.add('dummy' + p);
                                });
                        }
                                ...
                                if (O.left) {
                                  var H = w.has(O.left)
                                    ...
                                    B = w.has(O.right)
                                      ? w.get(O.right)
                                      : O.right;
                                  a.nodesInRelativeHorizontal.includes(H) ||
                                    (a.nodesInRelativeHorizontal.push(H),
                                    a.nodeToRelativeConstraintMapHorizontal.set(
                                      H,
                                      [],
                                    ),
                                    a.dummyToNodeForVerticalAlignment.has(H)
                                      ? a.nodeToTempPositionMapHorizontal.set(
                                          H,
                                          a.idToNodeMap
                                            .get(
                                              a.dummyToNodeForVerticalAlignment.get(
                                                H,
                                              )[0],
                                            )
                                            .getCenterX(),
                                      ...
                                      : a.nodeToTempPositionMapHorizontal.set(
                                          H,
                                          a.idToNodeMap.get(H).getCenterX(),
                                        )),
                                    a.nodesInRelativeHorizontal.includes(B) ||
                                      (a.nodesInRelativeHorizontal.push(B),
                                      a.nodeToRelativeConstraintMapHorizontal.set(
                                        B,
                                        [],
                                      ),
                                      a.dummyToNodeForVerticalAlignment.has(B)
                                        ...
                                        : a.nodeToTempPositionMapHorizontal.set(
                                            B,
                                            a.idToNodeMap.get(B).getCenterX(),
                                          )),
                                  ...
                                  var _ = R.has(O.top) ? R.get(O.top) : O.top,
                                    lt = R.has(O.bottom)
                                      ? R.get(O.bottom)
                                      : O.bottom;
                                  a.nodesInRelativeVertical.includes(_) ||
                                    (a.nodesInRelativeVertical.push(_),
                                    a.nodeToRelativeConstraintMapVertical.set(
                                      _,
                                      [],
                                    ),
                                    a.dummyToNodeForHorizontalAlignment.has(_)
                                      ? a.nodeToTempPositionMapVertical.set(
                                          _,
                                          a.idToNodeMap
                                            .get(
                                              a.dummyToNodeForHorizontalAlignment.get(
                                                _,
                                              )[0],
                                            )
                                            .getCenterY(),
                                      ...
                                      : a.nodeToTempPositionMapVertical.set(
                                          _,
                                          a.idToNodeMap.get(_).getCenterY(),
                                        )),
                                    a.nodesInRelativeVertical.includes(lt) ||
                                      (a.nodesInRelativeVertical.push(lt),
                                      a.nodeToRelativeConstraintMapVertical.set(
                                        lt,
                                        [],
                                      ),
                                      a.dummyToNodeForHorizontalAlignment.has(
                                        lt,
                                      )
                                        ? a.nodeToTempPositionMapVertical.set(
                                            lt,
                                        ...
                                        : a.nodeToTempPositionMapVertical.set(
                                            lt,
                                            a.idToNodeMap.get(lt).getCenterY(),
                                          )),
                                    a.nodeToRelativeConstraintMapVertical
                                      .get(_)
                              ...
                              return (
                                H.forEach(function (vt, it) {
                                  if (!Rt.has(it)) {
                                    ...
                                    var gt = it;
                                    for (
                                      J.push(gt), Rt.add(gt), _[Lt].push(gt);
                                      J.length != 0;
                    ...
                    (D.prototype.updateDisplacements = function () {
                      ...
                      if (
                        (this.constraints.fixedNodeConstraint &&
                          this.constraints.fixedNodeConstraint.forEach(
                            function (z) {
                              var O = a.idToNodeMap.get(z.nodeId);
                        ...
                        if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                          this.totalIterations % 10 == 0 &&
                            ...
                            this.nodesInRelativeHorizontal.forEach(
                              function (z) {
                                if (!a.fixedNodesOnHorizontal.has(z)) {
                                  var O = 0;
                                  a.dummyToNodeForVerticalAlignment.has(z)
                                    ? (O = a.idToNodeMap.get(
                                        a.dummyToNodeForVerticalAlignment.get(
                                          z,
                                        )[0],
                                      ).displacementX)
                                    : (O = a.idToNodeMap.get(z).displacementX),
                                    a.nodeToRelativeConstraintMapHorizontal
                                      .get(z)
                                      .forEach(function (H) {
                                        if (H.right) {
                                          var B =
                                            a.nodeToTempPositionMapHorizontal.get(
                                              H.right,
                                            ) -
                                            a.nodeToTempPositionMapHorizontal.get(
                                              z,
                                    ...
                                    a.nodeToTempPositionMapHorizontal.set(
                                      z,
                                      a.nodeToTempPositionMapHorizontal.get(z) +
                                        O,
                                    ),
                                    a.dummyToNodeForVerticalAlignment.has(z)
                                      ? a.dummyToNodeForVerticalAlignment
                                          .get(z)
                                          .forEach(function (H) {
                                            a.idToNodeMap.get(H).displacementX =
                                              O;
                                          })
                                      : (a.idToNodeMap.get(z).displacementX =
                                          O);
                                }
                              },
                            ),
                            this.nodesInRelativeVertical.forEach(function (z) {
                              if (!a.fixedNodesOnHorizontal.has(z)) {
                                var O = 0;
                                a.dummyToNodeForHorizontalAlignment.has(z)
                                  ? (O = a.idToNodeMap.get(
                                      a.dummyToNodeForHorizontalAlignment.get(
                                        z,
                                      )[0],
                                    ).displacementY)
                                  : (O = a.idToNodeMap.get(z).displacementY),
                                  a.nodeToRelativeConstraintMapVertical
                                    .get(z)
                                    .forEach(function (H) {
                                      if (H.bottom) {
                                        var B =
                                          a.nodeToTempPositionMapVertical.get(
                                            H.bottom,
                                          ) -
                                          a.nodeToTempPositionMapVertical.get(
                                            z,
                                  ...
                                  a.nodeToTempPositionMapVertical.set(
                                    z,
                                    a.nodeToTempPositionMapVertical.get(z) + O,
                                  ),
                                  a.dummyToNodeForHorizontalAlignment.has(z)
                                    ? a.dummyToNodeForHorizontalAlignment
                                        .get(z)
                                        .forEach(function (H) {
                                          a.idToNodeMap.get(H).displacementY =
                                            O;
                                        })
                                    : (a.idToNodeMap.get(z).displacementY = O);
                              }
                            });
                        else {
                          for (
                            ...
                            if (this.fixedComponentsOnHorizontal[p])
                              for (var y = 0; y < x.length; y++)
                                this.dummyToNodeForVerticalAlignment.has(x[y])
                                  ? this.dummyToNodeForVerticalAlignment
                                      .get(x[y])
                                      .forEach(function (H) {
                                        a.idToNodeMap.get(H).displacementX = 0;
                                      })
                              ...
                              for (var q = 0, V = 0, y = 0; y < x.length; y++)
                                if (
                                  ...
                                  (q +=
                                    Y.length *
                                    this.idToNodeMap.get(Y[0]).displacementX),
                                    (V += Y.length);
                                } else
                              ...
                              for (var et = q / V, y = 0; y < x.length; y++)
                                this.dummyToNodeForVerticalAlignment.has(x[y])
                                  ? this.dummyToNodeForVerticalAlignment
                                      .get(x[y])
                                      .forEach(function (H) {
                                        a.idToNodeMap.get(H).displacementX = et;
                                      })
                                  : (this.idToNodeMap.get(x[y]).displacementX =
                                      et);
                            }
                            ...
                            if (this.fixedComponentsOnVertical[p])
                              for (var y = 0; y < x.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(x[y])
                                  ? this.dummyToNodeForHorizontalAlignment
                                      .get(x[y])
                                      .forEach(function (B) {
                                        a.idToNodeMap.get(B).displacementY = 0;
                                      })
                              ...
                              for (var q = 0, V = 0, y = 0; y < x.length; y++)
                                if (
                                  ...
                                  (q +=
                                    Y.length *
                                    this.idToNodeMap.get(Y[0]).displacementY),
                                    (V += Y.length);
                                } else
                                  (q += this.idToNodeMap.get(
                                    x[y],
                              ...
                              for (var et = q / V, y = 0; y < x.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(x[y])
                                  ? this.dummyToNodeForHorizontalAlignment
                                      .get(x[y])
                                      .forEach(function (J) {
                                        a.idToNodeMap.get(J).displacementY = et;
                                      })
                                  : (this.idToNodeMap.get(x[y]).displacementY =
                                      et);
                            }
                    ...
                    (D.prototype.calculateNodesToApplyGravitationTo =
                      function () {
                        ...
                        for (y = 0; y < E; y++)
                          (m = p[y]),
                            m.updateConnected(),
                            m.isConnected || (a = a.concat(m.getNodes()));
                        return a;
                      }),
                    (D.prototype.createBendpoints = function () {
                      ...
                      for (p = 0; p < a.length; p++) {
                        ...
                        if (m.size == a.length) break;
                      }
                    }),
                    (D.prototype.positionNodesRadially = function (a) {
                      for (
                        var m = new v(0, 0),
                          p = Math.ceil(Math.sqrt(a.length)),
                          E = 0,
                          y = 0,
                          I = 0,
                          w = new d(0, 0),
                    ...
                    (D.radialLayout = function (a, m, p) {
                      var E = Math.max(
                        this.maxDiagonalInTree(a),
                        o.DEFAULT_RADIAL_SEPARATION,
                      );
                      D.branchRadialLayout(m, null, 0, 359, 0, E);
                      var y = K.calculateBounds(a),
                        I = new X();
                    ...
                    (D.branchRadialLayout = function (a, m, p, E, y, I) {
                      var w = (E - p + 1) / 2;
                      w < 0 && (w += 180);
                      var R = (w + p) % 360,
                        W = (R * P.TWO_PI) / 360,
                      ...
                      a.setCenter(x, q);
                      var V = [];
                      V = V.concat(a.getEdges());
                      var Y = V.length;
                      m != null && Y--;
                      for (
                        var et = 0, z = V.length, O, H = a.getEdgesBetween(m);
                        H.length > 1;
                      ...
                      for (
                        var lt = Math.abs(E - p) / Y, J = O;
                        et != Y;
                        J = ++J % z
                      ) {
                        var Rt = V[J].getOtherEnd(a);
                        if (Rt != m) {
                          var Lt = (p + et * lt) % 360,
                            vt = (Lt + lt) % 360;
                          D.branchRadialLayout(Rt, a, Lt, vt, y + I, I), et++;
                        }
                      }
                    }),
                    (D.maxDiagonalInTree = function (a) {
                      for (var m = M.MIN_VALUE, p = 0; p < a.length; p++) {
                        var E = a[p],
                          y = E.getDiagonal();
                        y > m && (m = y);
                      }
                    ...
                    (D.prototype.groupZeroDegreeMembers = function () {
                      ...
                      Object.keys(m).forEach(function (W) {
                        if (m[W].length > 1) {
                          ...
                          a.memberGroups[x] = m[W];
                          var q = m[W][0].getParent(),
                            V = new t(a.graphManager);
                          (V.id = x),
                            ...
                            (a.idToDummyNode[x] = V);
                          var Y = a.getGraphManager().add(a.newGraph(), V),
                            et = q.getChild();
                          et.add(V);
                    ...
                    (D.prototype.clearCompounds = function () {
                      ...
                      for (var p = 0; p < this.compoundOrder.length; p++)
                        (m[this.compoundOrder[p].id] = this.compoundOrder[p]),
                          (a[this.compoundOrder[p].id] = [].concat(
                    ...
                    (D.prototype.repopulateZeroDegreeMembers = function () {
                      ...
                      Object.keys(m).forEach(function (p) {
                        var E = a.idToDummyNode[p],
                          ...
                          w = E.labelMarginLeft,
                          R = E.labelMarginTop;
                        a.adjustLocations(m[p], E.rect.x, E.rect.y, y, I, w, R);
                      });
                    }),
                    ...
                    (D.prototype.getNodeDegreeWithChildren = function (a) {
                      var m = this.getNodeDegree(a);
                      if (a.getChild() == null) return m;
                      for (
                        var p = a.getChild().getNodes(), E = 0;
                        E < p.length;
                        E++
                      ) {
                        var y = p[E];
                    ...
                    (D.prototype.adjustLocations = function (
                      ...
                      (m += E + I), (p += y + w);
                      for (var R = m, W = 0; W < a.rows.length; W++) {
                        var x = a.rows[W];
                        m = R;
                        for (var q = 0, V = 0; V < x.length; V++) {
                          ...
                          (Y.rect.x = m),
                            (Y.rect.y = p),
                            (m += Y.rect.width + a.horizontalPadding),
                            Y.rect.height > q && (q = Y.rect.height);
                        }
                        p += q + a.verticalPadding;
                      }
                    }),
                    (D.prototype.tileCompoundMembers = function (a, m) {
                      var p = this;
                    ...
                    (D.prototype.tileNodes = function (a, m) {
                      var p = this.tileNodesByFavoringDim(a, m, !0),
                        E = this.tileNodesByFavoringDim(a, m, !1),
                    ...
                    (D.prototype.calcIdealRowWidth = function (a, m) {
                    ...
                    (D.prototype.tileNodesByFavoringDim = function (a, m, p) {
                      ...
                      I && (w.idealRowWidth = this.calcIdealRowWidth(a, p));
                      var R = function (O) {
                      ...
                      for (var x = 0, q = 0, V = 0; V < a.length; V++) {
                        var Y = a[V];
                        (x += Y.getCenterX()), (q += Y.getCenterY());
                      }
                      (w.centerX = x / a.length), (w.centerY = q / a.length);
                      for (var V = 0; V < a.length; V++) {
                        var Y = a[V];
                        if (w.rows.length == 0)
                          this.insertNodeToRow(w, Y, 0, m);
                        else if (
                          this.canAddHorizontal(w, Y.rect.width, Y.rect.height)
                        ) {
                    ...
                    (D.prototype.insertNodeToRow = function (a, m, p, E) {
                      var y = E;
                      if (p == a.rows.length) {
                        var I = [];
                        a.rows.push(I), a.rowWidth.push(y), a.rowHeight.push(0);
                      }
                      var w = a.rowWidth[p] + m.rect.width;
                      a.rows[p].length > 0 && (w += a.horizontalPadding),
                        (a.rowWidth[p] = w),
                        a.width < w && (a.width = w);
                      var R = m.rect.height;
                      p > 0 && (R += a.verticalPadding);
                      var W = 0;
                      R > a.rowHeight[p] &&
                        ((W = a.rowHeight[p]),
                        (a.rowHeight[p] = R),
                    ...
                    (D.prototype.getShortestRowIndex = function (a) {
                      for (
                        ...
                        a.rowWidth[E] < p && ((m = E), (p = a.rowWidth[E]));
                      return m;
                    }),
                    ...
                    (D.prototype.canAddHorizontal = function (a, m, p) {
                      if (a.idealRowWidth) {
                        var E = a.rows.length - 1,
                          y = a.rowWidth[E];
                        return y + m + a.horizontalPadding <= a.idealRowWidth;
                      }
                      var I = this.getShortestRowIndex(a);
                      if (I < 0) return !0;
                      var w = a.rowWidth[I];
                      if (w + a.horizontalPadding + m <= a.width) return !0;
                      var R = 0;
                      a.rowHeight[I] < p &&
                        I > 0 &&
                        (R = p + a.verticalPadding - a.rowHeight[I]);
                      var W;
                      a.width - w >= m + a.horizontalPadding
                        ? (W = (a.height + R) / (w + m + a.horizontalPadding))
                        : (W = (a.height + R) / a.width),
                        (R = p + a.verticalPadding);
                      var x;
                      return (
                        a.width < m
                          ? (x = (a.height + R) / m)
                          : (x = (a.height + R) / a.width),
                        x < 1 && (x = 1 / x),
                        W < 1 && (W = 1 / W),
                        W < x
                      );
                    ...
                    (D.prototype.shiftToLastRow = function (a) {
                      var m = this.getLongestRowIndex(a),
                        p = a.rowWidth.length - 1,
                        E = a.rows[m],
                        y = E[E.length - 1],
                        I = y.width + a.horizontalPadding;
                      if (a.width - a.rowWidth[p] > I && m != p) {
                        E.splice(-1, 1),
                          a.rows[p].push(y),
                          (a.rowWidth[m] = a.rowWidth[m] - I),
                          (a.rowWidth[p] = a.rowWidth[p] + I),
                          (a.width =
                            a.rowWidth[instance.getLongestRowIndex(a)]);
                        for (var w = Number.MIN_VALUE, R = 0; R < E.length; R++)
                          E[R].height > w && (w = E[R].height);
                        m > 0 && (w += a.verticalPadding);
                        var W = a.rowHeight[m] + a.rowHeight[p];
                        (a.rowHeight[m] = w),
                          a.rowHeight[p] < y.height + a.verticalPadding &&
                            (a.rowHeight[p] = y.height + a.verticalPadding);
                        var x = a.rowHeight[m] + a.rowHeight[p];
                        (a.height += x - W), this.shiftToLastRow(a);
                      }
                    }),
                    ...
                    (D.prototype.findPlaceforPrunedNode = function (a) {
                      ...
                      if (
                        ...
                        E.setCenter(
                          p.getCenterX() + a[3].getWidth(),
                          p.getCenterY() + a[3].getHeight(),
                        );
                      else {
                        var y = p.startX,
                          I = p.finishX,
                    ...
                    var X = function (b, $) {
                          ...
                          var wt = function () {
                            ...
                            Ct.forEach(function (ct) {
                              ...
                              ot.set(ct.id, ot.get(ct.id) - 1),
                                ...
                                Q && j.set(ct.id, ut(j.get(st), j.get(ct.id)));
                            });
                          };
                          dt.length != 0;
                      ...
                      a = function (b) {
                        var $ = [],
                          ...
                          nt = 0;
                        return (
                          b.forEach(function (ut, ot) {
                            if (!k.has(ot)) {
                              $[nt] = [];
                              var tt = ot;
                              for (
                                Q.push(tt), k.add(tt), $[nt].push(tt);
                                Q.length != 0;
                      ...
                      if (I) {
                        ...
                        for (var gt = 0; gt < v.size; gt++) {
                          var Tt = [d[gt], N[gt]],
                            At = [lt[0][0], lt[1][0]],
                            Dt = [lt[0][1], lt[1][1]];
                          (d[gt] = t.dotProduct(Tt, At)),
                            (N[gt] = t.dotProduct(Tt, Dt));
                        }
                    ...
                    if (i.ENFORCE_CONSTRAINTS) {
                        ...
                        if (h.alignmentConstraint.vertical)
                          for (
                            var xt = h.alignmentConstraint.vertical,
                              St = function (b) {
                                var $ = new Set();
                                xt[b].forEach(function (nt) {
                                  $.add(nt);
                                });
                                var Q = new Set(
                                    [].concat(f($)).filter(function (nt) {
                                      return R.has(nt);
                                    }),
                                  ),
                                  k = void 0;
                      ...
                      h.relativePlacementConstraint &&
                        (function () {
                                ...
                                var wt = h.alignmentConstraint.horizontal,
                                  yt = function (Et) {
                                    Q.set('dummy' + Et, []),
                                      ...
                                      nt.set('dummy' + Et, N[v.get(wt[Et][0])]);
                                  },
                                  It = 0;
                                It < wt.length;
                                It++
                          ...
                          var ee = D(ft, 'horizontal', ut, k, Kt),
                            jt = D(st, 'vertical', ot, nt, te),
                            se = function (Et) {
                              $.get(Et)
                          ...
                          try {
                            for (
                              var ue = ee.keys()[Symbol.iterator](), Ae;
                              !(re = (Ae = ue.next()).done);
                              re = !0
                            ) {
                              var ge = Ae.value;
                          ...
                          try {
                            for (
                              var ve = jt.keys()[Symbol.iterator](), De;
                              !(de = (De = ve.next()).done);
                              de = !0
                            ) {
                              var ge = De.value;
            ...
            function u(n) {
              ...
              var e = (L[n] = { exports: {} });
              return G[n](e, e.exports, u), e.exports;
            }
            var l = u(45);
            return l;
          })();
              ...
              (g.connectComponents = function (t, s, o, c) {
                var h = new i(),
                  ...
                  Z = function () {
                    ...
                    var a = o[0],
                      m = t.collection();
                    m.merge(a).merge(a.descendants().intersection(s)),
                      v.push(a),
                    ...
                    for (
                      var p = function () {
                        ...
                        a.neighborhood()
                          .nodes()
                          .forEach(function (x) {
                            s.intersection(a.edgesWith(x)).length > 0 &&
                              I.merge(x);
                          });
            ...
            var f = e(548),
              ...
              T = function (d, N) {
                var S = d.cy,
                  ...
                  rt = {};
                d.randomize &&
                  ((X = N.nodeIndexes), (Z = N.xCoords), (D = N.yCoords));
                var a = function (x) {
                  ...
                  E = function W(x, q, V, Y) {
                    for (var et = q.length, z = 0; z < et; z++) {
                      ...
                      if (O.outerWidth() != null && O.outerHeight() != null)
                        if (Y.randomize)
                          if (!O.isParent())
                            ...
                            var lt = f.calcBoundingBox(O, Z, D, X);
                      ...
                      if (
                        ((B.id = O.data('id')),
                        (B.nodeRepulsion = m(Y.nodeRepulsion, O)),
                ...
                d.nestingFactor != null &&
                  ...
                  d.quality == 'proof' ? (o.QUALITY = 2) : (o.QUALITY = 0),
                  ...
                  (o.DEFAULT_UNIFORM_LEAF_NODE_SIZES = d.uniformNodeDimensions),
                  d.step == 'transformed' &&
                        ...
                        M.fixedNodeConstraint &&
                          ...
                          M.alignmentConstraint &&
                            (M.alignmentConstraint.vertical &&
                              (!Array.isArray(M.alignmentConstraint.vertical) ||
                                M.alignmentConstraint.vertical.length == 0) &&
                              (M.alignmentConstraint.vertical = void 0),
                            M.alignmentConstraint.horizontal &&
                              (!Array.isArray(
                                M.alignmentConstraint.horizontal,
                              ) ||
                                M.alignmentConstraint.horizontal.length == 0) &&
                              (M.alignmentConstraint.horizontal = void 0)),
                          M.relativePlacementConstraint &&
                            (!Array.isArray(M.relativePlacementConstraint) ||
                              M.relativePlacementConstraint.length == 0) &&
                            (M.relativePlacementConstraint = void 0);
                        var a =
                          M.fixedNodeConstraint ||
                          M.alignmentConstraint ||
                          M.relativePlacementConstraint;
                        a && ((M.tile = !1), (M.packComponents = !1));
                        var m = void 0,
                          p = !1;
                        if (
                          (P.layoutUtilities &&
                          ...
                          if (p) {
                              ...
                              if (M.tile) {
                                ...
                                if (
                                  (D.forEach(function (vt, it) {
                                    vt.edges().length == 0 &&
                                      (vt.nodes().forEach(function (gt, Tt) {
                                        w.merge(vt.nodes()[Tt]),
                                          gt.isParent() ||
                                            (V.nodeIndexes.set(
                                              vt.nodes()[Tt].id(),
                                      ...
                                      if (
                                        ...
                                        if (M.quality == 'draft') {
                                          ...
                                          if (mt.isParent()) {
                                            ...
                                            Xt.push(bt.topLeftX + bt.width / 2),
                                              Xt.push(
                                                bt.topLeftY + bt.height / 2,
                                              );
                                          } else
                                            Xt.push(X[it].xCoords[St]),
                                              Xt.push(X[it].yCoords[St]);
                                          if (xt.isParent()) {
                                            ...
                                            Ut.push(Ht.topLeftX + Ht.width / 2),
                                              Ut.push(
                                                Ht.topLeftY + Ht.height / 2,
                                              );
                                          } else
                                            Ut.push(X[it].xCoords[Vt]),
                                              Ut.push(X[it].yCoords[Vt]);
                                          Tt.edges.push({
                                            startX: Xt[0],
                                            startY: Xt[1],
                                            endX: Ut[0],
                                          ...
                                          Z[it][mt.id()] &&
                                            ...
                                            Tt.edges.push({
                                              startX:
                                                Z[it][mt.id()].getCenterX(),
                                              startY:
                                                Z[it][mt.id()].getCenterY(),
                                              endX: Z[it][xt.id()].getCenterX(),
                                              endY: Z[it][xt.id()].getCenterY(),
                                            });
                                    }),
                                    Tt.nodes.length > 0 &&
                                      (H.push(Tt), O.add(it));
                              ...
                              if (M.quality == 'draft')
                                ...
                                O.forEach(function (vt) {
                                  Object.keys(Z[vt]).forEach(function (it) {
                                    var gt = Z[vt][it];
                                    gt.setCenter(
                                      gt.getCenterX() + _[lt].dx,
                                      gt.getCenterY() + _[lt].dy,
                                    );
                                  }),
                                    lt++;
                                });
                            ...
                            M.quality == 'default' || M.quality == 'proof'
                              ...
                              : t.relocateComponent(rt[0], X[0], M);
                          }
            ...
            var f = e(548),
              ...
              t = function (o) {
                var c = o.cy,
                  ...
                  x = function (b, $, Q) {
                    for (
                      ...
                      j[yt] = p;
                    for (k[ut] = b, j[b] = 0; ut >= nt; ) {
                      ot = k[nt++];
                      for (var It = M[ot], ft = 0; ft < It.length; ft++)
                        (tt = N.get(It[ft])),
                          j[tt] == p && ((j[tt] = j[ot] + 1), (k[++ut] = tt));
                      D[ot][$] = j[ot] * w;
                    }
                    if (Q) {
                  ...
                  q = function (b) {
                    ...
                    if (b) {
                      ...
                      W();
                      for (var Q = 0; Q < R; Q++) x(X[Q], Q, b);
                    }
                    for (var ut = 0; ut < m; ut++)
                      for (var ot = 0; ot < R; ot++) D[ut][ot] *= D[ut][ot];
                    for (var tt = 0; tt < R; tt++) rt[tt] = [];
                    for (var j = 0; j < R; j++)
                      for (var dt = 0; dt < R; dt++) rt[j][dt] = D[X[dt]][j];
                  },
                  V = function () {
                    for (
                      var b = g.svd(rt),
                    ...
                    a = i.multMat(i.multMat(k, ut), i.transpose(Q));
                  },
                  Y = function () {
                    for (
                      var b = void 0,
                    ...
                    for (var tt = E, j = E, dt = void 0; ; ) {
                      for (var wt = 0; wt < m; wt++) nt[wt] = Q[wt];
                      if (
                        ((Q = i.multGamma(i.multL(i.multGamma(nt), D, a))),
                        (b = i.dotProduct(nt, Q)),
                        (Q = i.normalize(Q)),
                        (tt = i.dotProduct(nt, Q)),
                        (dt = Math.abs(tt / j)),
                        dt <= 1 + y && dt >= 1)
                      )
                        break;
                    ...
                    for (var yt = 0; yt < m; yt++) nt[yt] = Q[yt];
                    for (j = E; ; ) {
                      for (var It = 0; It < m; It++) ut[It] = k[It];
                      if (
                        ((ut = i.minusOp(
                          ut,
                          i.multCons(nt, i.dotProduct(nt, ut)),
                        )),
                        (k = i.multGamma(i.multL(i.multGamma(ut), D, a))),
                        ($ = i.dotProduct(ut, k)),
                        (k = i.normalize(k)),
                        (tt = i.dotProduct(ut, k)),
                        (dt = Math.abs(tt / j)),
                        dt <= 1 + y && dt >= 1)
                      )
                        break;
                    ...
                    for (var ft = 0; ft < m; ft++) ut[ft] = k[ft];
                    (P = i.multCons(nt, Math.sqrt(Math.abs(b)))),
                      (K = i.multCons(ut, Math.sqrt(Math.abs($))));
                  };
                ...
                v.forEach(function (F) {
                  ...
                  b.nodes(':childless').forEach(function (k, nt) {
                    k.connectedEdges().length < Q &&
                      ((Q = k.connectedEdges().length), ($ = nt));
                  }),
                ...
                var Lt = function (b) {
                    ...
                    d.get(b).forEach(function (k) {
                      c.getElementById(k).isParent() ? (Q = S.get(k)) : (Q = k),
                        M[$].push(Q),
                        M[N.get(Q)].push(b);
                    });
                  },
...
var gr = Ge.exports;
const dr = fr(gr);
var Re = { L: 'left', R: 'right', T: 'top', B: 'bottom' },
  Se = {
    L: at((C) => `${C},${C / 2} 0,${C} 0,0`, 'L'),
    R: at((C) => `0,${C / 2} ${C},0 ${C},${C}`, 'R'),
    T: at((C) => `0,0 ${C},0 ${C / 2},${C}`, 'T'),
    B: at((C) => `${C / 2},0 ${C},${C} 0,${C}`, 'B'),
  },
  he = {
    L: at((C, U) => C - U + 2, 'L'),
    R: at((C, U) => C - 2, 'R'),
  ...
  Ue = at((C) => C.data(), 'edgeData'),
  ae = at((C) => C.data(), 'nodeData'),
  Ye = qe.architecture,
  pt = new hr(() => ({
    nodes: {},
    groups: {},
  ...
  Mr = at(function ({ id: C, icon: U, in: A, title: G, iconText: L }) {
  ...
  Ar = at(() => Object.values(pt.records.nodes).filter(Nr), 'getServices'),
  wr = at(function ({ id: C, in: U }) {
    (pt.records.registeredIds[C] = 'node'),
      (pt.records.nodes[C] = { id: C, type: 'junction', edges: [], in: U });
  }, 'addJunction'),
  Or = at(() => Object.values(pt.records.nodes).filter(Lr), 'getJunctions'),
  Dr = at(() => Object.values(pt.records.nodes), 'getNodes'),
  Te = at((C) => pt.records.nodes[C], 'getNode'),
  xr = at(function ({ id: C, icon: U, in: A, title: G }) {
    if (pt.records.registeredIds[C] !== void 0)
      throw new Error(
    ...
    (pt.records.registeredIds[C] = 'group'),
      (pt.records.groups[C] = { id: C, icon: U, title: G, in: A });
  }, 'addGroup'),
  Ir = at(() => Object.values(pt.records.groups), 'getGroups'),
  Rr = at(function ({
    lhsId: C,
    rhsId: U,
    lhsDir: A,
    ...
    pt.records.edges.push(i),
      pt.records.nodes[C] &&
        ...
        pt.records.nodes[U].edges.push(
          pt.records.edges[pt.records.edges.length - 1],
        ));
  }, 'addEdge'),
  Sr = at(() => pt.records.edges, 'getEdges'),
  Fr = at(() => {
    if (pt.records.dataStructures === void 0) {
      const C = {},
        U = Object.entries(pt.records.nodes).reduce(
          (n, [r, e]) => (
            (n[r] = e.edges.reduce((f, i) => {
              var s, o;
              const g = (s = Te(i.lhsId)) == null ? void 0 : s.in,
        ...
        l = [u(A)];
      for (; Object.keys(L).length > 0; ) l.push(u(Object.keys(L)[0]));
  ...
  Pr = at((C) => pt.records.elements[C], 'getElementById'),
  le = {
    clear: Cr,
    setDiagramTitle: Ke,
    getDiagramTitle: je,
...
at(Pt, 'getConfigField');
var Gr = at((C, U) => {
    sr(C, U),
      C.groups.map(U.addGroup),
      C.services.map((A) => U.addService({ ...A, type: 'service' })),
      C.junctions.map((A) => U.addJunction({ ...A, type: 'junction' })),
      C.edges.map(U.addEdge);
  }, 'populateDb'),
  Ur = {
    parse: at(async (C) => {
  ...
  Hr = at(async function (C, U) {
    ...
    await Promise.all(
      U.edges().map(async (n) => {
        ...
        let { x: h, y: T } = n[0].sourceEndpoint();
        const { x: v, y: d } = n[0].midpoint();
        let { x: N, y: S } = n[0].targetEndpoint();
        const M = A + 4;
        if (
          (i &&
            (zt(e)
          ...
          o &&
            (zt(t)
              ...
              : (S += t === 'T' ? -M : M + 18)),
          !i &&
            ((P = le.getNode(r)) == null ? void 0 : P.type) === 'junction' &&
            (zt(e) ? (h += e === 'L' ? L : -L) : (T += e === 'T' ? L : -L)),
          !o &&
            ((K = le.getNode(g)) == null ? void 0 : K.type) === 'junction' &&
            (zt(t) ? (N += t === 'L' ? L : -L) : (S += t === 'T' ? L : -L)),
          n[0]._private.rscratch)
        ) {
          const X = C.insert('g');
          if (
            (X.insert('path')
  ...
  Wr = at(async function (C, U) {
    ...
    await Promise.all(
      U.nodes().map(async (n) => {
        const r = ae(n);
        if (r.type === 'group') {
          const { h: e, w: f, x1: i, y1: g } = n.boundingBox();
          C.append('rect')
            .attr('x', i + l)
            .attr('y', g + l)
            .attr('width', f)
      ...
      if (G.title) {
        ...
        await Ne(
          ...
          e
            ...
            .attr('dominant-baseline', 'middle')
            .attr('text-anchor', 'middle'),
          e.attr('transform', 'translate(' + u / 2 + ', ' + u + ')');
      }
      const l = L.append('g');
      if (G.icon)
        l.html(
        ...
        l.append('path')
          .attr('class', 'node-bkg')
          .attr('id', 'node-' + G.id)
          .attr('d', `M0 ${u} v${-u} q0,-5 5,-5 h${u} q5,0 5,5 v${u} H0 Z`);
      L.attr('class', 'architecture-service');
      const { width: n, height: r } = L._groups[0][0].getBBox();
      (G.width = n), (G.height = r), C.setElementForId(G.id, L);
    }
    return 0;
  }, 'drawServices'),
  zr = at(function (C, U, A) {
    A.forEach((G) => {
      const L = U.append('g'),
        u = Pt('iconSize');
      L.append('g')
      ...
      const { width: n, height: r } = L._groups[0][0].getBBox();
      (L.width = n), (L.height = r), C.setElementForId(G.id, L);
    });
  }, 'drawJunctions');
Qe([{ name: oe.prefix, icons: oe }]);
Pe.use(dr);
function Xe(C, U) {
  C.forEach((A) => {
    U.add({
...
function ze(C, U) {
  C.forEach((A) => {
    const {
      ...
      g = Ce(A.lhsDir, A.rhsDir) ? 'segments' : 'straight',
      t = {
        id: `${G}-${L}`,
        label: i,
        source: G,
    ...
    U.add({ group: 'edges', data: t, classes: g });
  });
}
at(ze, 'addEdges');
function Be(C, U, A) {
  const G = at(
    ...
    L = U.map((n) => {
      const r = {},
        e = {};
      return (
        Object.entries(n).forEach(([f, [i, g]]) => {
          var s, o, c;
...
function $e(C) {
  const U = [],
    A = at((L) => `${L[0]},${L[1]}`, 'posToStr'),
    G = at((L) => L.split(',').map((u) => parseInt(u)), 'strToPos');
  return (
    C.forEach((L) => {
...
at($e, 'getRelativeConstraints');
function ke(C, U, A, G, L, { spatialMaps: u, groupAlignments: l }) {
  return new Promise((n) => {
    ...
    g.one('layoutstop', () => {
      ...
      function t(o, c, h, T) {
        ...
        return (d = Math.abs(d) * X), (v = v * Z), { distances: d, weights: v };
      }
      at(t, 'getSegmentWeights'), e.startBatch();
        ...
        if ((s = o.data) != null && s.call(o)) {
          ...
          if (c !== T && h !== v) {
            const d = o.sourceEndpoint(),
              ...
              { weights: K, distances: X } = t(d, N, M, P);
...
at(ke, 'layoutArchitecture');
var Br = at(async (C, U, A, G) => {
    const L = G.db,
      u = L.getServices(),
      l = L.getJunctions(),
      n = L.getGroups(),
    ...
    const s = await ke(u, l, n, r, L, e);
    await Hr(i, s),
      await Wr(t, s),
      We(L, s),
      or(void 0, f, Pt('padding'), Pt('useMaxWidth'));
  }, 'draw'),
  $r = { draw: Br },
  ai = { parser: Ur, db: le, renderer: $r, styles: Xr };
