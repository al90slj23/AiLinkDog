...
var $ = (function () {
  var t = c(function (E, i, n, a) {
      for (n = n || {}, a = E.length; a--; n[E[a]] = i);
      return n;
    }, 'o'),
    g = [1, 4],
    d = [1, 13],
    ...
    V = {
      ...
      performAction: c(function (i, n, a, o, u, e, B) {
        var l = e.length - 1;
        switch (u) {
          case 6:
          case 7:
...
` +
        ...
        next: c(function () {
          ...
          for (var u = this._currentRules(), e = 0; e < u.length; e++)
            if (
              ...
              if (((n = a), (o = e), this.options.backtrack_lexer)) {
                if (((i = this.test_match(a, u[e])), i !== !1)) return i;
                if (this._backtrack) {
                  n = !1;
                  continue;
                } else return !1;
          ...
          return n
            ? ((i = this.test_match(n, u[o])), i !== !1 ? i : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
var Ne = $,
  ...
  Le = c((t, g, d, r, p) => {
    ...
    const h = {
      ...
      label: F(d, _),
      width:
        ((w = _.mindmap) == null ? void 0 : w.maxNodeWidth) ??
        Y.mindmap.maxNodeWidth,
      padding: f,
      isGroup: !1,
    };
    if (p !== void 0) {
...
` +
      ...
      const s = _e(N, { schema: ke });
      if (
        s.shape &&
        (s.shape !== s.shape.toLowerCase() || s.shape.includes('_'))
      )
        throw new Error(
          `No such shape: ${s.shape}. Shape names should be lowercase.`,
        );
      s != null &&
        s.shape &&
        s.shape === 'kanbanItem' &&
        (h.shape = s == null ? void 0 : s.shape),
        s != null && s.label && (h.label = s == null ? void 0 : s.label),
        s != null &&
          s.icon &&
          (h.icon = s == null ? void 0 : s.icon.toString()),
        s != null &&
          s.assigned &&
          (h.assigned = s == null ? void 0 : s.assigned.toString()),
        s != null &&
          s.ticket &&
          (h.ticket = s == null ? void 0 : s.ticket.toString()),
        s != null &&
          s.priority &&
          (h.priority = s == null ? void 0 : s.priority);
    }
    const L = ve(t);
  ...
  Ce = c((t) => {
    ...
    const g = W(),
      d = D[D.length - 1];
    t.icon && (d.icon = F(t.icon, g)),
      t.class && (d.cssClasses = F(t.class, g));
  }, 'decorateNode'),
  we = c((t) => {
    switch (t) {
      case y.DEFAULT:
...
` + t,
    ...
    const C = h.append('g');
    C.attr('class', 'items');
    const w = _.nodes.filter((m) => m.isGroup);
    let N = 0;
    const s = 10,
      G = [];
    let x = 25;
    for (const m of w) {
      ...
      (x = Math.max(
        x,
        (U = E == null ? void 0 : E.labelBBox) == null ? void 0 : U.height,
      )),
        G.push(E);
    }
    let P = 0;
    for (const m of w) {
      ...
      for (const e of a) {
        ...
        (e.x = m.x), (e.width = E - 1.5 * s);
        const l = (await be(C, e, { config: f })).node().getBBox();
        (e.y = n + l.height / 2), await me(e), (n = e.y + l.height / 2 + s / 2);
      }
      const o = O.cluster.select('rect'),
        u = Math.max(n - i + 3 * s, 50) + (x - 25);
      o.attr('height', u);
    }
    Ee(
      void 0,
...
`,
  ...
  Ge = Fe,
  Xe = { db: Pe, renderer: Be, parser: Ne, styles: Ge };
