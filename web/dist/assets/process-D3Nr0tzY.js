...
var to = (N, B, d) =>
  B in N
    ? eo(N, B, { enumerable: !0, configurable: !0, writable: !0, value: d })
    : (N[B] = d);
...
async function ao(N = {}) {
  ...
  typeof document < 'u' &&
    ...
    (cr = document.currentScript.src),
    cr.indexOf('blob:') !== 0 &&
      (Sr = cr.substr(0, cr.replace(/[?#].*/, '').lastIndexOf('/') + 1)),
    (Ar = async (r) => {
  ...
  function Ve() {
    (Yr = !0),
      !d.noFSInit && !o.initialized && o.init(),
      dr.P(),
    ...
    lt = (r) => {
      ...
      var t = e.elements,
        ...
        i = t
          ...
          .concat(t.map((l) => l.setterArgumentType)),
        a = e.rawConstructor,
        s = e.rawDestructor;
      j([r], i, (l) => {
    ...
    ut = (r) => {
      ...
      var t = e.rawConstructor,
        ...
        a = i
          ...
          .concat(i.map((s) => s.setterArgumentType));
      j([r], a, (s) => {
        var l = {};
  ...
  function ft(r, e, t = {}) {
    var n = e.name;
    if (
      (r || E(`type "${n}" must have a positive integer typeid pointer`),
      L.hasOwnProperty(r))
    ) {
      if (t.ignoreDuplicateRegistrations) return;
      E(`Cannot register type '${n}' twice`);
    }
    if (((L[r] = e), delete wr[r], J.hasOwnProperty(r))) {
      var i = J[r];
    ...
    mt = () => {
      ...
      Object.assign(r, {
        isAliasOf(t) {
          ...
          t.$$ = t.$$;
          for (
            var a = t.$$.ptrType.registeredClass, s = t.$$.ptr;
            n.baseClass;
  ...
  var de = (r, e, t) => {
    ...
    F = (r, e, t = !1) => {
      ...
      return (
        typeof i != 'function' &&
          E(`unknown function pointer with signature ${r}: ${e}`),
        i
      );
    };
  ...
  var ve = (r) => {
    ...
    At = (r, e, t, n, i, a, s, l, u, f, c, v, m) => {
      ...
      var h = yt(c);
      ar(h, function () {
        Z(`Cannot construct ${c} due to unbound types`, [n]);
      }),
        j([r, e, t], n ? [n] : [], (p) => {
          var Ue;
          p = p[0];
          var y, b;
          n
            ? ((y = p.registeredClass), (b = y.instancePrototype))
            : (b = Er.prototype);
          ...
          return (
            (le[r] = { pointerType: S, constPointerType: T }),
            de(h, _),
            [R, S, T]
          );
        });
  ...
  function xr(r, e, t, n, i, a) {
    ...
    var l = e[1] !== null && t !== null,
      ...
      p = function (...y) {
        ...
        (m.length = l ? 2 : 1),
          (m[0] = i),
          l && ((b = e[1].toWireType(h, this)), (m[1] = b));
        for (var _ = 0; _ < c; ++_)
  ...
  var Rt = (r, e, t, n, i, a) => {
        ...
        j([], [r], (l) => {
          ...
          return (
            (l.registeredClass.constructor_body[e - 1] = () => {
              Z(`Cannot construct ${l.name} due to unbound types`, s);
            }),
            j(
              [],
              s,
              (f) => (
                f.splice(1, 0, null),
                (l.registeredClass.constructor_body[e - 1] = xr(
                  u,
                  f,
                  null,
                  i,
    ...
    Ot = (r, e, t, n, i, a, s, l, u, f) => {
      ...
      (e = $(e)),
        ...
        j([], [r], (v) => {
          ...
          function h() {
            Z(`Cannot call ${m} due to unbound types`, c);
          }
      ...
      (e = $(e)),
        ...
        j([], [r], (c) => {
          ...
          var v = `${c.name}.${e}`,
            m = {
              get() {
                Z(`Cannot access ${v} due to unbound types`, [t, s]);
              },
              enumerable: !0,
              configurable: !0,
            };
            ...
            j([], u ? [t, s] : [t], (h) => {
              ...
              return (
                Object.defineProperty(
                  c.registeredClass.instancePrototype,
                  e,
                  y,
                ),
                []
    ...
    pe = [],
    V = [0, 1, , 1, null, 1, !0, 1, !1, 1],
    ge = (r) => {
      r > 9 && --V[r + 1] === 0 && (V[r], (V[r] = void 0), pe.push(r));
    },
    I = {
      toValue: (r) => (r || E(`Cannot use deleted val. handle = ${r}`), V[r]),
      toHandle: (r) => {
        switch (r) {
          case void 0:
            return 2;
          ...
          case !1:
            return 8;
          default: {
            const e = pe.pop() || V.length;
            return (V[e] = r), (V[e + 1] = 1), e;
          }
        }
      },
    },
  ...
  var xt = (r, e, t, n, i) => {
    ...
    It = (r, e, t, n, i, a, s, l) => {
      ...
      (r = $(r)),
        ...
        ar(
          r,
          function () {
            Z(`Cannot call ${r} due to unbound types`, u);
          },
          e - 1,
        ),
        j([], u, (f) => {
    ...
    Kt = (r, e, t) => {
      var n = r >> 1,
        i = Ee(K, n, e / 2, t);
      if (i - n > 16 && ke) return ke.decode(K.subarray(n, i));
      for (var a = '', s = n; s < i; ++s) {
        var l = K[s];
    ...
    Yt = (r, e, t) => {
      ...
      t -= 2;
      for (
        var n = e, i = t < r.length * 2 ? t / 2 : r.length, a = 0;
        a < i;
        ++a
      ) {
    ...
    Ce = (r) => {
      var e;
      (mr = r),
        Te() || ((e = d.onExit) == null || e.call(d, r), (hr = !0)),
        Kr(r, new Zr(r));
    },
    gn = (r, e) => {
      (mr = r), Ce(r);
    ...
    kn = (r, e, t, n) => {
      ...
      var c = (h) => {
        ...
        v = c(l),
        m = c(u);
      u < l ? (q(v, t, 17), q(m, n, 17)) : (q(v, n, 17), q(m, t, 17));
    },
    Pn = () => 2147483648,
    ...
    lr = () => {
      ...
      if (!lr.strings) {
        var r =
            (
              ((i = globalThis.navigator) == null ? void 0 : i.language) ?? 'C'
            ).replace('-', '_') + '.UTF-8',
          e = {
            USER: 'web_user',
            LOGNAME: 'web_user',
...
`)),
    ...
    X = {
      ...
      shutdown() {},
      register(r, e) {
        (X.ttys[r] = { input: [], output: [], ops: e }),
          o.registerDevice(r, X.stream_ops);
      },
      stream_ops: {
        open(r) {
          var e = X.ttys[r.node.rdev];
      ...
      default_tty_ops: {
        ...
        put_char(r, e) {
          e === null || e === 10
            ? (vr(Q(r.output)), (r.output = []))
            : e != 0 && r.output.push(e);
        },
        fsync(r) {
          var e;
          ((e = r.output) == null ? void 0 : e.length) > 0 &&
            (vr(Q(r.output)), (r.output = []));
        },
        ioctl_tcgets(r) {
          return {
    ...
    g = {
          ...
          o.isDir(i.mode)
            ...
            : o.isFile(i.mode)
              ? ((i.node_ops = g.ops_table.file.node),
                ...
                (i.contents =
                  g.emptyFileContents ??
                  (g.emptyFileContents = new Uint8Array(0))))
              : o.isLink(i.mode)
                ? ((i.node_ops = g.ops_table.link.node),
                  (i.stream_ops = g.ops_table.link.stream))
                : o.isChrdev(i.mode) &&
      ...
      node_ops: {
        ...
        rename(r, e, t) {
          ...
          if (n) {
            if (o.isDir(r.mode))
              for (var i in n.contents) throw new o.ErrnoError(55);
            o.hashRemoveNode(n);
          }
    ...
    jn = (r) => {
      ...
      if (
        (G--,
        (t = d.monitorRunDependencies) == null || t.call(d, G),
        G == 0 && ur)
      ) {
        var e = ur;
        (ur = null), e();
    ...
    xn = (r) => {
      var e;
      G++, (e = d.monitorRunDependencies) == null || e.call(d, G);
    },
    De = [],
    Mn = async (r, e) => {
    ...
    o = {
      ...
      lookupPath(r, e = {}) {
        ...
        e.follow_mount ?? (e.follow_mount = !0),
          k.isAbs(r) || (r = o.cwd() + '/' + r);
      ...
      lookupNode(r, e) {
        ...
        for (
          var n = o.hashName(r.id, e), i = o.nameTable[n];
          i;
          i = i.name_next
        ) {
          var a = i.name;
      ...
      mayOpen(r, e) {
        ...
        return o.isDir(r.mode) && (t !== 'r' || e & 576)
          ? 31
          : o.nodePermissions(r, t);
      },
      checkOpExists(r, e) {
      ...
      dupStream(r, e = -1) {
        ...
        return (
          (i = (n = t.stream_ops) == null ? void 0 : n.dup) == null ||
            i.call(n, t),
          t
        );
      },
      ...
      chrdev_stream_ops: {
        open(r) {
          ...
          (r.stream_ops = e.stream_ops),
            (n = (t = r.stream_ops).open) == null || n.call(t, r);
        },
        llseek() {
      ...
      statfsNode(r) {
        ...
        return (
          r.node_ops.statfs &&
            Object.assign(e, r.node_ops.statfs(r.mount.opts.root)),
          e
        );
      },
      create(r, e = 438) {
      ...
      mkdev(r, e, t) {
        return (
          typeof t > 'u' && ((t = e), (e = 438)), (e |= 8192), o.mknod(r, e, t)
        );
      },
      symlink(r, e) {
      ...
      ftruncate(r, e) {
        var t = o.getStreamChecked(r);
        if (e < 0 || !(t.flags & 2097155)) throw new o.ErrnoError(28);
      ...
      open(r, e, t = 438) {
        ...
        return (
          u.stream_ops.open && u.stream_ops.open(u), s && o.chmod(n, t & 511), u
        );
      },
      close(r) {
      ...
      createStandardStreams(r, e, t) {
        r
          ? o.createDevice('/dev', 'stdin', r)
          : o.symlink('/dev/tty', '/dev/stdin'),
          e
            ? o.createDevice('/dev', 'stdout', null, e)
          ...
          cacheLength() {
            ...
            var P = (R, S) => {
                R > S &&
                  ...
                  S > h - 1 &&
                    W('only ' + h + ' bytes available! programmer error!');
                var T = new XMLHttpRequest();
                return (
                  T.open('GET', t, !1),
                  h !== _ &&
                    T.setRequestHeader('Range', 'bytes=' + R + '-' + S),
    ...
    function r() {
      ...
      (d.calledRun = !0),
        !hr &&
          (Ve(),
          pr == null || pr(d),
          (e = d.onRuntimeInitialized) == null || e.call(d),
          qe());
    }
    d.setStatus
      ? (d.setStatus('Running...'),
