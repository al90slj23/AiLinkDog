...
import { G as B } from './graph-ByJpsr8c.js';
import { l as I } from './layout-DShoTQlJ.js';
import { i as x } from './_baseUniq-CHUFGwGn.js';
import { c as L } from './clone-C-OSllvx.js';
import { m as A } from './_basePickBy-DzhG6LJH.js';
...
var f = new Map(),
  ...
  O = p((e, t) => {
    const n = b.get(t) || [];
    return (
      i.trace('In isDescendant', t, ' ', e, ' = ', n.includes(e)), n.includes(e)
    );
  }, 'isDescendant'),
  se = p((e, t) => {
    const n = b.get(t) || [];
  ...
  k = p(
    (e) =>
      !f.has(e) || !f.get(e).externalConnections
        ? e
        : f.has(e)
          ? f.get(e).id
          : e,
  ...
  re = p((e, t) => {
    ...
    e.edges().forEach(function (n) {
      ...
      if (
        ...
        i.warn('Fix Replacing with XXX', c, a, n.name),
          e.setEdge(c, a, o, n.name);
      }
    }),
  ...
  T = p((e, t) => {
    ...
    for (const r of n)
      if (
        ...
        (a = (c = f.get(r)) == null ? void 0 : c.clusterData) != null &&
          a.dir &&
          ((l = f.get(r).clusterData.dir),
          i.warn('Fixing dir', f.get(r).clusterData.dir, l));
    ...
    for (const r of n) {
      const u = e.node(r);
      i.warn(' Now next level', r, u),
        u != null && u.clusterNode && T(u.graph, t + 1);
    }
  }, 'extractor'),
  M = p((e, t) => {
  ...
  oe = p((e) => M(e, e.children()), 'sortNodesByHierarchy'),
  j = p(async (e, t, n, o, c, a) => {
...
Parent cluster`,
            ...
            t.setNode(c.id, w),
            t.parent(d) ||
              (i.trace('Setting parent', d, c.id), t.setParent(d, c.id, w));
        }
        if (
    ...
    let y = 0,
      { subGraphTitleTotalMargin: X } = q(a);
    return (
      await Promise.all(
        oe(t).map(async function (d) {
          ...
          if (
            ...
            const m = (s == null ? void 0 : s.padding) / 2 || 0,
              N =
                ((w = s == null ? void 0 : s.labelBBox) == null
                  ? void 0
                  : w.height) || 0,
              S = N - m || 0;
      ...
      i.warn('Returning from recursive render XAX', u, y),
      { elem: u, diff: y }
    );
  }, 'recursiveRender'),
  pe = p(async (e, t) => {
      ...
      e.edges.forEach((g) => {
        if (g.start === g.end) {
          ...
          (s.label = ''),
            ...
            n.setEdge(h, y, s, h + '-cyclic-special-0'),
            n.setEdge(y, X, w, h + '-cyclic-special-1'),
            n.setEdge(X, h, m, h + '-cyc<lic-special-2');
