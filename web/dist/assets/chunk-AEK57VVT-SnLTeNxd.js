...
import { g as ne, s as le } from './chunk-RZ5BOZE2-Dl5yENMm.js';
import {
  _ as p,
  l as v,
  V as oe,
...
var bt = (function () {
  var e = p(function (P, l, h, a) {
    ...
    X = [1, 33],
    y = [
      1, 4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42,
      45, 48, 49, 50, 51, 54,
    ],
    nt = [
      1, 4, 5, 14, 15, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37,
      38, 42, 45, 48, 49, 50, 51, 54,
    ],
    At = [
      4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 45,
      48, 49, 50, 51, 54,
    ],
    St = {
      ...
      performAction: p(function (l, h, a, T, _, i, K) {
        var u = i.length - 1;
        switch (_) {
          case 3:
          ...
          case 26:
            this.$ = {
              stmt: 'state',
              id: i[u - 1].trim(),
              note: { position: i[u - 2].trim(), text: i[u].trim() },
            };
            break;
          case 29:
      ...
      table: [
        ...
        e(
          [
            1, 4, 5, 16, 17, 19, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42,
            45, 48, 49, 50, 51, 54,
          ],
          o,
          { 7: 7 },
      ...
      parse: p(function (l) {
        ...
        function Lt() {
          ...
          return (
            (C = T.pop() || D.lex() || J),
            typeof C != 'number' &&
              (C instanceof Array && ((T = C), (C = T.pop())),
              (C = h.symbols_[C] || C)),
            C
          );
        }
        ...
        for (var k, U, x, _t, W = {}, ct, N, It, ht; ; ) {
          if (
            ...
            this.defaultActions[U]
              ? (x = this.defaultActions[U])
              : ((k === null || typeof k > 'u') && (k = Lt()),
                (x = K[U] && K[U][k])),
          ...
          switch (x[0]) {
            ...
            case 2:
              ...
              N &&
                ...
                _.push(W.$),
                i.push(W._$),
                (It = K[a[a.length - 2]][a[a.length - 1]]),
                a.push(It);
              break;
            case 3:
              return !0;
        ...
        unput: p(function (l) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: a
                ? (a.length === T.length ? this.yylloc.first_column : 0) +
                  T[T.length - a.length].length -
                  a[0].length
                : this.yylloc.first_column - h,
            }),
            this.options.ranges &&
              (this.yylloc.range = [_[0], _[0] + this.yyleng - h]),
...
` +
        ...
        next: p(function () {
          ...
          for (var _ = this._currentRules(), i = 0; i < _.length; i++)
            if (
              ((a = this._input.match(this.rules[_[i]])),
              a && (!h || a[0].length > h[0].length))
            ) {
              if (((h = a), (T = i), this.options.backtrack_lexer)) {
                if (((l = this.test_match(a, _[i])), l !== !1)) return l;
                if (this._backtrack) {
                  h = !1;
                  continue;
                } else return !1;
          ...
          return h
            ? ((l = this.test_match(h, _[T])), l !== !1 ? l : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: p(function (h, a, T, _) {
          switch (T) {
            case 0:
              return 41;
            case 1:
        ...
        conditions: {
          ...
          struct: {
            rules: [
              9, 10, 22, 26, 29, 35, 42, 43, 44, 45, 54, 55, 56, 57, 71, 72, 73,
              74, 75,
            ],
            inclusive: !1,
          },
          ...
          STYLEDEF_STYLES: { rules: [31], inclusive: !1 },
          STYLE_IDS: { rules: [], inclusive: !1 },
          STYLE: { rules: [30], inclusive: !1 },
          ...
          SCALE: { rules: [13, 14, 33, 34], inclusive: !1 },
          ALIAS: { rules: [], inclusive: !1 },
          STATE_ID: { rules: [48], inclusive: !1 },
          STATE_STRING: { rules: [49, 50], inclusive: !1 },
          ...
          INITIAL: {
            rules: [
              ...
              35, 53, 57, 68, 69, 70, 71, 72, 73, 74, 76, 77, 78,
            ],
            inclusive: !0,
          },
        },
...
var Xe = bt,
  ...
  Qt = p((e, t = Mt) => {
    if (!e.doc) return t;
    let s = t;
    for (const n of e.doc) n.stmt === 'dir' && (s = n.value);
    return s;
  }, 'getDir'),
  Ge = p(function (e, t) {
    return t.db.getClasses();
  }, 'getClasses'),
  Ye = p(async function (e, t, s, n) {
    v.info('REF0:'), v.info('Drawing state diagram (v2)', t);
    const { securityLevel: o, state: c, layout: r } = A();
    n.db.extract(n.db.getRootDocV2());
    const d = n.db.getData(),
      f = ne(t, o);
    (d.type = n.type),
      (d.layoutAlgorithm = r),
      (d.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 50),
      (d.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 50),
      (d.markers = ['barb']),
      (d.diagramId = t),
      await ye(d, f);
    const g = 8;
  ...
  Ke = { getClasses: Ge, draw: Ye, getDir: Qt },
  ft = new Map(),
  B = 0;
...
var Fe = p((e, t, s, n, o, c, r, d) => {
    v.trace('items', t),
      t.forEach((f) => {
        switch (f.stmt) {
          ...
          case vt:
            {
              Q(e, f.state1, s, n, o, c, r, d),
                Q(e, f.state2, s, n, o, c, r, d);
              const g = {
                id: 'edge' + B,
                start: f.state1.id,
                end: f.state2.id,
  ...
  $t = p((e, t = Mt) => {
    let s = t;
    if (e.doc) for (const n of e.doc) n.stmt === 'dir' && (s = n.value);
    return s;
  }, 'getDir');
function q(e, t, s) {
...
var Q = p((e, t, s, n, o, c, r, d) => {
    ...
    if ((v.info('dataFetcher parsedItem', t, g, m), f !== 'root')) {
      ...
      t.description &&
        (Array.isArray(S.description)
          ? ((S.shape = Dt), S.description.push(t.description))
          : ((I = S.description) == null ? void 0 : I.length) > 0
            ? ((S.shape = Dt),
              S.description === f
                ? (S.description = [t.description])
                : (S.description = [S.description, t.description]))
            : ((S.shape = mt), (S.description = t.description)),
        (S.description = j.sanitizeTextOrArray(S.description, A()))),
        ((G = S.description) == null ? void 0 : G.length) === 1 &&
          S.shape === Dt &&
          (S.type === 'group' ? (S.shape = Nt) : (S.shape = mt)),
        !S.type &&
          t.doc &&
          (v.info('Setting cluster for XCX', f, $t(t)),
          (S.type = 'group'),
          (S.isGroup = !0),
          (S.dir = $t(t)),
          (S.shape = t.type === Ut ? Ot : Nt),
          (S.cssClasses = `${S.cssClasses} ${Ne} ${c ? $e : ''}`));
      const L = {
        labelStyle: '',
        shape: S.shape,
        label: S.description,
      ...
      if (
        ...
        e &&
          e.id !== 'root' &&
          (v.trace('Setting node ', f, ' to be child of its parent ', e.id),
          (L.parentId = e.id)),
        (L.centerLabel = !0),
        t.note)
      ) {
        ...
        let w = f,
          $ = O.id;
        t.note.position === 'left of' && ((w = O.id), ($ = f)),
          o.push({
            id: w + '-' + $,
            start: w,
            end: $,
    ...
    t.doc &&
      (v.trace('Adding nodes children '), Fe(t, t.doc, s, n, o, !c, r, d));
  }, 'dataFetcher'),
  Ve = p(() => {
    ft.clear(), (B = 0);
  }, 'reset'),
...
var Vt = p(
  ...
  ut = p((e) => JSON.parse(JSON.stringify(e)), 'clone'),
  H,
  Je =
    ((H = class {
      constructor(t) {
      ...
      docTranslator(t, s, n) {
        if (s.stmt === vt)
          ...
          (s.stmt === dt &&
            (s.id === '[*]'
              ? ((s.id = n ? t.id + '_start' : t.id + '_end'), (s.start = n))
              : (s.id = s.id.trim())),
          s.doc)
        ) {
          const o = [];
          ...
          if (o.length > 0 && c.length > 0) {
            const d = { stmt: dt, id: oe(), type: 'divider', doc: ut(c) };
            o.push(ut(d)), (s.doc = o);
          }
      ...
      extract(t) {
        ...
        t.doc ? (s = t.doc) : (s = t),
          v.info(s),
          this.clear(!0),
          v.info('Extract initial document:', s),
          s.forEach((r) => {
            switch ((v.warn('Statement', r.stmt), r.stmt)) {
              ...
              case Ee:
                {
                  const d = r.id.trim().split(','),
                    f = r.styleClass.split(',');
                  d.forEach((g) => {
      ...
      addState(
        ...
        if (
          (this.currentDocument.states.has(g)
            ? (this.currentDocument.states.get(g).doc ||
                (this.currentDocument.states.get(g).doc = n),
              this.currentDocument.states.get(g).type ||
                (this.currentDocument.states.get(g).type = s))
            : (v.info('Adding state ', g, o),
          ...
          o &&
            (v.info('Setting state description', g, o),
            typeof o == 'string' && this.addDescription(g, o.trim()),
            typeof o == 'object' &&
              o.forEach((E) => this.addDescription(g, E.trim()))),
          c)
        ) {
        ...
        r &&
          (v.info('Setting state classes', g, r),
          (typeof r == 'string' ? [r] : r).forEach((m) =>
            this.setCssClass(g, m.trim()),
          )),
          d &&
            (v.info('Setting state styles', g, d),
            (typeof d == 'string' ? [d] : d).forEach((m) =>
              this.setStyle(g, m.trim()),
            )),
          f &&
            (v.info('Setting state styles', g, d),
            (typeof f == 'string' ? [f] : f).forEach((m) =>
              this.setTextStyle(g, m.trim()),
            ));
      }
      clear(t) {
        (this.nodes = []),
          (this.edges = []),
          (this.documents = { root: Vt() }),
      ...
      startIdIfNeeded(t = '') {
        ...
        return (
          t === kt &&
            (this.startEndCount++, (s = `${Pt}${this.startEndCount}`)),
          s
        );
      }
      ...
      endIdIfNeeded(t = '') {
        ...
        return (
          t === Bt &&
            (this.startEndCount++, (s = `${Gt}${this.startEndCount}`)),
          s
        );
      }
      ...
      addRelationObjs(t, s, n) {
        let o = this.startIdIfNeeded(t.id.trim()),
          c = this.startTypeIfNeeded(t.id.trim(), t.type),
          r = this.startIdIfNeeded(s.id.trim()),
          d = this.startTypeIfNeeded(s.id.trim(), s.type);
        this.addState(
          o,
          c,
          t.doc,
      ...
      addRelation(t, s, n) {
        if (typeof t == 'object') this.addRelationObjs(t, s, n);
        else {
          const o = this.startIdIfNeeded(t.trim()),
            c = this.startTypeIfNeeded(t),
            r = this.endIdIfNeeded(s.trim()),
            d = this.endTypeIfNeeded(s);
          this.addState(o, c),
            this.addState(r, d),
            this.currentDocument.relations.push({
              id1: o,
      ...
      addDescription(t, s) {
        const n = this.currentDocument.states.get(t),
          o = s.startsWith(':') ? s.replace(':', '').trim() : s;
      ...
      getDirection() {
        var t;
        return (
          ((t = this.getDirectionStatement()) == null ? void 0 : t.value) ?? Te
        );
      }
      setDirection(t) {
...
`,
  ...
  qe = je;
export { Je as S, qe as a, Ke as b, Xe as s };
