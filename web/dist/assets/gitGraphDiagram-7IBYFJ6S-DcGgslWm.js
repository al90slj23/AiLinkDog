import { p as Z } from './chunk-4BMEZGHF-C4FSbg0i.js';
import { I as F } from './chunk-XZIHB7SX-D1NPzHZs.js';
import {
  E as U,
  _ as h,
  e as ee,
...
import { p as ge } from './radar-MK3ICKWK-CR6EA1S0.js';
...
var p = { NORMAL: 0, REVERSE: 1, HIGHLIGHT: 2, MERGE: 3, CHERRY_PICK: 4 },
  ye = U.gitGraph,
  z = h(() => re({ ...ye, ...te().gitGraph }), 'getConfig'),
  i = new F(() => {
    const t = z(),
      e = t.mainBranchName,
      a = t.mainBranchOrder;
...
var ue = h(function (t) {
  ...
  be = h(function (t) {
    ...
    (a = B.sanitizeText(a, n)),
      ...
      (r = r == null ? void 0 : r.map((c) => B.sanitizeText(c, n)));
    const o = {
    ...
    (i.records.head = o),
      ...
      i.records.commits.set(o.id, o),
      i.records.branches.set(i.records.currBranch, o.id),
  ...
  me = h(function (t) {
    ...
    i.records.branches.set(
      e,
      i.records.head != null ? i.records.head.id : null,
    ),
  ...
  we = h((t) => {
    ...
    const o = i.records.branches.get(i.records.currBranch),
      c = i.records.branches.get(e),
      $ = o ? i.records.commits.get(o) : void 0,
      l = c ? i.records.commits.get(c) : void 0;
    if ($ && l && $.branch === e)
  ...
  Ce = h(function (t) {
    ...
    if (!a || !i.records.commits.has(a)) {
      ...
      const f = {
        ...
        tags: s
          ? s.filter(Boolean)
          : [`cherry-pick:${o.id}${o.type === p.MERGE ? `|parent:${r}` : ''}`],
      };
      (i.records.head = f),
  ...
  _ = h(function (t) {
    if (((t = B.sanitizeText(t, z())), i.records.branches.has(t))) {
      ...
      e === void 0 || !e
        ? (i.records.head = null)
        : (i.records.head = i.records.commits.get(e) ?? null);
    } else {
      const e = new Error(
...
function Y(t) {
  ...
  if (
    (w.debug(s.join(' ')),
    e.parents && e.parents.length == 2 && e.parents[0] && e.parents[1])
  ) {
...
var ve = h(function () {
    ...
    return [...i.records.branchConfig.values()]
      .map((e, a) =>
        e.order !== null && e.order !== void 0
          ? e
          : { ...e, order: parseFloat(`0.${a}`) },
      )
      .sort((e, a) => (e.order ?? 0) - (a.order ?? 0))
      .map(({ name: e }) => ({ name: e }));
  ...
  qe = h((t, e) => {
    const s = {
      Commit: h((r) => e.commit(Oe(r)), 'Commit'),
      Branch: h((r) => e.branch(ze(r)), 'Branch'),
      Merge: h((r) => e.merge(Ge(r)), 'Merge'),
      Checkout: h((r) => e.checkout(He(r)), 'Checkout'),
      CherryPicking: h((r) => e.cherryPick(Pe(r)), 'CherryPicking'),
    }[t.$type];
  ...
  ze = h((t) => ({ name: t.name, order: t.order ?? 0 }), 'parseBranch'),
  Ge = h(
    (t) => ({
      branch: t.branch,
      id: t.id ?? '',
  ...
  Q = h((t) => {
    ...
    return (
      u === 'BT'
        ? ((a = h((r, n) => r <= n, 'comparisonFunc')), (s = 1 / 0))
        : ((a = h((r, n) => r >= n, 'comparisonFunc')), (s = 0)),
      t.forEach((r) => {
        var o, c;
        const n =
          u === 'TB' || u == 'BT'
  ...
  Ae = h((t, e, a) => {
    ...
    t.forEach((o) => {
      const c = e.get(o);
      if (!c) throw new Error(`Commit not found for key ${o}`);
      c.parents.length ? ((s = De(c)), (r = Math.max(s, r))) : n.push(c),
        Ke(c, s);
    }),
      (s = r),
      n.forEach((o) => {
  ...
  De = h((t) => Ye(t) + I, 'calculateCommitPosition'),
  Ke = h((t, e) => {
  ...
  _e = h((t, e, a, s, r, n) => {
    if (n === p.HIGHLIGHT)
      ...
      if (
        (o.attr('cx', a.x),
        o.attr('cy', a.y),
        o.attr('r', e.type === p.MERGE ? 9 : 10),
        o.attr('class', `commit ${e.id} commit${r % O}`),
        n === p.MERGE)
      ) {
        ...
        c.attr('cx', a.x),
          c.attr('cy', a.y),
          c.attr('r', 6),
          c.attr('class', `commit ${s} ${e.id} commit${r % O}`);
      }
      n === p.REVERSE &&
        t
          .append('path')
    ...
    if (
      ...
      const n = t.append('g'),
        ...
        c = n
          ...
          .text(e.id),
        $ = (r = c.node()) == null ? void 0 : r.getBBox();
      if (
        $ &&
        (o
        ...
        u === 'TB' || u === 'BT'
          ? (o.attr('x', a.x - ($.width + 4 * k + 5)).attr('y', a.y - 12),
            c.attr('x', a.x - ($.width + 4 * k)).attr('y', a.y + $.height - 12))
          : c.attr('x', a.posWithOffset - $.width / 2),
        b.rotateCommitLabel)
      )
        if (u === 'TB' || u === 'BT')
  ...
  Xe = h((t, e, a, s) => {
    ...
    if (e.tags.length > 0) {
      ...
      for (const l of e.tags.reverse()) {
        ...
        (o = Math.max(o, y.width)),
          (c = Math.max(c, y.height)),
      ...
      ${a.posWithOffset - o / 2 - k},${x + y + L}`,
        ...
        ${a.x + R},${m + y + 2}`,
            ...
            .attr(
              'transform',
              'translate(12,12) rotate(45, ' + a.x + ',' + s + ')',
            ),
            f
              .attr('cx', a.x + k / 2)
              .attr('cy', m)
            ...
            l
              ...
              .attr(
                'transform',
                'translate(14,14) rotate(45, ' + a.x + ',' + s + ')',
              );
        }
      }
    }
  ...
  Qe = h((t, e, a, s) => {
    ...
    } else return e === 'TB' ? P : e === 'BT' ? (s.get(t.id) ?? r).y - I : 0;
    return 0;
  }, 'calculatePosition'),
  Ze = h((t, e, a) => {
    var o, c;
    const s = u === 'BT' && a ? e : e + R,
      r =
        u === 'TB' || u === 'BT'
          ? s
          : (o = v.get(t.branch)) == null
            ? void 0
            : o.pos,
      n =
        u === 'TB' || u === 'BT'
          ? (c = v.get(t.branch)) == null
            ? void 0
            : c.pos
          : s;
  ...
  K = h((t, e, a) => {
    ...
    let n = u === 'TB' || u === 'BT' ? P : 0;
    const o = [...e.keys()],
      c = (b == null ? void 0 : b.parallelCommits) ?? !1,
      $ = h((f, g) => {
        var x, m;
        const d = (x = e.get(f)) == null ? void 0 : x.seq,
          y = (m = e.get(g)) == null ? void 0 : m.seq;
        return d !== void 0 && y !== void 0 ? d - y : 0;
      }, 'sortKeys');
    let l = o.sort($);
    u === 'BT' && (c && Ae(l, e, n), (l = l.reverse())),
      l.forEach((f) => {
        var y;
        const g = e.get(f);
        ...
        if (a) {
          const x = Je(g),
            m = g.customType ?? g.type,
            q = ((y = v.get(g.branch)) == null ? void 0 : y.index) ?? 0;
          _e(s, g, d, x, q, m), Ve(r, g, d, n), Xe(r, g, d, n);
        }
        u === 'TB' || u === 'BT'
  ...
  Fe = h((t, e, a, s, r) => {
    const o = (u === 'TB' || u === 'BT' ? a.x < s.x : a.y < s.y)
        ? e.branch
        : t.branch,
      c = h((l) => l.branch === o, 'isOnBranchToGetCurve'),
      $ = h((l) => l.seq > t.seq && l.seq < e.seq, 'isBetweenCommits');
    return [...r.values()].some((l) => $(l) && c(l));
  }, 'shouldRerouteArrow'),
  H = h((t, e, a = 0) => {
    const s = t + Math.abs(t - e) / 2;
    if (a > 5) return s;
    if (W.every((o) => Math.abs(o - s) >= 10)) return W.push(s), s;
  ...
  Ue = h((t, e, a, s) => {
    ...
    if (r === void 0 || n === void 0)
      throw new Error(
        `Commit positions not found for commits ${e.id} and ${a.id}`,
      );
    ...
    let c = '',
      ...
      l = 0,
      f = 0,
      g = (y = v.get(a.branch)) == null ? void 0 : y.index;
    a.type === p.MERGE &&
      e.id !== a.parents[0] &&
      (g = (x = v.get(e.branch)) == null ? void 0 : x.index);
    let d;
    if (o) {
      (c = 'A 10 10, 0, 0, 0,'), ($ = 'A 10 10, 0, 0, 1,'), (l = 10), (f = 10);
      const T = r.y < n.y ? H(r.y, n.y) : H(n.y, r.y),
        C = r.x < n.x ? H(r.x, n.x) : H(n.x, r.x);
      u === 'TB'
        ? r.x < n.x
          ? (d = `M ${r.x} ${r.y} L ${C - l} ${r.y} ${$} ${C} ${r.y + f} L ${C} ${n.y - l} ${c} ${C + f} ${n.y} L ${n.x} ${n.y}`)
          : ((g = (m = v.get(e.branch)) == null ? void 0 : m.index),
            (d = `M ${r.x} ${r.y} L ${C + l} ${r.y} ${c} ${C} ${r.y + f} L ${C} ${n.y - l} ${$} ${C - f} ${n.y} L ${n.x} ${n.y}`))
        : u === 'BT'
          ? r.x < n.x
            ? (d = `M ${r.x} ${r.y} L ${C - l} ${r.y} ${c} ${C} ${r.y - f} L ${C} ${n.y + l} ${$} ${C + f} ${n.y} L ${n.x} ${n.y}`)
            : ((g = (q = v.get(e.branch)) == null ? void 0 : q.index),
              (d = `M ${r.x} ${r.y} L ${C + l} ${r.y} ${$} ${C} ${r.y - f} L ${C} ${n.y + l} ${c} ${C - f} ${n.y} L ${n.x} ${n.y}`))
          : r.y < n.y
            ? (d = `M ${r.x} ${r.y} L ${r.x} ${T - l} ${c} ${r.x + f} ${T} L ${n.x - l} ${T} ${$} ${n.x} ${T + f} L ${n.x} ${n.y}`)
            : ((g = (D = v.get(e.branch)) == null ? void 0 : D.index),
              (d = `M ${r.x} ${r.y} L ${r.x} ${T + l} ${$} ${r.x + f} ${T} L ${n.x - l} ${T} ${c} ${n.x} ${T - f} L ${n.x} ${n.y}`));
    } else
      (c = 'A 20 20, 0, 0, 0,'),
        ($ = 'A 20 20, 0, 0, 1,'),
        (l = 20),
        ...
        u === 'TB'
          ? (r.x < n.x &&
              (a.type === p.MERGE && e.id !== a.parents[0]
                ? (d = `M ${r.x} ${r.y} L ${r.x} ${n.y - l} ${c} ${r.x + f} ${n.y} L ${n.x} ${n.y}`)
                : (d = `M ${r.x} ${r.y} L ${n.x - l} ${r.y} ${$} ${n.x} ${r.y + f} L ${n.x} ${n.y}`)),
            r.x > n.x &&
              ((c = 'A 20 20, 0, 0, 0,'),
              ($ = 'A 20 20, 0, 0, 1,'),
              (l = 20),
              (f = 20),
              a.type === p.MERGE && e.id !== a.parents[0]
                ? (d = `M ${r.x} ${r.y} L ${r.x} ${n.y - l} ${$} ${r.x - f} ${n.y} L ${n.x} ${n.y}`)
                : (d = `M ${r.x} ${r.y} L ${n.x + l} ${r.y} ${c} ${n.x} ${r.y + f} L ${n.x} ${n.y}`)),
  ...
  rr = h((t, e) => {
    ...
    e.forEach((s, r) => {
      var x;
      const n = r % O,
        o = (x = v.get(s.name)) == null ? void 0 : x.pos;
      if (o === void 0)
      ...
      c.attr('x1', 0),
        ...
        c.attr('x2', M),
        c.attr('y2', o),
        c.attr('class', 'branch branch' + n),
        u === 'TB'
          ? (c.attr('y1', P), c.attr('x1', o), c.attr('y2', M), c.attr('x2', o))
          : u === 'BT' &&
            (c.attr('y1', M),
            c.attr('x1', o),
            c.attr('y2', P),
      ...
      f
        ...
        .attr(
          ...
          -y.width -
            4 -
            ((b == null ? void 0 : b.rotateCommitLabel) === !0 ? 30 : 0),
        )
        .attr('y', -y.height / 2 + 8)
        ...
        u === 'TB'
          ? (f.attr('x', o - y.width / 2 - 10).attr('y', 0),
            d.attr('transform', 'translate(' + (o - y.width / 2 - 5) + ', 0)'))
          : u === 'BT'
            ? (f.attr('x', o - y.width / 2 - 10).attr('y', M),
              d.attr(
                'transform',
                'translate(' + (o - y.width / 2 - 5) + ', ' + M + ')',
              ))
            : f.attr('transform', 'translate(-19, ' + (o - y.height / 2) + ')');
    });
  }, 'drawBranches'),
  tr = h(function (t, e, a, s, r) {
    return (
      v.set(t, { pos: e, index: a }),
      (e += 50 + (r ? 40 : 0) + (u === 'TB' || u === 'BT' ? s.width / 2 : 0)),
      e
    );
  }, 'setBranchPosition'),
  ar = h(function (t, e, a, s) {
    if (
      (Se(),
      w.debug(
...
`,
    ...
    o.forEach((l, f) => {
      ...
      const g = J(l.name),
        ...
        x = y.insert('g').attr('class', 'label branch-label');
      (q = x.node()) == null || q.appendChild(g);
      const m = g.getBBox();
      ($ = tr(l.name, $, f, m, r)), x.remove(), y.remove(), d.remove();
    }),
      K(c, G, !1),
      b.showBranches && rr(c, o),
      er(c, G),
      K(c, G, !0),
      $e.insertTitle(
        c,
      ...
      fe(void 0, c, b.diagramPadding, b.useMaxWidth);
  }, 'draw'),
  nr = { draw: ar },
  sr = h(
    (t) => `
...
`,
  ...
  cr = sr,
  br = { parser: We, db: X, renderer: nr, styles: cr };
