const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/HeroRobotScene-DoNih_Yi.js',
      'assets/semi-ui-St01U-q0.js',
      'assets/react-core-4ZwCPCju.js',
      'assets/semi-ui-BhhRYRAi.css',
      'assets/index-CoIn5CRw.js',
      'assets/i18n-BRm33D3q.js',
      'assets/tools-Cq0Qq7OB.js',
      'assets/react-components-geJ9h57c.js',
      'assets/index-X5UWuRcX.css',
    ]),
) => i.map((i) => d[i]);
import { j as d, B as It } from './semi-ui-St01U-q0.js';
import { r as v, L as rt } from './react-core-4ZwCPCju.js';
import {
  aH as Xo,
  aI as Yo,
  bF as qo,
...
import { u as tr } from './i18n-BRm33D3q.js';
import { m as er } from './tools-Cq0Qq7OB.js';
import './react-components-geJ9h57c.js';
const ni = v.createContext({});
function rn(t) {
  const e = v.useRef(null);
  return e.current === null && (e.current = t()), e.current;
}
const nr = typeof window < 'u',
  si = nr ? v.useLayoutEffect : v.useEffect,
...
class cn {
  ...
  add(e) {
    return ln(this.subscriptions, e), () => se(this.subscriptions, e);
  }
  notify(e, n, s) {
...
function rr(t, e, n, s, i) {
  let r,
    o,
    a = 0;
  do (o = e + (n - e) / 2), (r = ci(o, s, i) - t), r > 0 ? (n = o) : (e = o);
  while (Math.abs(r) > ir && ++a < or);
  return o;
}
function Ut(t, e, n, s) {
  if (t === e && n === s) return G;
  const i = (r) => rr(r, 0, 1, t, n);
  return (r) => (r === 0 || r === 1 ? r : ci(i(r), e, s));
}
const ui = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
  hi = (t) => (e) => 1 - t(1 - e),
  di = Ut(0.33, 1.53, 0.69, 0.99),
  un = hi(di),
  fi = ui(un),
  mi = (t) =>
    t >= 1
  ...
  xi = (t) => Array.isArray(t) && typeof t[0] == 'number',
  Ln = {
    linear: G,
    easeIn: ar,
    easeInOut: yi,
  ...
  In = (t) => {
    if (xi(t)) {
      ...
      const [e, n, s, i] = t;
      return Ut(e, n, s, i);
    } else if (ur(t)) return ie(Ln[t] !== void 0), Ln[t];
    return t;
  },
  Ht = [
    'setup',
...
function vi(t, e) {
  ...
  const i = { delta: 0, timestamp: 0, isProcessing: !1 },
    ...
    y = () => {
      const b = lt.useManualTiming,
        w = b ? i.timestamp : performance.now();
      (n = !1),
        b ||
          (i.delta = s ? 1e3 / 60 : Math.max(Math.min(w - i.timestamp, dr), 1)),
        (i.timestamp = w),
        (i.isProcessing = !0),
        a.process(i),
        l.process(i),
  ...
  return {
    schedule: Ht.reduce((b, w) => {
      const A = o[w];
      return (b[w] = (j, B = !1, C = !1) => (n || g(), A.schedule(j, B, C))), b;
    }, {}),
    cancel: (b) => {
      for (let w = 0; w < Ht.length; w++) o[Ht[w]].cancel(b);
    },
    state: i,
    steps: o,
  };
...
const {
  ...
  state: F,
  steps: ye,
} = vi(typeof requestAnimationFrame < 'u' ? requestAnimationFrame : G, !0);
let qt;
function fr() {
  qt = void 0;
}
const O = {
    now: () => (
      qt === void 0 &&
        O.set(
          F.isProcessing || lt.useManualTiming
            ? F.timestamp
            : performance.now(),
        ),
      qt
    ...
    set: (t) => {
      (qt = t), queueMicrotask(fr);
    },
  },
  bi = (t) => (e) => typeof e == 'string' && e.startsWith(t),
  Ti = bi('--'),
  mr = bi('var(--'),
  dn = (t) => (mr(t) ? pr.test(t.split('/*')[0].trim()) : !1),
  pr =
...
const yr =
  ...
  mn = (t, e) => (n) =>
    !!(
      (typeof n == 'string' && yr.test(n) && n.startsWith(t)) ||
      (e && !gr(n) && Object.prototype.hasOwnProperty.call(n, e))
    ),
  wi = (t, e, n) => (s) => {
    if (typeof s != 'string') return s;
    const [i, r, o, a] = s.match(fn);
    return {
      [t]: parseFloat(i),
      [e]: parseFloat(r),
      [n]: parseFloat(o),
  ...
  xr = (t) => et(0, 255, t),
  xe = { ...Pt, transform: (t) => Math.round(xr(t)) },
  mt = {
    test: mn('rgb', 'red'),
    parse: wi('red', 'green', 'blue'),
...
const Le = { test: mn('#'), parse: vr, transform: mt.transform },
  $t = (t) => ({
    test: (e) =>
  ...
  Tt = {
    test: mn('hsl', 'hue'),
    parse: wi('hue', 'saturation', 'lightness'),
  ...
  R = {
    test: (t) => mt.test(t) || Le.test(t) || Tt.test(t),
    parse: (t) =>
      mt.test(t) ? mt.parse(t) : Tt.test(t) ? Tt.parse(t) : Le.parse(t),
    transform: (t) =>
      typeof t == 'string'
        ? t
...
function Sr(t) {
  ...
  return (
    isNaN(t) &&
    typeof t == 'string' &&
    (((e = t.match(fn)) == null ? void 0 : e.length) || 0) +
      (((n = t.match(wr)) == null ? void 0 : n.length) || 0) >
      0
  );
}
const Si = 'number',
...
function At(t) {
  ...
  const a = e
    .replace(
      ...
      (l) => (
        R.test(l)
          ? (s.color.push(r), i.push(Ai), n.push(R.parse(l)))
          : l.startsWith(Pr)
            ? (s.var.push(r), i.push(Ar), n.push(l))
            : (s.number.push(r), i.push(Si), n.push(parseFloat(l))),
        ++r,
        Fn
      ),
    )
...
function Er(t) {
  const e = At(t);
  return Pi(e)(e.values.map((s, i) => Dr(s, e.split[i])));
}
const Y = { test: Sr, parse: Vr, createTransformer: jr, getAnimatableNone: Er };
function ve(t, e, n) {
  return (
    n < 0 && (n += 1),
    n > 1 && (n -= 1),
...
function Rr({ hue: t, saturation: e, lightness: n, alpha: s }) {
  ...
  if (!e) i = r = o = n;
    ...
    const a = n < 0.5 ? n * (1 + e) : n + e - n * e,
      l = 2 * n - a;
    (i = ve(l, a, t + 1 / 3)), (r = ve(l, a, t)), (o = ve(l, a, t - 1 / 3));
  }
  return {
...
const M = (t, e, n) => t + (e - t) * n,
  ...
  kr = [Le, mt, Tt],
  Lr = (t) => kr.find((e) => e.test(t));
function Bn(t) {
  const e = Lr(t);
  if (!e) return !1;
  let n = e.parse(t);
  return e === Tt && (n = Rr(n)), n;
}
const On = (t, e) => {
    const n = Bn(t),
      s = Bn(e);
    if (!n || !s) return oe(t, e);
    const i = { ...n };
    return (r) => (
      (i.red = be(n.red, s.red, r)),
      (i.green = be(n.green, s.green, r)),
      (i.blue = be(n.blue, s.blue, r)),
...
const Br = (t, e) => {
  ...
  return s.indexes.var.length === i.indexes.var.length &&
    ...
    ? (Ie.has(t) && !i.values.length) || (Ie.has(e) && !s.values.length)
      ? Ir(t, e)
      : Wt(Ci(Fr(s, i), i.values), n)
    : oe(t, e);
};
function Vi(t, e, n) {
...
function $r(t, e, n) {
  let s = n;
  for (let i = 1; i < Ur; i++) s = s - t(s) / e(s);
  return s;
}
const Wn = 0.001;
function Kr({
  ...
  let i,
    r,
    o = 1 - e;
  (o = et(D.minDamping, D.maxDamping, o)),
    (t = et(D.minDuration, D.maxDuration, H(t))),
    o < 1
      ? ((i = (u) => {
          const c = u * o,
            h = c * t,
  ...
  if (!Un(t, Gr) && Un(t, Hr))
    if (((e.velocity = 0), t.visualDuration)) {
      const n = t.visualDuration,
        s = (2 * Math.PI) / (n * 1.2),
        i = s * s,
        r = 2 * et(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(i);
...
function ae(t = D.visualDuration, e = D.bounce) {
  const n =
    typeof t != 'object'
  ...
  if (y < 1)
    (A = Ne(x, y)),
      (j = (p + y * x * g) / A),
      (b = (P) => {
        const E = Math.exp(-y * x * P);
        return o - E * (j * Math.sin(A * P) + g * Math.cos(A * P));
      }),
      (B = y * x * j + g * A),
      (C = y * x * g - j * A),
      (w = (P) =>
        Math.exp(-y * x * P) * (B * Math.sin(A * P) + C * Math.cos(A * P)));
  else if (y === 1) {
    b = (E) => o - Math.exp(-x * E) * (g + (p + x * g) * E);
    const P = p + x * g;
    w = (E) => Math.exp(-x * E) * (x * P * E - p);
  } else {
    const P = x * Math.sqrt(y * y - 1);
    b = (q) => {
      const nt = Math.exp(-y * x * q),
        Z = Math.min(P * q, 300);
      return (
        o - (nt * ((p + y * x * g) * Math.sinh(Z) + P * g * Math.cosh(Z))) / P
      );
    };
    const E = (p + y * x * g) / P,
      U = y * x * E - g * P,
    ...
    w = (q) => {
      const nt = Math.exp(-y * x * q),
        Z = Math.min(P * q, 300);
      return nt * (U * Math.sinh(Z) + ut * Math.cosh(Z));
    };
  }
  const N = {
    ...
    next: (P) => {
      if (!m && y < 1) {
        const U = Math.exp(-y * x * P),
          ut = Math.sin(A * P),
          q = Math.cos(A * P),
          nt = o - U * (j * ut + g * q),
          Z = $(U * (B * ut + C * q));
        return (
          (a.done = Math.abs(Z) <= s && Math.abs(o - nt) <= i),
          (a.value = a.done ? o : nt),
          a
        );
      }
      ...
      if (m) a.done = P >= h;
        ...
        const U = $(w(P));
        a.done = Math.abs(U) <= s && Math.abs(o - E) <= i;
      }
      return (a.value = a.done ? o : E), a;
    },
    toString: () => {
      const P = Math.min(gn(N), re),
        E = ji((U) => N.next(P * U).value, P, 30);
      return P + 'ms ' + E;
    },
    toTransition: () => {},
  };
...
function _e({
  ...
  const g = h + y,
    x = o === void 0 ? g : o(g);
  x !== g && (y = x - h);
  const T = (C) => -y * Math.exp(-C / s),
    b = (C) => x + T(C),
    w = (C) => {
      const N = T(C),
        P = b(C);
      (f.done = Math.abs(N) <= u), (f.value = f.done ? x : P);
    };
  let A, j;
  const B = (C) => {
    m(f.value) &&
  ...
  return (
    B(0),
    {
      ...
      next: (C) => {
        let N = !1;
        return (
          !j && A === void 0 && ((N = !0), w(C), B(C)),
          A !== void 0 && C >= A ? j.next(C - A) : (!N && w(C), f)
        );
      },
    }
  );
...
function Di(t, e, { clamp: n = !0, ease: s, mixer: i } = {}) {
  ...
  const a = Yr(e, s, i),
    ...
    u = (c) => {
      ...
      const f = Nt(t[h], t[h + 1], c);
      return a[h](f);
    };
  return n ? (c) => u(et(t[0], t[r - 1], c)) : u;
}
function qr(t, e) {
...
function Et({
  ...
  const i = cr(s) ? s.map(In) : In(s),
    r = { done: !1, value: e[0] },
    o = Qr(n && n.length === e.length ? n : Zr(e), t),
    a = Di(o, e, { ease: Array.isArray(i) ? i : Jr(e, i) });
  return {
...
const ea = { decay: _e, inertia: _e, tween: Et, keyframes: Et, spring: ae };
function Ei(t) {
...
class Ft extends yn {
  ...
  initAnimation() {
    ...
    l !== Et &&
      typeof a[0] != 'number' &&
      ((this.mixKeyframes = Wt(na, Vi(a[0], a[1]))), (a = [0, 100]));
  ...
  tick(e, n = !1) {
    ...
    let A;
    T
      ? ((this.delayState.value = c[0]), (A = this.delayState))
      : (A = w.next(b)),
    ...
    return (
      B && p !== _e && (A.value = de(c, this.options, g, this.speed)),
      y && y(A.value),
      B && this.finish(),
      A
    );
  ...
  getGeneratorVelocity() {
    ...
    return Mi((s) => this.generator.next(s).value, e, n);
  }
  get speed() {
  ...
  set speed(e) {
    ...
    n && this.driver && this.updateTime(O.now()),
  ...
  play() {
    ...
    const { driver: e = Or, startTime: n } = this.options;
...
const pt = (t) => (t * 180) / Math.PI,
  ...
  Hn = (t) => Math.sqrt(t[4] * t[4] + t[5] * t[5]),
  oa = {
    x: 12,
    y: 13,
    z: 14,
...
function Ri() {
  ...
  ($e = !1), (Ue = !1), gt.forEach((t) => t.complete(Ke)), gt.clear();
}
function ki() {
  gt.forEach((t) => {
...
class xn {
  ...
  scheduleResolve() {
    (this.state = 'scheduled'),
      this.isAsync
        ? (gt.add(this), Ue || ((Ue = !0), V.read(ki), V.resolveKeyframes(Ri)))
...
const ma = Ii(() => window.ScrollTimeline !== void 0, 'scrollTimeline'),
  Ni = Ii(() => {
    try {
      document
        .createElement('div')
...
class Bi extends yn {
  constructor(e) {
    ...
    const u = ga(e);
    (this.animation = pa(n, s, i, u, r)),
      u.autoplay === !1 && this.animation.pause(),
      (this.animation.onfinish = () => {
        if (((this.finishedTime = this.time), !r)) {
          const c = de(i, this.options, a, this.speed);
...
const Oi = { anticipate: mi, backInOut: fi, circInOut: gi };
function ya(t) {
  return t in Oi;
}
function xa(t) {
  typeof t.ease == 'string' && ya(t.ease) && (t.ease = Oi[t.ease]);
}
const Te = 10;
class va extends Bi {
  constructor(e) {
  ...
  updateMotionValue(e) {
    ...
    const a = new Ft({ ...o, autoplay: !1 }),
      l = Math.max(Te, O.now() - this.startTime),
      u = et(0, Te, l - Te),
      c = a.sample(l).value,
      { name: h } = this.options;
    r && h && Li(r, h, c),
...
function Ta(t, e, n, s) {
  ...
  const r = t[t.length - 1],
    o = Xn(i, e),
    a = Xn(r, e);
  return !o || !a ? !1 : ba(t) || ((n === 'spring' || Fi(n)) && s);
}
function He(t) {
  (t.duration = 0), (t.type = 'keyframes');
}
const Wi = new Set(['opacity', 'clipPath', 'filter', 'transform']),
  wa = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/;
function Sa(t) {
  for (let e = 0; e < t.length; e++)
    if (typeof t[e] == 'string' && wa.test(t[e])) return !0;
  return !1;
}
const Aa = new Set([
    'color',
  ...
  Pa = ai(() => Object.hasOwnProperty.call(Element.prototype, 'animate'));
function Ca(t) {
  var h;
  const {
    motionValue: e,
...
class ja extends yn {
  constructor({
    ...
    const f = {
      ...
      m = (c == null ? void 0 : c.KeyframeResolver) || xn;
    (this.keyframeResolver = new m(
      a,
      (y, g, x) => this.onKeyframesResolved(y, g, f, !x),
      l,
      u,
      c,
    )),
  ...
  onKeyframesResolved(e, n, s, i) {
    ...
    Ta(e, r, o, a) ||
      ((h = !1),
      (lt.instantAnimations || !l) && (c == null || c(de(e, s, n))),
      (e[0] = e[e.length - 1]),
      He(s),
      (s.repeat = 0));
    const m = {
      ...
      p = h && !u && Ca(m),
      y =
        (T = (x = m.motionValue) == null ? void 0 : x.owner) == null
          ? void 0
          : T.current;
    let g;
    if (p)
      try {
        g = new va({ ...m, element: y });
      } catch {
        g = new Ft(m);
      }
    else g = new Ft(m);
  ...
  get animation() {
    ...
    return (
      this._animation ||
        ((e = this.keyframeResolver) == null || e.resume(), ha()),
      this._animation
    );
  }
  get duration() {
...
function _a(t) {
  for (const e in t) if (!Na.has(e)) return !0;
  return !1;
}
const bn =
  (t, e, n, s = {}, i, r) =>
  (o) => {
    ...
    return a.isSync ? new Ft(c) : new ja(c);
  };
function Yn(t) {
  const e = [{}, {}];
  return (
...
function yt(t, e, n) {
  const s = t.getProps();
  return Tn(s, e, n !== void 0 ? n : s.custom, t);
}
const Hi = new Set([
    'width',
    'height',
...
const Ka = 'framerAppearId',
  Gi = 'data-' + wn(Ka);
function zi(t) {
  return t.props[Gi];
}
function Ha({ protectedKeys: t, needsAnimating: e }, n) {
...
function Xi(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
  ...
  r = r ? Ki(r, l) : l;
  const u = r == null ? void 0 : r.reduceMotion;
  s && (r = s);
  const c = [],
    h = i && t.animationState && t.animationState.getState()[i];
  for (const f in a) {
    const m = t.getValue(f, t.latestValues[f] ?? null),
      p = a[f];
    if (p === void 0 || (h && Ha(h, f))) continue;
    const y = { delay: n, ...vn(r || {}, f) },
      g = m.get();
    if (
      g !== void 0 &&
      !m.isAnimating() &&
    ...
    if (window.MotionHandoffAnimation) {
      const w = zi(t);
      if (w) {
        const A = window.MotionHandoffAnimation(w, f, V);
        A !== null && ((y.startTime = A), (x = !0));
      }
    }
    ze(t, f);
    const T = u ?? t.shouldReduceMotion;
    m.start(bn(f, m, p, T && Hi.has(f) ? { type: !1 } : y, t, x));
    const b = m.animation;
    b && c.push(b);
  }
  if (o) {
...
function Xe(t, e, n = {}) {
  ...
  const r = s ? () => Promise.all(Xi(t, s, n)) : () => Promise.resolve(),
    o =
...
function Ga(t, e, n = 0, s = 0, i = 0, r = 1, o) {
  const a = [];
...
function Qi(t, e) {
  let n = Zi(t);
  return (
    el.has(n) || (n = Y), n.getAnimatableNone ? n.getAnimatableNone(e) : void 0
  );
}
...
function sl(t, e, n) {
  ...
  for (; s < t.length && !i; ) {
    const r = t[s];
    typeof r == 'string' && !nl.has(r) && At(r).values.length && (i = t[s]),
      s++;
  }
  if (i && n) for (const r of e) t[r] = Qi(n, i);
}
class il extends xn {
  ...
  readKeyframes() {
    ...
    for (let c = 0; c < e.length; c++) {
      let h = e[c];
      if (typeof h == 'string' && ((h = h.trim()), dn(h))) {
        const f = $i(h, n.current);
        f !== void 0 && (e[c] = f),
          c === e.length - 1 && (this.finalKeyframe = h);
      }
    }
  ...
  resolveNoneKeyframes() {
    const { unresolvedKeyframes: e, name: n } = this,
      s = [];
    for (let i = 0; i < e.length; i++) (e[i] === null || Ya(e[i])) && s.push(i);
    s.length && sl(e, s, n);
  }
  measureInitialState() {
  ...
  measureEndState() {
    ...
    const r = s.length - 1,
      o = s[r];
    (s[r] = at[n](e.measureViewportBox(), window.getComputedStyle(e.current))),
...
const to = (t, e) => (e && typeof t == 'number' ? e.transform(t) : t);
function ol(t) {
  return oi(t) && 'offsetHeight' in t && !('ownerSVGElement' in t);
}
const { schedule: An, cancel: Ch } = vi(queueMicrotask, !1),
  X = { x: !1, y: !1 };
function eo() {
  return X.x || X.y;
}
    ...
    s.forEach((o) => {
      ...
      const c = () => {
        ...
        y = (g) => {
          ...
          const x = e(o, g);
          typeof x == 'function' &&
            ((u = x), o.addEventListener('pointerleave', p, i));
        };
...
const so = (t, e) => (e ? (t === e ? !0 : so(t, e.parentElement)) : !1),
  Pn = (t) =>
    t.pointerType === 'mouse'
      ...
      : t.isPrimary !== !1,
  cl = new Set(['BUTTON', 'INPUT', 'SELECT', 'TEXTAREA', 'A']);
function ul(t) {
  return cl.has(t.tagName) || t.isContentEditable === !0;
}
const hl = new Set(['INPUT', 'SELECT', 'TEXTAREA']);
function dl(t) {
...
function ml(t, e, n = {}) {
  const [s, i, r] = no(t, n),
    o = (a) => {
      ...
      if (!ts(a) || es.has(a)) return;
      Zt.add(l), n.stopPropagation && es.add(a);
      const u = e(l, a),
        c = (m, p) => {
          window.removeEventListener('pointerup', h),
            window.removeEventListener('pointercancel', f),
            Zt.has(l) && Zt.delete(l),
            ts(m) && typeof u == 'function' && u(m, { success: p });
        },
        h = (m) => {
          c(
            m,
  ...
  return (
    s.forEach((a) => {
      (n.useGlobalTarget ? window : a).addEventListener('pointerdown', o, i),
        ol(a) &&
          (a.addEventListener('focus', (u) => fl(u, i)),
          !ul(a) && !a.hasAttribute('tabindex') && (a.tabIndex = 0));
    }),
    r
  );
}
function Cn(t) {
  return oi(t) && 'ownerSVGElement' in t;
}
...
const io = (t, e, n) => (s, i) =>
    i && i[0]
      ...
      : Cn(s) && 'getBBox' in s
        ? s.getBBox()[e]
        : s[n],
  pl = io('inline', 'width', 'offsetWidth'),
  gl = io('block', 'height', 'offsetHeight');
...
function vl() {
  typeof ResizeObserver > 'u' || (ot = new ResizeObserver(xl));
}
function bl(t, e) {
  ot || vl();
  const n = Ji(t);
...
function ns(t, e) {
  return typeof t == 'function' ? wl(t) : bl(t, e);
}
function Sl(t) {
...
function Pl(t, e, n = {}) {
  ...
  const a = typeof s == 'string' ? s.replace(/[\d.-]/g, '') : void 0,
    ...
    u = () => {
      ...
      const m = i ? i.getGeneratorVelocity() : t.getVelocity();
      l(),
        (i = new Ft({
          keyframes: [h, f],
          velocity: m,
    ...
    c = () => {
      var h;
      u(),
        (t.animation = i ?? void 0),
        (h = t.events.animationStart) == null || h.notify(),
        i == null ||
          i.then(() => {
            var f;
            (t.animation = void 0),
              (f = t.events.animationComplete) == null || f.notify();
          });
    };
  if (
    (t.attach((h, f) => {
      (r = h), (o = (m) => f(Se(m, a))), V.postRender(c);
    }, l),
    L(e))
  ) {
    let h = n.skipInitialAnimation === !0;
    const f = e.on('change', (p) => {
        h ? ((h = !1), t.jump(Se(p, a), !1)) : t.set(Se(p, a));
      }),
      m = t.on('destroy', f);
    return () => {
      f(), m();
...
const Cl = [...qi, R, Y],
  Vl = (t) => Cl.find(Yi(t)),
  is = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
  St = () => ({ x: is(), y: is() }),
  os = () => ({ min: 0, max: 0 }),
  k = () => ({ x: os(), y: os() }),
  jl = new WeakMap();
...
const Vn = [
  ...
  jn = ['initial', ...Vn];
function me(t) {
  return fe(t.animate) || jn.some((e) => Bt(t[e]));
}
function oo(t) {
...
function Ml(t, e, n) {
  for (const s in e) {
    const i = e[s],
      r = n[s];
    if (L(i)) t.addValue(s, i);
    else if (L(r)) t.addValue(s, xt(i, { owner: t }));
    else if (r !== i)
      if (t.hasValue(s)) {
...
class kl {
    ...
    (this.current = null),
      ...
      (this.scheduleRender = () => {
        ...
        this.renderScheduledAt < m &&
          ((this.renderScheduledAt = m), V.render(this.render, !1, !0));
      });
    ...
    (this.current = e),
      ...
      this.reducedMotionConfig === 'never'
        ...
        : this.reducedMotionConfig === 'always'
          ...
          : (ro.current || El(), (this.shouldReduceMotion = Ze.current)),
  ...
  bindToMotionValue(e, n) {
    if (
      ...
      n.accelerate && Wi.has(e) && this.current instanceof HTMLElement)
    ) {
      const {
          factory: o,
          keyframes: a,
  ...
  readValue(e, n) {
    ...
    return (
      s != null &&
        (typeof s == 'string' && (ii(s) || ri(s))
          ? (s = parseFloat(s))
          : !Vl(s) && Y.test(n) && (s = Qi(e, n)),
        this.setBaseTarget(e, L(s) ? s.get() : s)),
      L(s) ? s.get() : s
    );
  }
  setBaseTarget(e, n) {
...
function Nl(t, e, n, s = !1) {
  ...
  for (let l = 0; l < i; l++) {
    ...
    (u && u.props.style && u.props.style.display === 'contents') ||
      ...
      o && ((e.x *= o.x.scale), (e.y *= o.y.scale), ho(t, o)),
      s &&
        ft(r.latestValues) &&
        te(t, r.latestValues, (a = r.layout) == null ? void 0 : a.layoutBox));
  }
  e.x < us && e.x > cs && (e.x = 1), e.y < us && e.y > cs && (e.y = 1);
}
function J(t, e) {
  (t.min += e), (t.max += e);
}
function hs(t, e, n, s, i = 0.5) {
...
function te(t, e, n) {
  const s = n ?? t;
  hs(t.x, ds(e.x, s.x), e.scaleX, e.scale, e.originX),
    hs(t.y, ds(e.y, s.y), e.scaleY, e.scale, e.originY);
}
function fo(t, e) {
  return co(Il(t.getBoundingClientRect(), e));
}
function _l(t, e, n) {
  const s = fo(t, n),
    { scroll: i } = e;
...
function Mn(t, e, n) {
  ...
  if (
    (e.transform ||
      (o || n
        ? (s.transform = Ol(e, t.transform, n))
...
function mo(t, { style: e, vars: n }, s, i) {
  const r = t.style;
  let o;
  for (o in e) r[o] = e[o];
...
class $l extends lo {
  ...
  readValueFromInstance(e, n) {
    var s;
    if (Vt.has(n))
      return (s = this.projection) != null && s.isProjecting ? Oe(n) : ra(e, n);
    {
      const i = Ul(e),
        r = (Ti(n) ? i.getPropertyValue(n) : i[n]) || 0;
...
const Kl = { offset: 'stroke-dashoffset', array: 'stroke-dasharray' },
...
const zl = ['offsetDistance', 'offsetPath', 'offsetRotate', 'offsetAnchor'];
function go(
  t,
  {
    attrX: e,
  ...
  for (const m of zl) h[m] !== void 0 && ((f[m] = h[m]), delete h[m]);
  e !== void 0 && (h.x = e),
    n !== void 0 && (h.y = n),
    s !== void 0 && (h.scale = s),
    i !== void 0 && Gl(h, i, r, o, !1);
}
const yo = new Set([
    'baseFrequency',
    'diffuseConstant',
...
function Xl(t, e, n, s) {
  mo(t, e, void 0, s);
  for (const i in e.attrs) t.setAttribute(yo.has(i) ? i : wn(i), e.attrs[i]);
}
function vo(t, e, n) {
  const s = Dn(t, e, n);
  for (const i in t)
...
class Yl extends lo {
  ...
  readValueFromInstance(e, n) {
    ...
    return (n = yo.has(n) ? n : wn(n)), e.getAttribute(n);
  }
  scrapeMotionValuesFromProps(e, n, s) {
    return vo(e, n, s);
  }
  build(e, n, s) {
    go(e, n, this.isSVGTag, s.transformTemplate, s.style);
  }
...
function Jl(t) {
  return (e) =>
    Promise.all(e.map(({ animation: n, options: s }) => za(t, n, s)));
}
function tc(t) {
  let e = Jl(t),
    n = ms(),
  ...
  const r = (u) => (c, h) => {
    ...
    const f = yt(
      ...
      h,
      u === 'exit'
        ? (m = t.presenceContext) == null
          ? void 0
          : m.custom
        : void 0,
    );
    if (f) {
      const { transition: p, transitionEnd: y, ...g } = f;
      c = { ...c, ...g, ...y };
    }
    return c;
  };
  ...
  function a(u) {
    ...
    for (let x = 0; x < Ql; x++) {
      const T = Zl[x],
        ...
        A = Bt(w),
        j = T === u ? b.isActive : null;
      j === !1 && (y = x);
      let B = w === h[T] && w !== c[T] && A;
      if (
        (B && (s || i) && t.manuallyAnimateOnMount && (B = !1),
        (b.protectedKeys = { ...p }),
        (!b.isActive && j === null) ||
          (!w && !b.prevProp) ||
          fe(w) ||
        ...
        continue;
      if (T === 'exit' && b.isActive && j !== !0) {
        b.prevResolvedValues && (p = { ...p, ...b.prevResolvedValues });
        continue;
      }
      const C = ec(b.prevProp, w);
      let N = C || (T === u && b.isActive && !B && A) || (x > y && A),
        P = !1;
      const E = Array.isArray(w) ? w : [w];
      let U = E.reduce(r(T), {});
      j === !1 && (U = {});
      const { prevResolvedValues: ut = {} } = b,
        q = { ...ut, ...U },
        nt = (_) => {
          (N = !0),
            m.has(_) && ((P = !0), m.delete(_)),
            (b.needsAnimating[_] = !0);
          const K = t.getValue(_);
          K && (K.liveStyle = !1);
        };
      for (const _ in q) {
        const K = U[_],
      ...
      (b.prevProp = w),
        (b.prevResolvedValues = U),
        b.isActive && (p = { ...p, ...U }),
        (s || i) && t.blockInitialAnimation && (N = !1);
      const Z = B && C;
      N &&
        (!Z || P) &&
        f.push(
          ...E.map((_) => {
            ...
            if (
              ...
              if (ht.enteringChildren && vt) {
                const { delayChildren: zo } = vt.transition || {};
                K.delay = Ui(ht.enteringChildren, t, zo);
              }
            }
    ...
    if (m.size) {
      ...
      if (typeof c.initial != 'boolean') {
        const T = yt(t, Array.isArray(c.initial) ? c.initial[0] : c.initial);
        T && T.transition && (x.transition = T.transition);
      }
      m.forEach((T) => {
        const b = t.getBaseTarget(T),
          w = t.getValue(T);
        w && (w.liveStyle = !0), (x[T] = b ?? null);
      }),
        f.push({ animation: x });
    }
    let g = !!f.length;
  ...
  function l(u, c) {
    ...
    (f = t.variantChildren) == null ||
      f.forEach((m) => {
        var p;
        return (p = m.animationState) == null ? void 0 : p.setActive(u, c);
      }),
      (n[u].isActive = c);
    const h = a(u);
...
function gs(t, e, n, s = 0.5) {
  (t.origin = s),
    ...
    ((t.scale >= nc && t.scale <= sc) || isNaN(t.scale)) && (t.scale = 1),
    ((t.translate >= ic && t.translate <= oc) || isNaN(t.translate)) &&
      (t.translate = 0);
}
function kt(t, e, n, s) {
  gs(t.x, e.x, n.x, s ? s.originX : void 0),
    gs(t.y, e.y, n.y, s ? s.originY : void 0);
}
function ys(t, e, n, s = 0) {
  const i = s ? M(n.min, n.max, s) : n.min;
  (t.min = i + e.min), (t.max = t.min + W(e));
}
function ac(t, e, n, s) {
  ys(t.x, e.x, n.x, s == null ? void 0 : s.x),
    ys(t.y, e.y, n.y, s == null ? void 0 : s.y);
}
function xs(t, e, n, s = 0) {
  const i = s ? M(n.min, n.max, s) : n.min;
  (t.min = e.min - i), (t.max = t.min + W(e));
}
function ue(t, e, n, s) {
  xs(t.x, e.x, n.x, s == null ? void 0 : s.x),
    xs(t.y, e.y, n.y, s == null ? void 0 : s.y);
}
function vs(t, e, n, s, i) {
  return (
    (t -= e), (t = ce(t, 1 / n, s)), i !== void 0 && (t = ce(t, 1 / i, s)), t
  );
}
function lc(t, e = 0, n = 1, s = 0.5, i, r = t, o = t) {
  if (
    (tt.test(e) &&
...
function bs(t, e, [n, s, i], r, o) {
  lc(t, e[n], e[s], e[i], e.scale, r, o);
}
const cc = ['x', 'scaleX', 'originX'],
  uc = ['y', 'scaleY', 'originY'];
function Ts(t, e, n, s) {
  bs(t.x, e, cc, n ? n.x : void 0, s ? s.x : void 0),
    bs(t.y, e, uc, n ? n.y : void 0, s ? s.y : void 0);
}
function ws(t) {
...
const Co = [
  ...
  fc = Co.length,
  Vs = (t) => (typeof t == 'string' ? parseFloat(t) : t),
  js = (t) => typeof t == 'number' || S.test(t);
function mc(t, e, n, s, i, r) {
  i
    ? ((t.opacity = M(0, n.opacity ?? 1, pc(s))),
      (t.opacityExit = M(e.opacity ?? 1, 0, gc(s))))
  ...
  for (let o = 0; o < fc; o++) {
    ...
    l || (l = 0),
      u || (u = 0),
      l === 0 || u === 0 || js(l) === js(u)
        ? ((t[a] = Math.max(M(Vs(l), Vs(u), s), 0)),
          (tt.test(u) || tt.test(l)) && (t[a] += '%'))
        : (t[a] = u);
  }
      ...
      (s = (n = e.options).onExitComplete) == null || s.call(n),
        (o =
          (i = e.resumingFrom) == null
            ? void 0
            : (r = i.options).onExitComplete) == null || o.call(r);
    });
  }
  scheduleRender() {
...
function Mo({
  ...
  return class {
    ...
    addEventListener(o, a) {
      return (
        this.eventHandlers.has(o) || this.eventHandlers.set(o, new cn()),
    ...
    mount(o) {
      ...
      (this.isSVG = Cn(o) && !Sl(o)), (this.instance = o);
        ...
        V.read(() => {
          ...
          t(o, () => {
            ...
            m !== h &&
              ...
              c && c(),
              (c = bc(f, 250)),
              ne.hasAnimatedSinceResize &&
                ((ne.hasAnimatedSinceResize = !1), this.nodes.forEach(Rs)));
          });
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({
              ...
              const p =
                  this.options.transition || u.getDefaultTransition() || Fc,
                { onLayoutAnimationStart: y, onLayoutAnimationComplete: g } =
                  u.getProps(),
                x = !this.targetLayout || !Po(this.targetLayout, m),
                T = !h && f;
              if (
                this.options.layoutRoot ||
                this.resumeFrom ||
                T ||
                (h && (x || !this.currentAnimation))
              ) {
                this.resumeFrom &&
                  ((this.resumingFrom = this.resumeFrom),
                  (this.resumingFrom.resumingFrom = void 0));
                const b = { ...vn(p, 'layout'), onPlay: y, onComplete: g };
    ...
    didUpdate() {
      this.updateScheduled ||
        ((this.updateScheduled = !0), An.read(this.scheduleUpdate));
    }
    clearAllSnapshots() {
      this.nodes.forEach(jc), this.sharedNodes.forEach(Ic);
    }
    ...
    measurePageBox() {
      ...
      if (
        !(
          ((u = this.scroll) == null ? void 0 : u.wasRoot) || this.path.some(Oc)
        )
      ) {
    ...
    removeElementScroll(o) {
      var l;
      const a = k();
      if ((z(a, o), (l = this.scroll) != null && l.wasRoot)) return a;
      for (let u = 0; u < this.path.length; u++) {
        ...
        c !== this.root &&
          h &&
          f.layoutScroll &&
          (h.wasRoot && z(a, o), J(a.x, h.offset.x), J(a.y, h.offset.y));
      }
      return a;
    }
    applyTransform(o, a = !1, l) {
      ...
      for (let f = 0; f < this.path.length; f++) {
        ...
        !a &&
          ...
          m.scroll &&
          m !== m.root &&
          (J(u.x, -m.scroll.offset.x), J(u.y, -m.scroll.offset.y)),
          ft(m.latestValues) &&
            te(
              u,
              m.latestValues,
    ...
    removeTransform(o) {
      ...
      for (let u = 0; u < this.path.length; u++) {
        const c = this.path[u];
        if (!ft(c.latestValues)) continue;
        let h;
        c.instance &&
          (Qe(c.latestValues) && c.updateSnapshot(),
          (h = k()),
          z(h, c.measurePageBox())),
          Ts(
            a,
            c.latestValues,
      ...
      return ft(this.latestValues) && Ts(a, this.latestValues), a;
    }
    setTargetDelta(o) {
      (this.targetDelta = o),
          ...
          this.relativeParent.target
            ...
            : this.targetDelta
              ? (this.resumingFrom
                ...
                ho(this.target, this.targetDelta))
              : z(this.target, this.layout.layoutBox),
          this.attemptToResolveRelativeTarget &&
    ...
    calcProjection() {
      ...
      !this.projectionDelta || !this.prevProjectionDelta
        ...
        kt(this.projectionDelta, this.layoutCorrected, m, this.latestValues),
        (this.treeScale.x !== h ||
          this.treeScale.y !== f ||
          !Cs(this.projectionDelta.x, this.prevProjectionDelta.x) ||
          !Cs(this.projectionDelta.y, this.prevProjectionDelta.y)) &&
          ((this.hasProjected = !0),
          this.scheduleRender(),
    ...
    setAnimationOrigin(o, a = !1) {
      ...
      const f = k(),
        ...
        y = m !== p,
        g = this.getStack(),
        x = !g || g.members.length <= 1,
        T = !!(y && !x && this.options.crossfade === !0 && !this.path.some(_c));
      this.animationProgress = 0;
      let b;
      (this.mixTargetDelta = (w) => {
        ...
        ks(h.x, o.x, A),
          ...
          this.relativeTarget &&
            ...
            Nc(this.relativeTarget, this.relativeTargetOrigin, f, A),
            b && hc(this.relativeTarget, b) && (this.isProjectionDirty = !1),
            b || (b = k()),
            z(b, this.relativeTarget)),
          y &&
            ((this.animationValues = c), mc(c, u, this.latestValues, A, T, x)),
          this.root.scheduleUpdateProjection(),
          this.scheduleRender(),
    ...
    finishAnimation() {
      this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(wc),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!a || !l || !u)) {
        if (
          ...
          this.layout &&
          u &&
          Do(this.options.animationType, this.layout.layoutBox, u.layoutBox)
        ) {
          l = this.target || k();
        ...
        z(a, l),
          te(a, c),
          kt(this.projectionDeltaWithTransform, this.layoutCorrected, a, c);
      }
    }
    ...
    resetSkewAndRotation() {
      ...
      for (let c = 0; c < Pe.length; c++)
        Ce(`rotate${Pe[c]}`, o, u, this.animationValues),
          Ce(`skew${Pe[c]}`, o, u, this.animationValues);
      o.render();
      for (const c in u)
    ...
    applyProjectionStyles(o, a) {
      ...
      if (this.needsReset) {
        (this.needsReset = !1),
          (o.visibility = ''),
          (o.opacity = ''),
          (o.pointerEvents = ee(a == null ? void 0 : a.pointerEvents) || ''),
      ...
      (o.transformOrigin = `${f.origin * 100}% ${m.origin * 100}% 0`),
        u.animationValues
          ? (o.opacity =
              u === this
      ...
      for (const p in tn) {
        ...
        const { correct: y, applyTo: g, isCSSVariable: x } = tn[p],
          T = h === 'none' ? c[p] : y(c[p], u);
        if (g) {
          const b = g.length;
          for (let w = 0; w < b; w++) o[g[w]] = T;
        } else
          x ? (this.options.visualElement.renderState.vars[p] = T) : (o[p] = T);
      }
      this.options.layoutId &&
        (o.pointerEvents =
          u === this ? ee(a == null ? void 0 : a.pointerEvents) || '' : 'none');
    }
    clearSnapshot() {
...
function Pc(t) {
  ...
  if (t.isLead() && t.layout && e && t.hasListeners('didUpdate')) {
    ...
    if (r === 'size')
      ...
      const h = r === 'x' ? 'y' : 'x';
      en(o ? e.measuredBox[h] : e.layoutBox[h], s[h]);
    } else
      Do(r, e.layoutBox, s) &&
        Q((h) => {
          const f = o ? e.measuredBox[h] : e.layoutBox[h],
          ...
          (f.max = f.min + m),
            t.relativeTarget &&
              ...
              (t.relativeTarget[h].max = t.relativeTarget[h].min + m));
        });
    const a = St();
    kt(a, s, e.layoutBox);
    const l = St();
    o ? kt(l, t.applyTransform(i, !0), e.measuredBox) : kt(l, s, e.layoutBox);
    const u = !Ao(a);
    let c = !1;
    if (!t.resumeFrom) {
      ...
      if (h && !h.resumeFrom) {
        ...
        if (f && m) {
          const p = t.options.layoutAnchor || void 0,
            y = k();
          ue(y, e.layoutBox, f.layoutBox, p);
          const g = k();
          ue(g, s, m.layoutBox, p),
            Po(y, g) || (c = !0),
...
const Fc = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
  ...
  Ns = Is('applewebkit/') && !Is('chrome/') ? Math.round : G;
function _s(t) {
...
function Do(t, e, n) {
  return (
    t === 'position' || (t === 'preserve-aspect' && !rc(Ps(e), Ps(n), 0.2))
  );
}
function Oc(t) {
  var e;
...
function Uc(t = !0) {
  ...
  const o = v.useCallback(() => t && s && s(r), [r, s, t]);
  return !n && s ? [!1, o] : [!0];
}
const Ro = v.createContext({ strict: !1 }),
  Fs = {
    animation: [
      'animate',
      'variants',
...
let Lo = (t) => !he(t);
function Gc(t) {
  typeof t == 'function' && (Lo = (e) => (e.startsWith('on') ? !he(e) : t(e)));
}
try {
  Gc(require('@emotion/is-prop-valid').default);
} catch {}
function zc(t, e, n) {
  const s = {};
  for (const i in t)
...
function Yc(t) {
  const { initial: e, animate: n } = Xc(t, v.useContext(ge));
  return v.useMemo(() => ({ initial: e, animate: n }), [Os(e), Os(n)]);
}
function Os(t) {
...
function Io(t, e, n) {
  for (const s in e) !L(e[s]) && !po(s, n) && (t[s] = e[s]);
}
function qc({ transformTemplate: t }, e) {
  return v.useMemo(() => {
    const n = En();
...
function Zc(t, e) {
  const n = t.style || {},
    s = {};
  return Io(s, n, t), Object.assign(s, qc(t, e)), s;
}
function Qc(t, e) {
  const n = {},
    s = Zc(t, e);
...
function Jc(t, e, n, s) {
  const i = v.useMemo(() => {
    const r = No();
    return (
      go(r, e, xo(s), t.transformTemplate, t.style),
      { ...r.attrs, style: { ...r.style } }
    );
  }, [e]);
  if (t.style) {
    const r = {};
    Io(r, t.style, t), (i.style = { ...r, ...i.style });
  }
  return i;
}
const tu = [
...
function Rn(t) {
  return typeof t != 'string' || t.includes('-')
    ? !1
    : !!(tu.indexOf(t) > -1 || /[A-Z]/u.test(t));
}
function eu(t, e, n, { latestValues: s }, i, r = !1, o) {
  const l = ((o ?? Rn(t)) ? Jc : Qc)(e, s, i, t),
    u = zc(e, typeof t == 'string', r),
    c = t !== v.Fragment ? { ...u, ...l, ref: n } : {},
    { children: h } = e,
    f = v.useMemo(() => (L(h) ? h.get() : h), [h]);
  return v.createElement(t, { ...c, children: f });
}
function nu({ scrapeMotionValuesFromProps: t, createRenderState: e }, n, s, i) {
  return { latestValues: su(n, s, i, t), renderState: e() };
}
function su(t, e, n, s) {
  const i = {},
    r = s(t, {});
  for (const f in r) i[f] = ee(r[f]);
  ...
  if (h && typeof h != 'boolean' && !fe(h)) {
    ...
    for (let m = 0; m < f.length; m++) {
      const p = Tn(t, f[m]);
      if (p) {
        const { transitionEnd: y, transition: g, ...x } = p;
        for (const T in x) {
          let b = x[T];
          if (Array.isArray(b)) {
...
const _o = (t) => (e, n) => {
    const s = v.useContext(ge),
      i = v.useContext(an),
      r = () => nu(t, e, s, i);
    return n ? r() : rn(r);
  },
  iu = _o({ scrapeMotionValuesFromProps: Dn, createRenderState: En }),
  ou = _o({ scrapeMotionValuesFromProps: vo, createRenderState: No }),
...
function lu(t, e, n, s, i, r) {
  var b, w;
  const { visualElement: o } = v.useContext(ge),
    a = v.useContext(Ro),
    l = v.useContext(an),
    u = v.useContext(pe),
    c = u.reducedMotion,
    ...
    si(() => {
      (m.current = !0),
        p &&
          ...
          T.current && p.animationState && p.animationState.animateChanges());
    }),
    v.useEffect(() => {
      p &&
        (!T.current && p.animationState && p.animationState.animateChanges(),
...
function cu(t, e, n, s) {
  ...
  (t.projection = new n(
    t.latestValues,
    e['data-framer-portal-id'] ? void 0 : Bo(t.parent),
  )),
...
function Bo(t) {
  if (t) return t.options.allowProjection !== !1 ? t.projection : Bo(t.parent);
}
function je(t, { forwardMotionProps: e = !1, type: n } = {}, s, i) {
  s && Kc(s);
  const r = n ? n === 'svg' : Rn(t),
    o = r ? ou : iu;
  function a(u, c) {
    let h;
    const f = { ...v.useContext(pe), ...u, layoutId: uu(u) },
      { isStatic: m } = f,
      p = Yc(u),
      y = o(u, m);
    if (!m && typeof window < 'u') {
      ...
      const g = du(f);
      (h = g.MeasureLayout),
        (p.visualElement = lu(t, y, f, i, g.ProjectionNode, r));
    }
    return d.jsxs(ge.Provider, {
      value: p,
      children: [
        h && p.visualElement
          ? d.jsx(h, { visualElement: p.visualElement, ...f })
          : null,
        eu(t, u, au(y, p.visualElement, c), y, m, e, r),
      ],
    });
  }
...
function uu({ layoutId: t }) {
  const e = v.useContext(ni).id;
  return e && t !== void 0 ? e + '-' + t : t;
}
function hu(t, e) {
  v.useContext(Ro).strict;
}
function du(t) {
  const e = ko(),
    { drag: n, layout: s } = e;
...
function fu(t, e) {
  ...
  return new Proxy(i, {
    get: (r, o) =>
      o === 'create'
        ? s
        : (n.has(o) || n.set(o, je(o, void 0, t, e)), n.get(o)),
  });
}
const mu = (t, e) =>
  (e.isSVG ?? Rn(t))
    ? new Yl(e)
    : new $l(e, { allowProjection: t !== v.Fragment });
class pu extends ct {
  constructor(e) {
...
class yu extends ct {
  constructor() {
    super(...arguments), (this.id = gu++), (this.isExitComplete = !1);
  }
  update() {
    var r;
    ...
    if (e && s === !1) {
      if (this.isExitComplete) {
        ...
        if (typeof o == 'string') {
          const l = yt(this.node, o, a);
          if (l) {
            const { transition: u, transitionEnd: c, ...h } = l;
            for (const f in h)
              (r = this.node.getValue(f)) == null || r.jump(h[f]);
          }
        }
        this.node.animationState.reset(),
...
const xu = { animation: { Feature: pu }, exit: { Feature: yu } };
function Kt(t) {
  return { point: { x: t.pageX, y: t.pageY } };
}
const vu = (t) => (e) => Pn(e) && t(e, Kt(e));
function Lt(t, e, n, s) {
  return Ot(t, e, vu(n), s);
}
const Oo = ({ current: t }) => (t ? t.ownerDocument.defaultView : null),
  Ws = (t, e) => Math.abs(t - e);
function bu(t, e) {
  const n = Ws(t.x, e.x),
    s = Ws(t.y, e.y);
    ...
    if (
      ...
      (this.updatePoint = () => {
        ...
        this.lastRawMoveEventInfo &&
          (this.lastMoveEventInfo = zt(
            this.lastRawMoveEventInfo,
            this.transformPagePoint,
          ));
        const m = Me(this.lastMoveEventInfo, this.history),
          p = this.startEvent !== null,
          y = bu(m.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
        if (!p && !y) return;
        const { point: g } = m,
          { timestamp: x } = F;
      ...
      (this.handlePointerUp = (m, p) => {
        this.end();
        const { onEnd: y, onSessionEnd: g, resumeAnimation: x } = this.handlers;
        if (
        ...
        const T = Me(
          m.type === 'pointercancel'
            ...
            : zt(p, this.transformPagePoint),
          this.history,
        );
        this.startEvent && y && y(m, T), g && g(m, T);
      }),
      !Pn(e))
    )
      return;
...
class Du {
  ...
  start(e, { snapToCursor: n = !1, distanceThreshold: s } = {}) {
    ...
    const r = (h) => {
      ...
      o = (h, f) => {
        const { drag: m, dragPropagation: p, onDragStart: y } = this.getProps();
        if (
          m &&
          !p &&
          (this.openDragLock && this.openDragLock(),
          (this.openDragLock = rl(m)),
          !this.openDragLock)
        )
          return;
    ...
    this.panSession = new Wo(
      ...
      },
      {
        ...
        dragSnapToOrigin: c,
        distanceThreshold: s,
        contextWindow: Oo(this.visualElement),
  ...
  updateAxis(e, n, s) {
    ...
    if (!s || !Xt(e, i, this.currentDirection)) return;
  ...
  resolveConstraints() {
    ...
    e && bt(e)
      ...
      : e && s
        ? (this.constraints = Au(s.layoutBox, e))
        : (this.constraints = !1),
      (this.elastic = ju(n)),
      i !== this.constraints &&
        !bt(e) &&
        ...
        Q((o) => {
          this.constraints !== !1 &&
            ...
            (this.constraints[o] = Vu(s.layoutBox[o], this.constraints[o]));
        });
  }
  resolveRefConstraints() {
    ...
    const r = _l(s, i.root, this.visualElement.getTransformPagePoint());
    let o = Pu(i.layout.layoutBox, r);
    if (n) {
      const a = n(Ll(o));
  ...
  startAnimation(e) {
    const {
      ...
      l = this.constraints || {},
      u = Q((c) => {
        if (!Xt(c, n, this.currentDirection)) return;
        let h = l[c] || {};
  ...
  startAxisValueAnimation(e, n) {
    ...
    return (
      ze(this.visualElement, e), s.start(bn(e, s, 0, n, this.visualElement, !1))
    );
  }
  stopAnimation() {
  ...
  snapToCursor(e) {
    Q((n) => {
      ...
      if (!Xt(n, s, this.currentDirection)) return;
  ...
  scalePositionWithinConstraints() {
    ...
    if (!bt(n) || !s || !this.constraints) return;
    this.stopAnimation();
    const i = { x: 0, y: 0 };
    Q((o) => {
      ...
      if (a && this.constraints !== !1) {
        const l = a.get();
        i[o] = Cu({ min: l, max: l }, this.constraints[o]);
      }
    });
...
function $o(t) {
  ...
  return d.jsx(Iu, {
    ...t,
    layoutGroup: s,
    switchLayoutGroup: v.useContext(Fo),
    isPresent: e,
    safeToRemove: n,
  });
}
const Nu = {
  pan: { Feature: Lu },
  drag: { Feature: ku, ProjectionNode: Eo, MeasureLayout: $o },
};
function Ys(t, e, n) {
  const { props: s } = t;
  t.animationState &&
...
class _u extends ct {
  mount() {
    ...
    e &&
      (this.unmount = ll(
        e,
        (n, s) => (Ys(this.node, s, 'Start'), (i) => Ys(this.node, i, 'End')),
      ));
  }
  unmount() {}
}
...
class Hu extends ct {
  ...
  startObserver() {
    ...
    this.stopObserver = $u(this.node.current, o, a);
  }
  mount() {
    this.startObserver();
  }
  update() {
    ...
    ['amount', 'margin', 'root'].some(Gu(e, n)) && this.startObserver();
  }
  unmount() {
    var e;
...
function Gu({ viewport: t = {} }, { viewport: e = {} } = {}) {
  return (n) => t[n] !== e[n];
}
const zu = {
    inView: { Feature: Hu },
  ...
  Xu = { layout: { ProjectionNode: Eo, MeasureLayout: $o } },
  Yu = { ...xu, ...zu, ...Nu, ...Xu },
  qu = fu(Yu, mu);
function Ko(t) {
  const e = rn(() => xt(t)),
    { isStatic: n } = v.useContext(pe);
  if (n) {
    const [, s] = v.useState(t);
    v.useEffect(() => e.on('change', s), []);
  }
  return e;
}
function Ho(t, e) {
...
function Zu(t) {
  (Rt.current = []), t();
  const e = Ho(Rt.current, t);
  return (Rt.current = void 0), e;
}
function on(t, e, n, s) {
  if (typeof t == 'function') return Zu(t);
  const r = typeof e == 'function' ? e : Al(e, n, s),
    o = Array.isArray(t) ? Zs(t, r) : Zs([t], ([l]) => r(l)),
    a = Array.isArray(t) ? void 0 : t.accelerate;
  return (
    a &&
      !a.isTransformed &&
      typeof e != 'function' &&
      ...
      (o.accelerate = { ...a, times: e, keyframes: n, isTransformed: !0 }),
    o
  );
}
function Zs(t, e) {
...
function Qu(t, e = {}) {
  const { isStatic: n } = v.useContext(pe),
    s = () => (L(t) ? t.get() : t);
  if (n) return on(s);
  const i = Ko(s());
  return v.useInsertionEffect(() => Pl(i, t, e), [i, JSON.stringify(e)]), i;
}
function Qs(t, e = {}) {
  return Qu(t, { type: 'spring', ...e });
}
const Ju = {
  bounce: 0,
  stiffness: 420,
...
function th({ className: t = '', size: e = 220, springOptions: n = Ju }) {
  ...
  v.useEffect(() => {
    if (!s.current) return;
    const m = s.current.parentElement;
    m &&
    ...
    (m) => {
      ...
      const p = o.getBoundingClientRect(),
        y =
          ...
          m.clientY >= p.top &&
          m.clientY <= p.bottom;
      r(y), y && (l.set(m.clientX - p.left), u.set(m.clientY - p.top));
    },
    [l, u, o],
  );
  return (
    v.useEffect(() => {
      if (o)
        return (
          window.addEventListener('mousemove', f, { passive: !0 }),
          () => {
    ...
    d.jsx(qu.div, {
      ref: s,
      className: `ald-ui-spotlight ${i ? 'is-visible' : ''} ${t}`.trim(),
      style: { width: e, height: e, left: c, top: h },
    })
  );
}
function eh() {
  return d.jsx('span', {
    className: 'ald-home-dog-mark',
    'aria-hidden': 'true',
    children: d.jsx('img', { src: '/logo.png', alt: '' }),
  });
}
function nh({ docsLink: t, t: e }) {
  return d.jsxs('div', {
    className: 'ald-home-hero__primary-copy',
    children: [
      d.jsx('div', {
        className: 'ald-home-chip',
        children: 'All 128 models operational · 实时监控中',
      }),
      d.jsx('div', {
        className: 'ald-home-eyebrow',
        children: 'ALD · AI API Aggregation Platform',
      }),
      d.jsxs('h1', {
        children: [
          e('接入所有模型'),
          ',',
          d.jsx('br', {}),
          d.jsxs('span', { children: [e('自由定义选择'), '。'] }),
        ],
      }),
      d.jsx('p', {
        className: 'ald-home-hero__desc',
        children: d.jsx('span', {
          children: e('面向 AI 开发者与应用团队的无忧中转平台.'),
        }),
      }),
      d.jsxs('p', {
        className: 'ald-home-hero__slogan ald-home-hero__slogan--emphasis',
        children: [
          d.jsx('span', { children: 'All AI, One Link — Follow the Dog!' }),
          d.jsx(eh, {}),
        ],
      }),
      d.jsxs('div', {
        className: 'ald-home-hero__actions',
        children: [
          d.jsx(rt, {
            to: '/register',
            children: d.jsx(It, {
          ...
          t &&
            d.jsx('a', {
              ...
              children: d.jsx(It, {
                theme: 'borderless',
                className: 'ald-home-button-secondary',
                children: e('查看文档'),
              }),
            }),
        ],
...
function ke({ value: t, suffix: e = '', prefix: n = '', decimals: s = 0 }) {
  const [i, r] = v.useState(0),
    o = v.useRef(null);
  v.useEffect(() => {
    const l = o.current;
    if (!l) return;
    ...
    const h = new IntersectionObserver(
      ([f]) => {
        if (!f.isIntersecting || c) return;
        c = !0;
        const m = performance.now(),
          p = 1200,
          y = (g) => {
            const x = Math.min(1, (g - m) / p),
              T = 1 - Math.pow(1 - x, 3);
            r(t * T), x < 1 && (u = requestAnimationFrame(y));
          };
        (u = requestAnimationFrame(y)), h.disconnect();
      },
      { threshold: 0.35 },
    );
    return (
      h.observe(l),
      () => {
        h.disconnect(), cancelAnimationFrame(u);
      }
    );
  }, [t]);
  const a = s > 0 ? i.toFixed(s) : Math.round(i).toLocaleString();
  return d.jsxs('span', { ref: o, children: [n, a, e] });
}
function sh({ t }) {
  return d.jsx('div', {
    className: 'ald-home-hero__primary-metrics',
    children: d.jsxs('div', {
      className: 'ald-home-stats ald-home-stats--stacked',
      children: [
        d.jsxs('div', {
          children: [
            d.jsx('strong', {
              children: d.jsx(ke, { value: 99.98, suffix: '%', decimals: 2 }),
            }),
            d.jsx('span', { children: t('30 天可用率') }),
          ],
        }),
        d.jsxs('div', {
          children: [
            d.jsx('strong', {
              children: d.jsx(ke, { value: 128, suffix: '+' }),
            }),
            d.jsx('span', { children: t('接入模型数') }),
          ],
        }),
        d.jsxs('div', {
          children: [
            d.jsx('strong', {
              children: d.jsx(ke, { value: 80, suffix: 'ms', prefix: '< ' }),
            }),
            d.jsx('span', { children: t('路由转发开销') }),
          ],
        }),
      ],
    }),
...
function ih({ serverAddress: t, t: e }) {
  return d.jsx('div', {
    className: 'ald-home-hero__secondary-info',
    children: d.jsxs('div', {
      className: 'ald-home-hero__meta-grid ald-home-hero__meta-grid--stacked',
      children: [
        d.jsxs('div', {
          className: 'ald-home-hero__meta-card',
          children: [
            d.jsx('span', { children: e('兼容方式') }),
            d.jsx('strong', { children: e('OpenAI Drop-in') }),
          ],
        }),
        d.jsxs('div', {
          className: 'ald-home-hero__meta-card',
          children: [
            d.jsx('span', { children: e('默认接入') }),
            d.jsxs('strong', { children: [t, '/v1'] }),
          ],
        }),
        d.jsxs('div', {
          className: 'ald-home-hero__meta-card',
          children: [
            d.jsx('span', { children: e('鉴权方式') }),
            d.jsx('strong', { children: e('Bearer API Key') }),
          ],
        }),
        d.jsxs('div', {
          className: 'ald-home-hero__meta-card',
          children: [
            d.jsx('span', { children: e('接入成本') }),
            d.jsx('strong', { children: e('改一行 base_url') }),
          ],
        }),
      ],
    }),
...
function oh({ lang: t, onChangeLang: e, snippets: n, t: s }) {
  const i = v.useRef(null),
    [r, o] = v.useState(Yt.length);
  v.useEffect(() => {
    const l = () => {
      if (!i.current) return;
      const f = i.current.clientWidth - 260;
      if (f <= 0) {
        o(2);
        return;
      }
      const m = [50, 65, 55, 40, 50, 50, 45];
      let p = 0,
        y = 0;
      for (
        let g = 0;
        g < Yt.length && ((p += m[g] || 55), !(p > f && y >= 2));
        g++
      )
        y++;
      o(Math.min(Yt.length, y));
    };
    l();
    const u = new ResizeObserver(l);
    return i.current && u.observe(i.current), () => u.disconnect();
  }, []);
  const a = Yt.slice(0, r);
  return (
    v.useEffect(() => {
      !a.includes(t) && a.length > 0 && e(a[0]);
    }, [a, t, e]),
    d.jsx('div', {
      className: 'ald-home-hero__secondary-code',
      children: d.jsxs('div', {
        className: 'ald-home-code ald-home-code--hero',
        children: [
          d.jsxs('div', {
            className: 'ald-home-code__tabs',
            ref: i,
            children: [
              d.jsx('div', {
                className: 'ald-home-code__tab-buttons',
                children: a.map((l) =>
                  d.jsx(
                    'button',
                    {
                      type: 'button',
                      className: l === t ? 'is-active' : '',
                      onClick: () => e(l),
                      children: l,
                    },
                    l,
              ...
              d.jsx('span', { children: 'OpenAI 兼容 · /v1/chat/completions' }),
            ],
          }),
          d.jsx('pre', {
            children: n[t]
...
`)
          ...
          d.jsxs('div', {
            className: 'ald-home-code__log',
            children: [
              d.jsxs('div', {
                className: 'ald-home-code__log-header',
                children: [
                  d.jsxs('span', {
                    children: [
                      s ? s('路由日志') : '路由日志',
              ...
              d.jsx('div', { children: '→ upstream-a · 429 rate-limited' }),
              d.jsx('div', { children: '→ upstream-b · 200 · 346ms' }),
              d.jsxs('div', {
                className: 'ald-home-code__reroute',
                children: [
                  '✓ ',
                  s
                    ? s('已自动回源，用户侧无感知')
...
const rh = v.lazy(() =>
    Xo(
      () => import('./HeroRobotScene-DoNih_Yi.js'),
  ...
  I = {
    ...
    cpp: (t) => [
      ...
      `// POST ${t}/v1/chat/completions`,
      '// Authorization: Bearer sk-ald-•••••',
    ],
    r: (t) => [
      '# R httr2 example',
      `req <- request('${t}/v1/chat/completions')`,
      "req <- req_headers(req, Authorization = 'Bearer sk-ald-•••••')",
    ],
    scala: (t) => ['// Scala example', `// baseURL = ${t}/v1`],
    perl: (t) => [
      '# Perl example',
      '# Authorization: Bearer sk-ald-•••••',
      `# POST ${t}/v1/chat/completions`,
...
function Go() {
  ...
  return (
    v.useEffect(() => {
      const s = () => {
        if (!t.current) return;
        const r = t.current.clientWidth,
          a = Math.max(1, Math.floor(r / 252)),
          l = Array.from({ length: a }, (u, c) =>
            [...ah]
      ...
      return (
        i.observe(t.current),
        () => {
          window.removeEventListener('resize', s), i.disconnect();
        }
      );
    }, []),
    d.jsx('div', {
      className: 'ald-home-hero__robot-vendors',
      ref: t,
      children: e.map((s, i) =>
        d.jsx(
          'div',
          {
            className: `ald-home-vendor-col ald-home-vendor-col--${i % 7}`,
            children: d.jsx('div', {
              className: 'ald-home-vendor-col__track',
              children: [...s, ...s].map((r, o) =>
                d.jsx(
                  'span',
                  {
                    className: `ald-home-proof__item ald-home-proof__item--${r.colorIndex}`,
                    children: r.name,
                  },
                  `${r.name}-${o}`,
                ),
...
function Js() {
  return d.jsxs('div', {
    className: 'ald-home-robot-bg ald-home-robot-bg--idle',
    children: [
      d.jsx('div', {
        className: 'ald-home-robot-bg__gradient',
        'aria-hidden': 'true',
      }),
      d.jsx('div', {
        className: 'ald-home-robot-bg__mid-layer',
        children: d.jsx(Go, {}),
      }),
      d.jsx('div', {
        className: 'ald-home-robot-bg__scene',
        children: d.jsxs('div', {
          className: 'ald-home-robot-bg__placeholder',
          'aria-hidden': 'true',
          children: [
            d.jsx('div', { className: 'ald-home-robot-bg__orb' }),
            d.jsx('div', { className: 'ald-home-robot-bg__halo' }),
            d.jsx('div', { className: 'ald-home-robot-bg__core' }),
          ],
        }),
      }),
    ],
...
function lh({ docsLink: t, serverAddress: e, t: n }) {
  const [s, i] = v.useState('curl'),
    [r, o] = v.useState(!1),
    [a, l] = v.useState(!1),
    u = v.useRef(null),
    c = v.useMemo(
  ...
  return (
    v.useEffect(() => {
      const h = () => l(window.innerWidth >= 1024);
      return (
        h(),
    ...
    v.useEffect(() => {
      ...
      const h = new IntersectionObserver(
        ([f]) => {
          f.isIntersecting && (o(!0), h.disconnect());
        },
        { threshold: 0.25 },
      );
      return h.observe(u.current), () => h.disconnect();
    }, [a]),
    d.jsxs('section', {
      className: 'ald-home-hero',
      'data-ald-reveal': !0,
      children: [
        d.jsx(th, { className: 'ald-home-hero__primary-spotlight', size: 320 }),
        d.jsx('div', { className: 'ald-home-hero__primary-background' }),
        d.jsxs('div', {
          className: 'ald-home-hero__row ald-home-hero__row--primary',
          children: [
            d.jsx('div', {
              className: 'ald-home-hero__primary-copy',
              children: d.jsx(nh, { docsLink: t, t: n }),
            }),
            d.jsx('div', {
              className: 'ald-home-hero__primary-robot',
              ref: u,
              children: d.jsx('div', {
                className: 'ald-home-hero__robot-layer',
                children:
                  a && r
                    ? d.jsx(v.Suspense, {
                        fallback: d.jsx(Js, {}),
        ...
        d.jsxs('div', {
          className: 'ald-home-hero__row ald-home-hero__row--secondary',
          children: [
            d.jsx('div', {
              className: 'ald-home-hero__secondary-left',
              children: d.jsx(ih, { serverAddress: e, t: n }),
            }),
            d.jsx(oh, { lang: s, onChangeLang: i, snippets: c, t: n }),
          ],
        }),
        d.jsx('div', {
          className: 'ald-home-hero__row ald-home-hero__row--metrics',
          children: d.jsx(sh, { t: n }),
        }),
      ],
    })
  );
...
const ch = [
  [
    ...
    '稳定性优先',
    'Stability First',
    '多路由自动回源，provider 波动用户无感。持续监控模型健康状态。',
  ],
  [
    '02',
    '真实、不掺水',
    'No Dilution',
    '模型能力与运行状态透明展示，不做营销话术修饰。',
  ],
  [
    '03',
    'OpenAI 兼容',
    'Drop-in API',
    '改 base_url 即可完成迁移。所有官方 SDK 与工具链开箱可用。',
  ],
  [
    '04',
    '统一入口',
    'One Gateway',
    '一个密钥、一套账单，按需在 128+ 模型之间自由切换。',
  ],
  [
    '05',
    '鉴别与持续监控',
    'Active Monitoring',
    '后台特有的渠道鉴别逻辑，实时筛选劣质节点，只保留健康上游。',
  ],
  [
    '06',
    '综合成本更低',
    'Real Lower Cost',
    '智能路由 + 缓存 + 压缩，让账单真实下降，而非仅卷表面单价。',
  ],
];
function uh() {
  return d.jsxs('section', {
    className: 'ald-home-section',
    'data-ald-reveal': !0,
    children: [
      d.jsxs('div', {
        className: 'ald-home-section__heading',
        children: [
          d.jsx('span', { children: '§ CORE' }),
          d.jsx('h2', { children: '六项核心能力' }),
          d.jsx('p', { children: 'Six things we take seriously.' }),
        ],
      }),
      d.jsx('div', {
        className: 'ald-home-grid ald-home-grid--three',
        children: ch.map(([t, e, n, s]) =>
          d.jsxs(
            'article',
            {
              className: 'ald-home-card ald-home-card--lift',
              children: [
                d.jsxs('div', {
                  className: 'ald-home-card__meta',
                  children: [
                    d.jsxs('span', { children: ['— ', t] }),
                    d.jsx('span', {
                      className: 'ald-home-card__dot',
                      children: '●',
                    }),
                  ],
                }),
                d.jsx('h3', { children: e }),
                d.jsx('small', { children: n }),
                d.jsx('p', { children: s }),
              ],
            },
            t,
...
const ti = [
  {
    ...
    latency: '1.18s',
    status: 'OPERATIONAL',
    bars: [80, 82, 78, 85, 81, 79, 83, 80, 82, 81],
  },
  {
    name: 'gpt-5',
    inPrice: '¥17.50',
    ...
    latency: '0.96s',
    status: 'OPERATIONAL',
    bars: [65, 70, 68, 72, 69, 74, 71, 70, 73, 69],
  },
  {
    name: 'gemini-2.5-pro',
    inPrice: '¥8.80',
    ...
    latency: '0.74s',
    status: 'OPERATIONAL',
    bars: [50, 55, 52, 58, 54, 56, 53, 57, 55, 56],
  },
  {
    name: 'deepseek-v3.2',
    inPrice: '¥0.98',
    ...
    latency: '0.52s',
    status: 'OPERATIONAL',
    bars: [38, 42, 40, 44, 41, 43, 40, 42, 41, 43],
  },
  {
    name: 'qwen3-max',
    inPrice: '¥2.80',
    ...
    latency: '0.61s',
    status: 'OPERATIONAL',
    bars: [44, 48, 46, 50, 47, 49, 46, 48, 47, 49],
  },
  {
    name: 'moonshot-v2',
    inPrice: '¥4.20',
    ...
    latency: '0.88s',
    status: 'DEGRADED',
    bars: [60, 75, 50, 80, 45, 70, 55, 85, 60, 72],
  },
];
function hh({ t }) {
  const [e, n] = v.useState(0),
    s = ti[e];
  return d.jsxs('section', {
    ...
    children: [
      d.jsxs('div', {
        className: 'ald-home-section__header-row',
        children: [
          d.jsxs('div', {
            className: 'ald-home-section__heading',
            children: [
              d.jsx('span', { children: '§ MODELS' }),
              d.jsx('h2', { children: t('多模型统一入口，按需自由切换') }),
              d.jsx('p', { children: t('点击任意模型查看实时延迟分布') }),
            ],
          }),
          d.jsxs('div', {
            className: 'ald-home-section__actions',
            children: [
              d.jsx('div', {
                className: 'ald-home-section__hint',
                children: t('价格与状态仅作首页展示，实际以控制台配置为准'),
              }),
              d.jsxs('button', {
                type: 'button',
                className: 'ald-home-inline-button',
                children: [t('查看全部 128 个模型'), ' →'],
              }),
            ],
          }),
        ],
      ...
      d.jsxs('div', {
        className: 'ald-home-models',
        children: [
          d.jsxs('div', {
            className: 'ald-home-models__table',
            children: [
              d.jsxs('div', {
                className: 'ald-home-models__head',
                children: [
                  d.jsx('span', { children: 'MODEL' }),
                  d.jsx('span', { children: 'IN / 1M' }),
                  d.jsx('span', { children: 'OUT / 1M' }),
                  d.jsx('span', { children: 'P50' }),
              ...
              ti.map((i, r) =>
                d.jsxs(
                  ...
                  {
                    type: 'button',
                    className: `ald-home-models__row ${r === e ? 'is-active' : ''}`,
                    onClick: () => n(r),
                    children: [
                      d.jsx('span', { children: i.name }),
                      d.jsx('span', { children: i.inPrice }),
                      d.jsx('span', { children: i.outPrice }),
                      d.jsx('span', { children: i.latency }),
                      d.jsx('span', {
                        className:
                          i.status === 'OPERATIONAL' ? 'is-ok' : 'is-degraded',
                        children: i.status,
                      }),
                    ],
                  },
          ...
          d.jsxs('div', {
            className: 'ald-home-models__detail',
            children: [
              d.jsxs('div', {
                children: [
                  d.jsx('label', { children: 'SELECTED' }),
                  d.jsx('strong', { children: s.name }),
                  d.jsx('p', {
                    className: 'ald-home-models__detail-copy',
                    children: t(
                      '适合需要稳定输出、统一路由与透明计费的生产场景。',
                    ),
                  }),
                ],
              }),
              d.jsxs('div', {
                children: [
                  d.jsx('label', { children: 'EST. 1K TOKENS' }),
                  d.jsx('strong', {
                    className: 'ald-home-highlight',
                    children: '¥0.3360',
                  }),
                  d.jsx('p', {
                    className: 'ald-home-models__detail-copy',
                    children: t(
                      '以输入 + 输出组合估算，实际价格以后台配置与路由结果为准。',
                    ),
                  }),
                ],
              }),
              d.jsxs('div', {
                children: [
                  d.jsx('label', { children: 'LATENCY · LAST 10 MIN' }),
                  d.jsx(
                    'div',
                    {
                      className: 'ald-home-models__bars',
                      children: s.bars.map((i, r) =>
                        d.jsx('span', { style: { height: `${i}%` } }, r),
                      ),
                    },
                    s.name,
                  ),
...
function fh({ serverAddress: t, t: e }) {
  const n = [
    ['01', e('注册账号，获取 API Key'), 'ailink.dog/register'],
    ['02', e('将 base_url 指向站点 API 地址'), `${t}/v1`],
    ['03', e('调用任意模型，实时查看用量与账单'), 'console.ailink.dog'],
  ];
  return d.jsxs('section', {
    className: 'ald-home-section ald-home-quickstart',
    'data-ald-reveal': !0,
    children: [
      d.jsxs('div', {
        children: [
          d.jsxs('div', {
            className: 'ald-home-section__heading',
            children: [
              d.jsx('span', { children: '§ QUICK START' }),
              d.jsx('h2', { children: e('3 步完成接入') }),
            ],
          }),
          d.jsx('div', {
            className: 'ald-home-steps',
            children: n.map(([s, i, r]) =>
              d.jsxs(
                'div',
                {
                  className: 'ald-home-steps__item',
                  children: [
                    d.jsx('span', { children: s }),
                    d.jsx('strong', { children: i }),
                    d.jsx('code', { children: r }),
                  ],
                },
                s,
              ),
      ...
      d.jsxs('div', {
        children: [
          d.jsxs('div', {
            className: 'ald-home-section__heading',
            children: [
              d.jsx('span', { children: '§ FOR' }),
              d.jsx('h2', { children: e('为谁而做') }),
            ],
          }),
          d.jsx('div', {
            className: 'ald-home-grid ald-home-grid--two',
            children: dh.map(([s, i]) =>
              d.jsxs(
                'article',
                {
  ...
  return d.jsxs('section', {
    ...
    children: [
      d.jsxs('div', {
        className: 'ald-home-section__heading',
        children: [
          d.jsx('span', { children: '§ FAQ' }),
          d.jsx('h2', { children: '常见问题' }),
        ],
      }),
      d.jsx('div', {
        className: 'ald-home-faq',
        children: mh.map(([t, e]) =>
          d.jsxs(
            'details',
            {
              className: 'ald-home-faq__item',
              children: [
                d.jsxs('summary', {
                  children: [
                    d.jsx('span', { children: t }),
                    d.jsx('span', { children: '+' }),
                  ],
                }),
                d.jsx('p', { children: e }),
...
function gh({ docsLink: t, t: e }) {
  return d.jsxs('section', {
    className: 'ald-home-final',
    'data-ald-reveal': !0,
    children: [
      d.jsx('img', {
        src: '/logo.png',
        alt: 'AiLink.Dog',
        className: 'ald-home-final__logo',
      }),
      d.jsxs('h2', {
        children: [
          e('接入所有模型'),
          ', ',
          d.jsx('span', { children: e('自由定义选择') }),
          '。',
        ],
      }),
      d.jsx('p', { children: e('更低算力成本，享受 AI 浪潮。') }),
      d.jsx('small', { children: 'All AI, One Link — Follow the Dog.' }),
      d.jsxs('div', {
        className: 'ald-home-final__actions',
        children: [
          d.jsx(rt, {
            to: '/register',
            children: d.jsx(It, {
  ...
  return (
    v.useEffect(() => {
      const o = document.documentElement,
        a = Array.from(document.querySelectorAll('[data-ald-reveal]')),
        l = () => {
          const f = window.scrollY || 0,
            m = document.documentElement.scrollHeight - window.innerHeight,
            p = m > 0 ? Math.min(1, f / m) : 0;
          o.style.setProperty('--ald-scroll-progress', `${p}`),
            o.style.setProperty('--ald-scroll-y', `${f}`);
        };
      l();
      let u = !1;
      const c = () => {
        ...
        h = new IntersectionObserver(
          (f) => {
            f.forEach((m) => {
              m.isIntersecting && m.target.classList.add('is-visible');
            });
          },
          { threshold: 0.18, rootMargin: '0px 0px -10% 0px' },
        );
      return (
        a.forEach((f) => h.observe(f)),
        window.addEventListener('scroll', c, { passive: !0 }),
        () => {
          h.disconnect(), window.removeEventListener('scroll', c);
        }
      );
    }, []),
    d.jsxs('div', {
      className: `ald-home ${r ? 'ald-home-dark' : 'ald-home-light'}`,
      children: [
        d.jsx('div', { className: 'ald-home-progress', 'aria-hidden': 'true' }),
        d.jsxs('header', {
          className: 'ald-home-nav',
          children: [
            d.jsxs('div', {
              className: 'ald-home-nav__left',
              children: [
                d.jsxs(rt, {
                  to: '/',
                  className: 'ald-home-brand',
                  'aria-label': 'AiLink.Dog',
                  children: [
                    d.jsx('img', {
                      src: '/logo.png',
                      alt: 'AiLink.Dog',
                    ...
                    d.jsxs('span', {
                      className: 'ald-home-brand__text',
                      children: [
                        'AiLink',
                        d.jsx('span', {
                          className: 'ald-home-brand__dot',
                          children: '.Dog',
                        }),
                      ],
                    }),
                ...
                d.jsx('span', { className: 'ald-home-badge', children: 'ALD' }),
                d.jsxs('nav', {
                  className: 'ald-home-nav__links',
                  'aria-label': 'Homepage',
                  children: [
                    d.jsx(rt, { to: '/pricing', children: i('模型广场') }),
                    d.jsx(rt, { to: '/pricing', children: i('定价') }),
                    t &&
                      d.jsx('a', {
                        href: t,
                        target: '_blank',
                    ...
                    d.jsx(rt, { to: '/console', children: i('控制台') }),
                  ],
                }),
              ],
            }),
            d.jsxs('div', {
              className: 'ald-home-nav__right',
              children: [
                d.jsx('span', {
                  className: 'ald-home-nav__meta',
                  children: e ? '中 / EN' : 'EN / 中',
                }),
                d.jsx('span', {
                  className: 'ald-home-nav__meta',
                  children: r ? 'dark' : 'light',
                }),
                d.jsx(rt, {
                  to: '/login',
                  className: 'ald-home-nav__login',
                  children: i('登录'),
                }),
                d.jsx(rt, {
                  to: '/register',
        ...
        d.jsx('div', {
          className: 'ald-home-ticker',
          children: d.jsx('div', {
            className: 'ald-home-ticker__track',
            children: [...ei, ...ei].map(([o, a], l) =>
              d.jsxs(
                'span',
                {
                  className: 'ald-home-ticker__item',
                  children: [
                    d.jsx('span', { className: 'ald-home-ticker__dot' }),
                    d.jsx('span', {
                      className: 'ald-home-ticker__model',
                      children: o,
                    }),
                    d.jsx('span', { children: a }),
                  ],
                },
                `${o}-${l}`,
              ),
        ...
        d.jsxs('main', {
          children: [
            d.jsx(lh, { docsLink: t, serverAddress: n, t: i }),
            d.jsxs('section', {
              className: 'ald-home-proof',
              'data-ald-reveal': !0,
              children: [
                d.jsxs('div', {
                  className: 'ald-home-proof__intro',
                  children: [
                    d.jsx('span', { children: '§ TRUST' }),
                    d.jsx('p', {
                      children: i(
                        '支持多家主流模型供应商，面向真实生产场景持续维护',
                      ),
                    }),
                  ],
                }),
                d.jsx('div', {
                  className: 'ald-home-proof__grid',
                  children: yh.map((o, a) =>
                    d.jsx(
                      'div',
                      {
                        className: `ald-home-proof__item ald-home-proof__item--${a % 3}`,
                        children: o,
                      },
                      o,
                    ),
            ...
            d.jsx(uh, { t: i }),
            d.jsx(hh, { t: i }),
            d.jsx(fh, { serverAddress: n, t: i }),
            d.jsx(ph, { t: i }),
            d.jsx(gh, { docsLink: t, t: i }),
          ],
        }),
      ],
    })
...
const jh = () => {
  ...
  const { t, i18n: e } = tr(),
    ...
    c = Zo(),
    h =
      ((y = n == null ? void 0 : n.status) == null ? void 0 : y.docs_link) ||
      '',
    f =
      ((g = n == null ? void 0 : n.status) == null
        ? void 0
        : g.server_address) || `${window.location.origin}`,
    m = e.language.startsWith('zh'),
    p = async () => {
      a(localStorage.getItem('home_page_content') || '');
      const x = await kn.get('/api/home_page_content'),
        { success: T, message: b, data: w } = x.data;
      if (T) {
        let A = w;
        if (
          (w.startsWith('https://') || (A = er.parse(w)),
          a(A),
          localStorage.setItem('home_page_content', A),
          w.startsWith('https://'))
        ) {
          const j = document.querySelector('iframe');
          j &&
            (j.onload = () => {
              j.contentWindow.postMessage({ themeMode: s }, '*'),
                j.contentWindow.postMessage({ lang: e.language }, '*');
            });
        }
      } else Jo(b), a('加载首页内容失败...');
      r(!0);
    };
  return (
    v.useEffect(() => {
      (async () => {
        const T = localStorage.getItem('notice_close_date'),
          b = new Date().toDateString();
        if (T !== b)
          try {
            const w = await kn.get('/api/notice'),
              { success: A, data: j } = w.data;
            A && j && j.trim() !== '' && u(!0);
          } catch (w) {
            console.error('获取公告失败:', w);
          }
      })();
    }, []),
    v.useEffect(() => {
    ...
    d.jsxs('div', {
      ...
      children: [
        d.jsx(Qo, { visible: l, onClose: () => u(!1), isMobile: c }),
        i && o === ''
          ? d.jsx(xh, {
              docsLink: h,
              isChinese: m,
