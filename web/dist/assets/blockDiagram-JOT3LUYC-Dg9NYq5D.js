...
import { c as Le } from './clone-C-OSllvx.js';
import { G as Se } from './graph-ByJpsr8c.js';
import { c as ve } from './channel-BL7ad_n3.js';
...
var yt = (function () {
  var e = d(function (T, x, g, u) {
      for (g = g || {}, u = T.length; u--; g[T[u]] = x);
      return g;
    }, 'o'),
    t = [1, 7],
    r = [1, 13],
      ...
      performAction: d(function (x, g, u, w, S, c, _) {
        ...
        switch (S) {
          ...
          case 14:
            ...
            break;
          case 15:
            w.getLogger().debug('Rule: LABEL link: ', c[p - 3], c[p - 1], c[p]),
          ...
          case 27:
            w
              ...
              w.generateId(),
              (this.$ = { ...c[p - 2], type: 'composite', children: c[p - 1] });
            break;
          case 28:
            w.getLogger().debug(
              'Rule: blockStatement : ',
          ...
          switch (U[0]) {
            ...
            case 2:
              ...
              q &&
                ...
                S.push($.$),
                c.push($._$),
                (Tt = _[u[u.length - 2]][u[u.length - 1]]),
                u.push(Tt);
              break;
            case 3:
              return !0;
...
` +
        ...
        performAction: d(function (g, u, w, S) {
          switch (w) {
            ...
            case 38:
              return (
                this.popState(), g.getLogger().debug('Lex: (('), 'NODE_DEND'
              );
            case 39:
              return (
                this.popState(), g.getLogger().debug('Lex: (('), 'NODE_DEND'
            ...
            case 55:
              return (
                g.getLogger().debug('Lexa: -)'), this.pushState('NODE'), 36
              );
            case 56:
              return (
                g.getLogger().debug('Lexa: (-'), this.pushState('NODE'), 36
            ...
            case 59:
              return (
                g.getLogger().debug('Lex: ((('), this.pushState('NODE'), 36
              );
            case 60:
              return g.getLogger().debug('Lexa: )'), this.pushState('NODE'), 36;
            case 61:
            ...
            case 83:
              return (
                g.getLogger().debug('LEX: NODE_DESCR:', u.yytext), 'NODE_DESCR'
              );
            case 84:
            ...
            case 103:
              return (
                this.popState(), g.getLogger().debug('Lex: LINK', u.yytext), 15
              );
            case 104:
              return (
                this.popState(), g.getLogger().debug('Lex: LINK', u.yytext), 15
...
var Ee = yt,
  ...
  ke = z(),
  ct = new Map(),
  De = d((e) => me.sanitizeText(e, ke), 'sanitizeText'),
  Te = d(function (e, t = '') {
    let r = ct.get(e);
...
var It = 0,
  ...
  ze = d(() => [...V.values()], 'getBlocksFlat'),
  Ae = d(() => vt || [], 'getBlocks'),
  Me = d(() => St, 'getEdges'),
  Fe = d((e) => V.get(e), 'getBlock'),
  We = d((e) => {
    V.set(e.id, e);
  }, 'setBlock'),
  Pe = d(() => console, 'getLogger'),
  Ye = d(function () {
    return ct;
  }, 'getClasses'),
  He = {
...
function ot(e, t, r = 0, n = 0) {
  ...
  if (((o = e.children) == null ? void 0 : o.length) > 0) {
    ...
    (i = N.width),
      (a = N.height),
      L.debug('setBlockSizes abc95 maxWidth of', e.id, ':s children is ', i, a);
    ...
    const k = e.columns ?? -1;
    let T = 0;
    for (const S of e.children) T += S.widthInColumns ?? 1;
    let x = e.children.length;
    k > 0 && k < T && (x = k);
    const g = Math.ceil(T / x);
    let u = x * (i + I) + I,
      w = g * (a + I) + I;
    if (u < r) {
      L.debug(
...
d(ot, 'setBlockSizes');
function Et(e, t) {
  var n, i, a, s, l, o, f, h, y, b, m, E, D, v, N, k, T;
  L.debug(
  ...
  L.debug(
    `layout blocks (<==layoutBlocks) ${e.id} x: ${(N = e == null ? void 0 : e.size) == null ? void 0 : N.x} y: ${(k = e == null ? void 0 : e.size) == null ? void 0 : k.y} width: ${(T = e == null ? void 0 : e.size) == null ? void 0 : T.width}`,
  );
}
d(Et, 'layoutBlocks');
function _t(
...
var ir = d((e, t, r, n) => {
  ...
  cr = d((e, t) => {
    ...
    let o;
    if (t.startLabelLeft) {
      const f = j(t.startLabelLeft, t.labelStyle),
    ...
    if (t.startLabelRight) {
      const f = j(t.startLabelRight, t.labelStyle),
        h = e.insert('g').attr('class', 'edgeTerminals'),
        y = h.insert('g').attr('class', 'inner');
    ...
    if (t.endLabelLeft) {
      const f = j(t.endLabelLeft, t.labelStyle),
        h = e.insert('g').attr('class', 'edgeTerminals'),
        y = h.insert('g').attr('class', 'inner');
      o = y.node().appendChild(f);
      const b = f.getBBox();
    ...
    if (t.endLabelRight) {
      const f = j(t.endLabelRight, t.labelStyle),
        h = e.insert('g').attr('class', 'edgeTerminals'),
        y = h.insert('g').attr('class', 'inner');
      o = y.node().appendChild(f);
      const b = f.getBBox();
...
var or = d((e, t) => {
    ...
    const n = z(),
      { subGraphTitleTotalMargin: i } = ge(n);
    if (e.label) {
      const a = mt[e.id];
      let s = e.x,
        l = e.y;
  ...
  gr = d(function (e, t, r, n, i, a, s) {
    ...
    (z().flowchart.arrowMarkerAbsolute || z().state.arrowMarkerAbsolute) &&
      ...
      nr(N, r, k, s, i);
    let T = {};
    return o && (T.updatedPath = l), (T.originalPath = r.points), T;
  }, 'insertEdge'),
  ur = d((e) => {
    const t = new Set();
    for (const r of e)
...
var xr = $t;
function te(e, t, r, n) {
  var i, a, s, l, o, f, h, y, b, m, E, D, v, N, k;
  if (
    ((i = t.y - e.y),
    (s = e.x - t.x),
    (o = t.x * e.y - e.x * t.y),
...
function ee(e, t, r) {
  ...
  for (
    ...
    var y = t[h],
      ...
      m = yr(e, r, { x: o + y.x, y: f + y.y }, { x: o + b.x, y: f + b.y });
    m && a.push(m);
  }
  return a.length
    ? (a.length > 1 &&
...
var wr = d((e, t) => {
  ...
  mr = wr,
  C = { node: fr, circle: xr, ellipse: Qt, polygon: br, rect: mr },
  F = d(async (e, t, r, n) => {
    const i = z();
    let a;
    ...
    t.labelType === 'markdown'
      ...
      : (y = h.appendChild(j(Nt(xt(f), i), t.labelStyle, !1, n)));
    let b = y.getBBox();
    const m = t.padding / 2;
...
var Ar = d((e, t) => {
    ...
    const m = s
      .node()
      .appendChild(j(y.join ? y.join('<br/>') : y, t.labelStyle, !0, !0));
    if (Z(z().flowchart.htmlLabels)) {
  ...
  Kr = d((e, t) => {
    ...
    const E = (S = t.classData.annotations) == null ? void 0 : S[0],
      D = t.classData.annotations[0]
        ...
        : '',
      v = b.node().appendChild(j(D, t.labelStyle, !0, !0));
    let N = v.getBBox();
    if (Z(z().flowchart.htmlLabels)) {
      const c = v.children[0],
        _ = R(v);
      (N = c.getBoundingClientRect()),
        _.attr('width', N.width),
        _.attr('height', N.height);
    }
    t.classData.annotations[0] && ((y += N.height + n), (h += N.width));
    ...
    t.classData.type !== void 0 &&
      ...
      (z().flowchart.htmlLabels
        ? (k += '&lt;' + t.classData.type + '&gt;')
        : (k += '<' + t.classData.type + '>'));
    const T = b.node().appendChild(j(k, t.labelStyle, !0, !0));
    R(T).attr('class', 'classTitle');
    let x = T.getBBox();
    if (Z(z().flowchart.htmlLabels)) {
    ...
    t.classData.members.forEach((c) => {
      ...
      const A = b
        .node()
        .appendChild(j(p, _.cssStyle ? _.cssStyle : t.labelStyle, !0, !0));
      let O = A.getBBox();
      if (Z(z().flowchart.htmlLabels)) {
...
function kt(e, t, r = !1) {
  ...
  const o = de((n == null ? void 0 : n.styles) ?? []),
    f = n.label,
...
async function le(e, t, r, n, i) {
  const a = new Se({ multigraph: !0, compound: !0 });
  a.setGraph({
    rankdir: 'TB',
    nodesep: 10,
    ranksep: 10,
      ...
      if (l != null && l.size && o != null && o.size) {
        ...
        gr(
          ...
          s.label &&
            ...
            or({ ...s, x: y[1].x, y: y[1].y }, { originalPath: y }));
      }
    }
}
d(le, 'insertEdges');
var Ur = d(function (e, t) {
  ...
  jr = d(async function (e, t, r, n) {
    ...
    if ((await ne(E, y, s), await le(E, m, b, s, t), D)) {
      const v = D,
        N = Math.max(1, Math.round(0.125 * (v.width / v.height))),
        k = v.height + N + 10,
        T = v.width + 10,
        { useMaxWidth: x } = a;
      fe(f, k, T, !!x),
  ...
  sa = { parser: Ee, db: Ke, renderer: Vr, styles: Ue };
