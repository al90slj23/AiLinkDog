import { g as ze, s as Ge } from './chunk-RZ5BOZE2-Dl5yENMm.js';
import {
  _ as f,
  b as Xe,
  g as Je,
...
var Ae = (function () {
  var e = f(function (P, i, r, l) {
    ...
    Se = {
      ...
      performAction: f(function (i, r, l, s, E, t, de) {
        var n = t.length - 1;
        switch (E) {
          case 4:
      ...
      table: [
        { 3: 1, 4: 2, 6: a, 9: u, 11: o, 13: m },
        { 1: [3] },
        { 3: 8, 4: 2, 5: [1, 7], 6: a, 9: u, 11: o, 13: m },
        { 5: [1, 9] },
        { 10: [1, 10] },
        { 12: [1, 11] },
        e(c, [2, 6]),
        { 3: 12, 4: 2, 6: a, 9: u, 11: o, 13: m },
        { 1: [2, 2] },
        {
          4: 17,
          5: p,
            ...
            case 2:
              if (
                ...
                (Te = this.performAction.apply(
                  J,
                  [n, Pe, ye, z.yy, q[1], E, t].concat(Ke),
                )),
                typeof Te < 'u')
              )
                return Te;
      ...
      var P = {
        ...
        unput: f(function (i) {
          ...
          return (
            ...
            this.options.ranges &&
              (this.yylloc.range = [E[0], E[0] + this.yyleng - r]),
...
` +
        ...
        next: f(function () {
          ...
          for (var E = this._currentRules(), t = 0; t < E.length; t++)
            if (
              ((l = this._input.match(this.rules[E[t]])),
              l && (!r || l[0].length > r[0].length))
            ) {
              if (((r = l), (s = t), this.options.backtrack_lexer)) {
                if (((i = this.test_match(l, E[t])), i !== !1)) return i;
                if (this._backtrack) {
                  r = !1;
                  continue;
                } else return !1;
          ...
          return r
            ? ((i = this.test_match(r, E[s])), i !== !1 ? i : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: f(function (r, l, s, E) {
          switch (s) {
            case 0:
              return 'title';
            case 1:
    ...
    ((Z = class {
      ...
      defineClass(a, u) {
        for (const o of a) {
          ...
          m === void 0 &&
            ((m = { id: o, styles: [], textStyles: [] }),
            this.classes.set(o, m)),
            u &&
      ...
      getData() {
        ...
        for (const h of this.requirements.values()) {
          const d = h;
          (d.id = h.name),
            (d.cssStyles = h.cssStyles),
            (d.cssClasses = h.classes.join(' ')),
            (d.shape = 'requirementBox'),
            (d.look = a.look),
            u.push(d);
        }
        ...
        for (const h of this.relations) {
          ...
          const I = h.type === this.Relationships.CONTAINS,
            k = {
              id: `${h.src}-${h.dst}-${d}`,
              start:
                ((m = this.requirements.get(h.src)) == null
                  ? void 0
                  : m.name) ??
...
`,
  ...
  Be = {};
rt(Be, { draw: () => ft });
var ft = f(async function (e, a, u, o) {
    qe.info('REF0:'), qe.info('Drawing requirement diagram (unified)', a);
    const { securityLevel: m, state: c, layout: p } = Ne(),
      R = o.db.getData(),
      h = ze(a, m);
    (R.type = o.type),
