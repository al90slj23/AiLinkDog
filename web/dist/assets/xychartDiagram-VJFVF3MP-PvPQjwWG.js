...
import { i as Si } from './init-Gi6I4Gst.js';
import { o as _i } from './ordinal-Cboi1Yqb.js';
import { l as Wt } from './linear-2Ht_xilX.js';
...
function pt() {
  ...
  function w() {
    var y = t().length,
      ...
      S = D ? n : s,
      v = D ? s : n;
    (o = (v - S) / Math.max(1, y - p + k * 2)),
      f && (o = Math.floor(o)),
      (S += (v - S - o * (y - p)) * T),
      (u = o * (1 - p)),
      f && ((S = Math.round(S)), (u = Math.round(u)));
  ...
  return (
    ...
    (e.align = function (y) {
      return arguments.length ? ((T = Math.max(0, Math.min(1, y))), w()) : T;
    }),
    (e.copy = function () {
      return pt(t(), [s, n]).round(f).paddingInner(p).paddingOuter(k).align(T);
    }),
    Si.apply(w(), arguments)
  );
}
var ft = (function () {
  var e = a(function (B, h, c, g) {
    ...
    lt = [1, 10, 12, 14, 16, 18, 19, 21, 23, 24, 26, 27, 28, 34, 35, 36],
    I = [
    ...
    ct = {
      ...
      performAction: a(function (h, c, g, x, A, r, Z) {
        var d = r.length - 1;
        switch (A) {
          case 5:
      ...
      table: [
        ...
        e(I, [2, 51]),
        e(C, [2, 10]),
        e(C, [2, 22], { 30: 41, 29: 56, 24: K, 27: vt }),
        e(C, [2, 24]),
        e(C, [2, 25]),
        { 31: [1, 57] },
        {
        ...
        for (var P, O, M, xt, z = {}, at, V, Vt, rt; ; ) {
          if (
            ...
            this.defaultActions[O]
              ? (M = this.defaultActions[O])
              : ((P === null || typeof P > 'u') && (P = Mt()),
                (M = Z[O] && Z[O][P])),
            ...
            case 2:
              if (
                ...
                (xt = this.performAction.apply(
                  z,
                  [d, Et, nt, W.yy, M[1], A, r].concat(hi),
                )),
                typeof xt < 'u')
              )
                return xt;
              V &&
                ...
                A.push(z.$),
                r.push(z._$),
                (Vt = Z[g[g.length - 2]][g[g.length - 1]]),
                g.push(Vt);
              break;
            case 3:
              return !0;
      ...
      var B = {
        ...
        unput: a(function (h) {
          ...
          return (
            ...
            this.options.ranges &&
              (this.yylloc.range = [A[0], A[0] + this.yyleng - c]),
...
` +
        ...
        next: a(function () {
          ...
          for (var A = this._currentRules(), r = 0; r < A.length; r++)
            if (
              ((g = this._input.match(this.rules[A[r]])),
              g && (!c || g[0].length > c[0].length))
            ) {
              if (((c = g), (x = r), this.options.backtrack_lexer)) {
                if (((h = this.test_match(g, A[r])), h !== !1)) return h;
                if (this._backtrack) {
                  c = !1;
                  continue;
                } else return !1;
          ...
          return c
            ? ((h = this.test_match(c, A[x])), h !== !1 ? h : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: a(function (c, g, x, A) {
          switch (x) {
            case 0:
              break;
            case 1:
...
var N,
  Yt =
    ...
    a(N, 'TextDimensionCalculatorWithFont'),
    N),
  Ot = 0.7,
  zt = 0.2,
  X,
  ...
  Ri =
    ((Y = class extends Ht {
      constructor(t, i, s, n, o) {
        super(t, n, o, i),
          (this.categories = s),
          (this.scale = pt().domain(this.categories).range(this.getRange()));
      }
      setRange(t) {
        super.setRange(t);
      }
...
function yt(e, t, i, s) {
  const n = new Yt(s);
  return wt(e)
    ? new Ri(t, i, e.categories, e.title, n)
    : new Di(t, i, [e.min, e.max], e.title, n);
}
a(yt, 'getAxis');
var U,
  vi =
...
var q,
    ...
    ((q = class {
      ...
      calculateVerticalSpace() {
        let t = this.chartConfig.width,
          ...
          f = this.componentStore.plot.calculateSpace({ width: o, height: u });
        (t -= f.width),
          (i -= f.height),
          ...
          (f = this.componentStore.xAxis.calculateSpace({
            width: t,
            height: i,
          })),
          (i -= f.height),
          this.componentStore.yAxis.setAxisPosition('left'),
          (f = this.componentStore.yAxis.calculateSpace({
            width: t,
            height: i,
          })),
          (s = f.width),
          ...
          this.chartData.plots.some((p) => mt(p)) &&
      ...
      calculateHorizontalSpace() {
        let t = this.chartConfig.width,
          ...
          p = this.componentStore.plot.calculateSpace({ width: u, height: f });
        (t -= p.width),
          (i -= p.height),
  ...
  it = St(),
  b = kt(),
  bt = it.plotColorPalette.split(',').map((e) => e.trim()),
  ot = !1,
  Ct = !1;
function St() {
  const e = gi(),
...
function _t() {
  const e = At();
  return Nt(xi.xyChart, e.xyChart);
}
...
function qt(e) {
  e === 'horizontal'
    ? (tt.chartOrientation = 'horizontal')
    : (tt.chartOrientation = 'vertical');
}
a(qt, 'setOrientation');
function Qt(e) {
...
a(Zt, 'setYAxisTitle');
function Jt(e, t) {
  (b.yAxis = { type: 'linear', title: b.yAxis.title, min: e, max: t }),
    (Ct = !0);
}
...
function ti(e) {
  const t = Math.min(...e),
    i = Math.max(...e),
    s = F(b.yAxis) ? b.yAxis.min : 1 / 0,
    n = F(b.yAxis) ? b.yAxis.max : -1 / 0;
  b.yAxis = {
    type: 'linear',
    title: b.yAxis.title,
    min: Math.min(s, t),
...
function Rt(e) {
  ...
  if (!ot) {
    const i = F(b.xAxis) ? b.xAxis.min : 1 / 0,
      s = F(b.xAxis) ? b.xAxis.max : -1 / 0;
    Tt(Math.min(i, 1), Math.max(s, e.length));
  }
  if (
    (Ct || ti(e),
    wt(b.xAxis) && (t = b.xAxis.categories.map((i, s) => [i, e[s]])),
    F(b.xAxis))
  ) {
    const i = b.xAxis.min,
      s = b.xAxis.max,
...
function ii(e, t) {
  const i = Rt(t);
  b.plots.push({ type: 'line', strokeFill: Dt(J), strokeWidth: 2, data: i }),
    J++;
}
a(ii, 'setLineData');
function ei(e, t) {
  const i = Rt(t);
  b.plots.push({ type: 'bar', fill: Dt(J), data: i }), J++;
}
a(ei, 'setBarData');
function si() {
  if (b.plots.length === 0)
    throw Error('No Plot to render, please provide a plot with some data');
  return (b.title = Xt()), Mi.build(tt, b, it, Gt);
}
...
` + e,
    ...
    const T = wi(t),
      w = T.append('g').attr('class', 'main'),
      y = w
        .append('rect')
        .attr('width', u.width)
        .attr('height', u.height)
        .attr('class', 'background');
    Ci(T, u.height, u.width, !0),
      T.attr('viewBox', `0 0 ${u.width} ${u.height}`),
      y.attr('fill', o.backgroundColor),
      n.setTmpSVGG(T.append('g').attr('class', 'mermaid-tmp-group'));
    ...
    function v(m) {
      ...
      for (const [E] of m.entries()) {
        ...
        E > 0 && S[l] && (K = S[l]),
          (l += m[E]),
          (_ = S[l]),
          _ || (_ = S[l] = K.append('g').attr('class', m[E]));
      }
      return _;
    }
    a(v, 'getGroup');
  ...
  Oi = { draw: Wi },
  ji = { parser: Ti, db: Bi, renderer: Oi };
