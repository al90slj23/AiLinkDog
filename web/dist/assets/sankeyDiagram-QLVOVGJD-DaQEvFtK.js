...
import { o as Nt } from './ordinal-Cboi1Yqb.js';
...
function It(t) {
  for (var e = (t.length / 6) | 0, s = new Array(e), i = 0; i < e; )
    s[i] = '#' + t.slice(i * 6, ++i * 6);
  return s;
}
...
function ct(t, e) {
  ...
  if (e == null) {
    for (; ++i < s; )
      if ((r = t[i]) != null && r >= r)
        for (a = r; ++i < s; ) (r = t[i]) != null && r > a && (a = r);
  } else
    for (; ++i < s; )
      if ((r = e(t[i], i, t)) != null && r >= r)
        for (a = r; ++i < s; ) (r = e(t[i], i, t)) != null && r > a && (a = r);
  return a;
}
function mt(t, e) {
  var s = t.length,
  ...
  if (e == null) {
    for (; ++i < s; )
      if ((r = t[i]) != null && r >= r)
        for (a = r; ++i < s; ) (r = t[i]) != null && a > r && (a = r);
  } else
    for (; ++i < s; )
      if ((r = e(t[i], i, t)) != null && r >= r)
        for (a = r; ++i < s; ) (r = e(t[i], i, t)) != null && a > r && (a = r);
  return a;
}
function nt(t, e) {
  var s = t.length,
    ...
    r,
    a = 0;
  if (e == null) for (; ++i < s; ) (r = +t[i]) && (a += r);
  else for (; ++i < s; ) (r = +e(t[i], i, t)) && (a += r);
  return a;
}
function Dt(t) {
...
function yt({ nodes: t }) {
  for (const e of t) {
    let s = e.y0,
      i = s;
    for (const r of e.sourceLinks) (r.y0 = s + r.width / 2), (s += r.width);
    for (const r of e.targetLinks) (r.y1 = i + r.width / 2), (i += r.width);
  }
}
function Vt() {
  let t = 0,
  ...
  (w.update = function (n) {
    ...
    (w.nodeId = function (n) {
      return arguments.length
        ? ((_ = typeof n == 'function' ? n : q(n)), w)
        : _;
    }),
    (w.nodeAlign = function (n) {
      return arguments.length
        ? ((o = typeof n == 'function' ? n : q(n)), w)
        : o;
    }),
    ...
    (w.nodes = function (n) {
      return arguments.length
        ? ((x = typeof n == 'function' ? n : q(n)), w)
        : x;
    }),
    (w.links = function (n) {
      return arguments.length
        ? ((v = typeof n == 'function' ? n : q(n)), w)
        : v;
    }),
    ...
    (w.extent = function (n) {
      return arguments.length
        ? ((t = +n[0][0]), (s = +n[1][0]), (e = +n[0][1]), (i = +n[1][1]), w)
        : [
            [t, e],
            [s, i],
          ];
  ...
  function M({ nodes: n, links: y }) {
    ...
    for (const [h, l] of y.entries()) {
      ...
      typeof k != 'object' && (k = l.source = ft(f, k)),
        typeof b != 'object' && (b = l.target = ft(f, b)),
        k.sourceLinks.push(l),
        b.targetLinks.push(l);
    }
    if (u != null)
      for (const { sourceLinks: h, targetLinks: l } of n) h.sort(u), l.sort(u);
  }
  function T({ nodes: n }) {
    for (const y of n)
      y.value =
        y.fixedValue === void 0
          ? Math.max(nt(y.sourceLinks, it), nt(y.targetLinks, it))
          : y.fixedValue;
  }
  function N({ nodes: n }) {
    const y = n.length;
    ...
    for (; f.size; ) {
      for (const k of f) {
        k.depth = l;
        for (const { target: b } of k.sourceLinks) h.add(b);
      }
  ...
  function C({ nodes: n }) {
    ...
    for (; f.size; ) {
      for (const k of f) {
        k.height = l;
        for (const { source: b } of k.targetLinks) h.add(b);
      }
      if (++l > y) throw new Error('circular link');
      (f = h), (h = new Set());
    }
  ...
  function $({ nodes: n }) {
    const y = ct(n, (l) => l.depth) + 1,
      f = (s - t - r) / (y - 1),
      h = new Array(y);
    for (const l of n) {
      const k = Math.max(0, Math.min(y - 1, Math.floor(o.call(null, l, y))));
      (l.layer = k),
        (l.x0 = t + k * f),
        (l.x1 = l.x0 + r),
        h[k] ? h[k].push(l) : (h[k] = [l]);
    }
    if (c) for (const l of h) l.sort(c);
    return h;
  }
  function R(n) {
    const y = mt(n, (f) => (i - e - (f.length - 1) * m) / nt(f, it));
    for (const f of n) {
      let h = e;
      for (const l of f) {
        (l.y0 = h), (l.y1 = h + l.value * y), (h = l.y1 + m);
        for (const k of l.sourceLinks) k.width = k.value * y;
      }
      h = (i - h + m) / (f.length + 1);
  ...
  function S(n) {
    const y = $(n);
    (m = Math.min(a, (i - e) / (ct(y, (f) => f.length) - 1))), R(y);
    for (let f = 0; f < g; ++f) {
      const h = Math.pow(0.99, f),
        l = Math.max(1 - h, (f + 1) / g);
      B(y, h, l), P(y, h, l);
    }
  }
  function P(n, y, f) {
  ...
  function E({ sourceLinks: n, targetLinks: y }) {
    if (u === void 0) {
      for (const {
        source: { sourceLinks: f },
      } of y)
        f.sort(ht);
      for (const {
        target: { targetLinks: f },
      } of n)
        f.sort(ut);
    }
  }
...
ot.prototype = _t.prototype = {
  ...
  quadraticCurveTo: function (t, e, s, i) {
    this._ +=
      'Q' + +t + ',' + +e + ',' + (this._x1 = +s) + ',' + (this._y1 = +i);
  },
  bezierCurveTo: function (t, e, s, i, r, a) {
    this._ +=
      'C' +
      +t +
      ',' +
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(u * _ - o * c) > V) || !r)
        ...
        var v = s - a,
          ...
          T = Math.sqrt(w),
          N = Math.sqrt(x),
          C = r * Math.tan((rt - Math.acos((w + x - M) / (2 * T * N))) / 2),
          $ = C / N,
          R = C / T;
        Math.abs($ - 1) > V &&
          (this._ += 'L' + (t + $ * c) + ',' + (e + $ * u)),
  ...
  arc: function (t, e, s, i, r, a) {
    ...
    this._x1 === null
      ? (this._ += 'M' + o + ',' + c)
      : (Math.abs(this._x1 - o) > V || Math.abs(this._y1 - c) > V) &&
        (this._ += 'L' + o + ',' + c),
      s &&
        (x < 0 && (x = (x % st) + st),
        x > Wt
          ...
          : x > V &&
            (this._ +=
              ...
              u +
              ',' +
              (this._x1 = t + s * Math.cos(r)) +
              ',' +
              (this._y1 = e + s * Math.sin(r))));
  },
...
function qt(t) {
  ...
  function m() {
    ...
    if (
      ...
      t(
        a,
        +i.apply(this, ((o[0] = c), o)),
        +r.apply(this, o),
        +i.apply(this, ((o[0] = u), o)),
        +r.apply(this, o),
      ),
      _)
    )
      return (a = null), _ + '' || null;
  }
  return (
    (m.source = function (_) {
    ...
    (m.x = function (_) {
      return arguments.length
        ? ((i = typeof _ == 'function' ? _ : gt(+_)), m)
        : i;
    }),
    (m.y = function (_) {
      return arguments.length
        ? ((r = typeof _ == 'function' ? _ : gt(+_)), m)
        : r;
    }),
...
var at = (function () {
  var t = p(function (_, o, c, u) {
      for (c = c || {}, u = _.length; u--; c[_[u]] = o);
      return c;
    }, 'o'),
    e = [1, 9],
    s = [1, 10],
    ...
    r = {
      ...
      performAction: p(function (o, c, u, x, v, g, w) {
        var M = g.length - 1;
        switch (v) {
          case 7:
            const T = x.findOrCreateNode(g[M - 4].trim().replaceAll('""', '"')),
              N = x.findOrCreateNode(g[M - 2].trim().replaceAll('""', '"')),
              C = parseFloat(g[M].trim());
            x.addLink(T, N, C);
            break;
          case 8:
          case 9:
      ...
      table: [
        ...
        { 1: [3] },
        { 5: [1, 3] },
        { 6: 4, 8: 5, 15: 6, 16: 7, 17: 8, 18: e, 20: s },
        { 1: [2, 6], 7: 11, 10: [1, 12] },
        t(s, [2, 4], { 9: 13, 5: [1, 14] }),
        { 12: [1, 15] },
        t(i, [2, 8]),
        ...
        { 1: [2, 5] },
        t(s, [2, 2]),
        { 6: 17, 8: 5, 15: 6, 16: 7, 17: 8, 18: e, 20: s },
        { 15: 18, 16: 7, 17: 8, 18: e, 20: s },
        { 18: [1, 19] },
        t(s, [2, 3]),
        { 12: [1, 20] },
        t(i, [2, 10]),
        { 15: 21, 16: 7, 17: 8, 18: e, 20: s },
        t([1, 5, 10], [2, 7]),
      ],
      defaultActions: { 11: [2, 1], 12: [2, 5] },
      parseError: p(function (o, c) {
          ...
          switch (I[0]) {
            ...
            case 2:
              ...
              h &&
                ...
                (v = v.slice(0, -1 * h)),
                (g = g.slice(0, -1 * h))),
                u.push(this.productions_[I[1]][0]),
                v.push(y.$),
                g.push(y._$),
                (l = w[u[u.length - 2]][u[u.length - 1]]),
                u.push(l);
              break;
            case 3:
              return !0;
      ...
      var _ = {
        ...
        unput: p(function (o) {
          ...
          return (
            ...
            this.options.ranges &&
              (this.yylloc.range = [v[0], v[0] + this.yyleng - c]),
...
` +
        ...
        next: p(function () {
          ...
          for (var v = this._currentRules(), g = 0; g < v.length; g++)
            if (
              ((u = this._input.match(this.rules[v[g]])),
              u && (!c || u[0].length > c[0].length))
            ) {
              if (((c = u), (x = g), this.options.backtrack_lexer)) {
                if (((o = this.test_match(u, v[g])), o !== !1)) return o;
                if (this._backtrack) {
                  c = !1;
                  continue;
                } else return !1;
          ...
          return c
            ? ((o = this.test_match(c, v[x])), o !== !1 ? o : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: p(function (c, u, x, v) {
          switch (x) {
            case 0:
  ...
  return p(m, 'Parser'), (m.prototype = r), (r.Parser = m), new m();
})();
at.parser = at;
var K = at,
  J = [],
  ...
  dt =
    ...
    (j.count = 0),
    j),
  ue = { left: $t, right: zt, center: jt, justify: kt },
  he = p(function (t, e, s, i) {
    const { securityLevel: r, sankey: a } = lt(),
      m = Tt.sankey;
    let _;
    r === 'sandbox' && (_ = X('#i' + e));
    const o =
        r === 'sandbox' ? X(_.nodes()[0].contentDocument.body) : X('body'),
      c = r === 'sandbox' ? o.select(`[id="${e}"]`) : X(`[id="${e}"]`),
      u = (a == null ? void 0 : a.width) ?? m.width,
      x = (a == null ? void 0 : a.height) ?? m.width,
      v = (a == null ? void 0 : a.useMaxWidth) ?? m.useMaxWidth,
      g = (a == null ? void 0 : a.nodeAlignment) ?? m.nodeAlignment,
      w = (a == null ? void 0 : a.prefix) ?? m.prefix,
      M = (a == null ? void 0 : a.suffix) ?? m.suffix,
      T = (a == null ? void 0 : a.showValues) ?? m.showValues,
      N = i.db.getGraph(),
      C = ue[g];
    Vt()
      .nodeId((d) => d.id)
    ...
    c.append('g')
      ...
      .join('g')
      .attr('class', 'node')
      .attr('id', (d) => (d.uid = dt.next('node-')).id)
...
${w}${Math.round(E * 100) / 100}${M}`
    ...
    c.append('g')
      ...
      .data(N.nodes)
      .join('text')
      .attr('x', (d) => (d.x0 < u / 2 ? d.x1 + 6 : d.x0 - 6))
      .attr('y', (d) => (d.y1 + d.y0) / 2)
      .attr('dy', `${T ? '0' : '0.35'}em`)
      .attr('text-anchor', (d) => (d.x0 < u / 2 ? 'start' : 'end'))
      .text(P);
    const B = c
        .append('g')
        .attr('class', 'links')
      ...
      O = (a == null ? void 0 : a.linkColor) ?? 'gradient';
    if (O === 'gradient') {
      const d = B.append('linearGradient')
        .attr('id', (E) => (E.uid = dt.next('linearGradient-')).id)
    ...
    switch (O) {
      case 'gradient':
        D = p((d) => d.uid, 'coloring');
        break;
      case 'source':
        D = p((d) => S(d.source.id), 'coloring');
        break;
      case 'target':
        D = p((d) => S(d.target.id), 'coloring');
        break;
      default:
        D = O;
    }
...
`,
  ...
  pe = K.parse.bind(K);
K.parse = (t) => pe(ye(t));
var Le = { styles: de, parser: K, db: ce, renderer: fe };
