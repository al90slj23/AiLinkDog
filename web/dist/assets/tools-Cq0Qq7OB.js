...
var Qt = (r, e, n) =>
  e in r
    ? Kt(r, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
    : (r[e] = n);
var Ve = (r, e, n) => Qt(r, typeof e != 'symbol' ? e + '' : e, n);
import { _ as Je } from './semi-ui-St01U-q0.js';
var ee;
(function (r) {
...
function es(r) {
  ...
  var e = r,
    n = e.window,
    t = n === void 0 ? document.defaultView : n,
    s = t.history;
  function i() {
    var k = t.location,
      _ = k.pathname,
  ...
  var u = ee.Pop,
    ...
    w = Qe(),
    d = Qe();
  c == null && ((c = 0), s.replaceState(Je({}, s.state, { idx: c }), ''));
  function p(k) {
    return typeof k == 'string' ? k : Yt(k);
  }
  function m(k, _) {
    return (
      _ === void 0 && (_ = null),
  ...
  function g(k, _) {
    return [{ usr: k.state, key: k.key, idx: _ }, p(k)];
  }
  function S(k, _, P) {
    return !d.length || (d.call({ action: k, location: _, retry: P }), !1);
  }
  function E(k) {
    u = k;
    var _ = i();
    (c = _[0]), (h = _[1]), w.call({ action: u, location: h });
  }
  function T(k, _) {
    var P = ee.Push,
      F = m(k, _);
  ...
  var C = {
    ...
    block: function (_) {
      var P = d.push(_);
      return (
        d.length === 1 && t.addEventListener(We, Ke),
        function () {
          P(), d.length || t.removeEventListener(We, Ke);
        }
      );
    },
  };
...
function en(r) {
  ...
  if (r) {
    var n = r.indexOf('#');
    n >= 0 && ((e.hash = r.substr(n)), (r = r.substr(0, n)));
    var t = r.indexOf('?');
    t >= 0 && ((e.search = r.substr(t)), (r = r.substr(0, t))),
      r && (e.pathname = r);
  }
  return e;
}
...
const { toString: tn } = Object.prototype,
  ...
  { iterator: ke, toStringTag: yt } = Symbol,
  xe = ((r) => (e) => {
    const n = tn.call(e);
    return r[n] || (r[n] = n.slice(8, -1).toLowerCase());
  })(Object.create(null)),
  M = (r) => ((r = r.toLowerCase()), (e) => xe(e) === r),
  ye = (r) => (e) => typeof e === r,
  { isArray: ne } = Array,
  te = ye('undefined');
function se(r) {
  return (
    ...
    r.constructor !== null &&
    !te(r.constructor) &&
    I(r.constructor.isBuffer) &&
    r.constructor.isBuffer(r)
  );
}
const Rt = M('ArrayBuffer');
function nn(r) {
  let e;
  return (
    typeof ArrayBuffer < 'u' && ArrayBuffer.isView
      ? (e = ArrayBuffer.isView(r))
      : (e = r && r.buffer && Rt(r.buffer)),
    e
  );
}
const rn = ye('string'),
  I = ye('function'),
  St = ye('number'),
  ie = (r) => r !== null && typeof r == 'object',
  sn = (r) => r === !0 || r === !1,
  he = (r) => {
    if (xe(r) !== 'object') return !1;
    const e = Le(r);
    return (
      (e === null ||
        e === Object.prototype ||
  ...
  an = M('Date'),
  ln = M('File'),
  cn = (r) => !!(r && typeof r.uri < 'u'),
  un = (r) => r && typeof r.getParts < 'u',
  fn = M('Blob'),
  hn = M('FileList'),
  pn = (r) => ie(r) && I(r.pipe);
function dn() {
...
const Xe = dn(),
  Ge = typeof Xe.FormData < 'u' ? Xe.FormData : void 0,
  gn = (r) => {
    let e;
    return (
      r &&
  ...
  mn = M('URLSearchParams'),
  [bn, wn, kn, xn] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(
    M,
  ),
  yn = (r) =>
    r.trim ? r.trim() : r.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, '');
function oe(r, e, { allOwnKeys: n = !1 } = {}) {
  if (r === null || typeof r > 'u') return;
  let t, s;
  if ((typeof r != 'object' && (r = [r]), ne(r)))
    for (t = 0, s = r.length; t < s; t++) e.call(null, r[t], t, r);
  else {
    if (se(r)) return;
    const i = n ? Object.getOwnPropertyNames(r) : Object.keys(r),
      o = i.length;
    let a;
    for (t = 0; t < o; t++) (a = i[t]), e.call(null, r[a], a, r);
  }
}
function Et(r, e) {
  if (se(r)) return null;
  ...
  let t = n.length,
    s;
  for (; t-- > 0; ) if (((s = n[t]), e === s.toLowerCase())) return s;
  return null;
}
const K =
    typeof globalThis < 'u'
  ...
  _t = (r) => !te(r) && r !== K;
function Ce() {
  const { caseless: r, skipUndefined: e } = (_t(this) && this) || {},
    n = {},
    t = (s, i) => {
  ...
  for (let s = 0, i = arguments.length; s < i; s++)
    arguments[s] && oe(arguments[s], t);
  return n;
}
const Rn = (r, e, n, { allOwnKeys: t } = {}) => (
    oe(
      e,
      (s, i) => {
        n && I(s)
  ...
  Sn = (r) => (r.charCodeAt(0) === 65279 && (r = r.slice(1)), r),
  En = (r, e, n, t) => {
  ...
  _n = (r, e, n, t) => {
    ...
    do {
      for (s = Object.getOwnPropertyNames(r), i = s.length; i-- > 0; )
        (o = s[i]), (!t || t(o, r, e)) && !a[o] && ((e[o] = r[o]), (a[o] = !0));
      r = n !== !1 && Le(r);
  ...
  Tn = (r, e, n) => {
    (r = String(r)),
      (n === void 0 || n > r.length) && (n = r.length),
      (n -= e.length);
    const t = r.indexOf(e, n);
    return t !== -1 && t === n;
  },
  An = (r) => {
    if (!r) return null;
  ...
  Cn = (r, e) => {
    let n;
    const t = [];
    for (; (n = r.exec(e)) !== null; ) t.push(n);
    return t;
  },
  Pn = M('HTMLFormElement'),
  zn = (r) =>
    r.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function (n, t, s) {
  ...
  Ln = (r) => {
    Tt(r, (e, n) => {
      if (I(r) && ['arguments', 'caller', 'callee'].indexOf(n) !== -1)
        return !1;
      const t = r[n];
      if (I(t)) {
  ...
  Un = (r, e) => {
    ...
    return ne(r) ? t(r) : t(String(r).split(e)), n;
  },
  Bn = () => {},
  In = (r, e) => (r != null && Number.isFinite((r = +r)) ? r : e);
function Dn(r) {
  return !!(r && I(r.append) && r[yt] === 'FormData' && r[ke]);
}
const Fn = (r) => {
  ...
  qn = M('AsyncFunction'),
  jn = (r) => r && (ie(r) || I(r)) && I(r.then) && I(r.catch),
  At = ((r, e) =>
    r
      ? setImmediate
      : e
        ? ((n, t) => (
            K.addEventListener(
              'message',
              ({ source: s, data: i }) => {
                s === K && i === n && t.length && t.shift()();
              },
              !1,
            ),
            (s) => {
              t.push(s), K.postMessage(n, '*');
            }
          ))(`axios@${Math.random()}`, [])
        : (n) => setTimeout(n))(
  ...
  vn =
    typeof queueMicrotask < 'u'
      ...
      : (typeof process < 'u' && process.nextTick) || At,
  Mn = (r) => r != null && I(r[ke]),
  l = {
    isArray: ne,
    isArrayBuffer: Rt,
...
class R extends Error {
  static from(e, n, t, s, i, o) {
    const a = new R(e.message, n || e.code, t, s, i);
    return (
      (a.cause = e),
      (a.name = e.name),
      e.status != null && a.status == null && (a.status = e.status),
      o && Object.assign(a, o),
      a
    );
  }
...
function Vn(r) {
  return l.isArray(r) && !r.some(Pe);
}
const Jn = l.toFlatObject(l, {}, null, function (e) {
...
function Re(r, e, n) {
  ...
  function f(p) {
    ...
    if (l.isBoolean(p)) return p.toString();
    if (!u && l.isBlob(p))
  ...
  function c(p, m, g) {
    ...
    if (l.isReactNative(e) && l.isReactNativeBlob(p))
      return e.append(Te(g, m, i), f(p)), !1;
    if (p && !g && typeof p == 'object') {
      if (l.endsWith(m, '{}'))
        (m = t ? m : m.slice(0, -2)), (p = JSON.stringify(p));
      else if (
        (l.isArray(p) && Vn(p)) ||
        ((l.isFileList(p) || l.endsWith(m, '[]')) && (S = l.toArray(p)))
      )
        return (
          (m = Ot(m)),
    ...
    return Pe(p) ? !0 : (e.append(Te(g, m, i), f(p)), !1);
  }
  const h = [],
    w = Object.assign(Jn, {
      defaultVisitor: c,
  ...
  function d(p, m) {
    if (!l.isUndefined(p)) {
      ...
      h.push(p),
        l.forEach(p, function (S, E) {
          (!(l.isUndefined(S) || S === null) &&
            s.call(e, S, l.isString(E) ? E.trim() : E, m, w)) === !0 &&
            d(S, m ? m.concat(E) : [E]);
        }),
        h.pop();
    }
...
function Ct(r, e, n) {
  if (!e) return r;
  const t = (n && n.encode) || Zn,
    s = l.isFunction(n) ? { serialize: n } : n,
    i = s && s.serialize;
  let o;
  if (
    (i
      ? (o = i(e, s))
      : (o = l.isURLSearchParams(e) ? e.toString() : new Ue(e, s).toString(t)),
    o)
  ) {
    const a = r.indexOf('#');
    a !== -1 && (r = r.slice(0, a)),
...
const Be = {
  ...
  Wn = typeof URLSearchParams < 'u' ? URLSearchParams : Ue,
  Kn = typeof FormData < 'u' ? FormData : null,
  Qn = typeof Blob < 'u' ? Blob : null,
  Xn = {
    isBrowser: !0,
    classes: { URLSearchParams: Wn, FormData: Kn, Blob: Qn },
  ...
  Gn =
    Ie &&
    (!ze || ['ReactNative', 'NativeScript', 'NS'].indexOf(ze.product) < 0),
  Yn =
    typeof WorkerGlobalScope < 'u' &&
    self instanceof WorkerGlobalScope &&
    typeof self.importScripts == 'function',
  er = (Ie && window.location.href) || 'http://localhost',
  tr = Object.freeze(
  ...
  L = { ...tr, ...Xn };
function nr(r, e) {
  return Re(r, new L.classes.URLSearchParams(), {
    visitor: function (n, t, s, i) {
      return L.isNode && l.isBuffer(n)
...
function Pt(r) {
  function e(n, t, s, i) {
    ...
    const a = Number.isFinite(+o),
      u = i >= n.length;
    return (
      (o = !o && l.isArray(s) ? s.length : o),
      u
        ? (l.hasOwnProp(s, o) ? (s[o] = [s[o], t]) : (s[o] = t), !a)
        : ((!s[o] || !l.isObject(s[o])) && (s[o] = []),
          e(n, t, s[o], i) && l.isArray(s[o]) && (s[o] = sr(s[o])),
          !a)
    );
  }
  ...
  transformRequest: [
    function (e, n) {
      const t = n.getContentType() || '',
        s = t.indexOf('application/json') > -1,
        i = l.isObject(e);
      ...
      if (i) {
        ...
        if ((a = l.isFileList(e)) || t.indexOf('multipart/form-data') > -1) {
      ...
      return i || s ? (n.setContentType('application/json', !1), ir(e)) : e;
    },
  ],
  transformResponse: [
    function (e) {
      ...
      if (e && l.isString(e) && ((t && !this.responseType) || s)) {
...
function cr(r) {
  ...
  return e === r.length ? r : r.slice(0, e);
}
function pe(r) {
  return r === !1 || r == null ? r : l.isArray(r) ? r.map(pe) : cr(String(r));
}
function ur(r) {
  const e = Object.create(null),
    n = /([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;
  let t;
  for (; (t = n.exec(r)); ) e[t[1]] = t[2];
  return e;
}
const fr = (r) => /^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(r.trim());
  ...
  ['get', 'set', 'has'].forEach((t) => {
    Object.defineProperty(r, t + n, {
      value: function (s, i, o) {
        return this[t].call(this, e, s, i, o);
      },
      configurable: !0,
    });
  });
...
class D {
  ...
  set(e, n, t) {
    ...
    const o = (a, u) => l.forEach(a, (f, c) => i(f, c, u));
    if (l.isPlainObject(e) || e instanceof this.constructor) o(e, n);
    else if (l.isString(e) && (e = e.trim()) && !fr(e)) o(ar(e), n);
  ...
  get(e, n) {
    if (((e = re(e)), e)) {
      const t = l.findKey(this, e);
      if (t) {
        const s = this[t];
        if (!n) return s;
        if (n === !0) return ur(s);
        if (l.isFunction(n)) return n.call(this, s, t);
  ...
  has(e, n) {
    if (((e = re(e)), e)) {
      const t = l.findKey(this, e);
      return !!(t && this[t] !== void 0 && (!n || Ae(this, this[t], t, n)));
    }
    return !1;
  }
  delete(e, n) {
    ...
    function i(o) {
      if (((o = re(o)), o)) {
        const a = l.findKey(t, o);
        a && (!n || Ae(t, t[a], a, n)) && (delete t[a], (s = !0));
      }
    }
  ...
  normalize(e) {
    ...
    return (
      l.forEach(this, (s, i) => {
        const o = l.findKey(t, i);
        if (o) {
          (n[o] = pe(s)), delete n[i];
          return;
        }
        const a = e ? hr(i) : String(i).trim();
        a !== i && delete n[i], (n[a] = pe(s)), (t[a] = !0);
      }),
      this
    );
  }
  ...
  toJSON(e) {
    ...
    return (
      l.forEach(this, (t, s) => {
        t != null && t !== !1 && (n[s] = e && l.isArray(t) ? t.join(', ') : t);
      }),
      n
    );
  }
...
l.reduceDescriptors(D.prototype, ({ value: r }, e) => {
...
class le extends R {
  constructor(e, n, t) {
    super(e ?? 'canceled', R.ERR_CANCELED, n, t),
  ...
  return (
    ...
    function (u) {
      ...
      let h = i,
        w = 0;
      for (; h !== s; ) (w += n[h++]), (h = h % r);
      if (((s = (s + 1) % r), s === i && (i = (i + 1) % r), f - o < e)) return;
      const d = c && f - c;
...
function mr(r, e) {
  ...
  const o = (f, c = Date.now()) => {
    (n = c), (s = null), i && (clearTimeout(i), (i = null)), r(...f);
  };
  return [
    (...f) => {
      const c = Date.now(),
...
const me = (r, e, n = 3) => {
  ...
  rt = (r, e) => {
    const n = r != null;
    return [(t) => e[0]({ lengthComputable: n, total: r, loaded: t }), e[1]];
  },
  st =
    (r) =>
    (...e) =>
      l.asap(() => r(...e)),
  br = L.hasStandardBrowserEnv
    ? ((r, e) => (n) => (
    ...
    : () => !0,
  wr = L.hasStandardBrowserEnv
    ? {
        write(r, e, n, t, s, i, o) {
          if (typeof document > 'u') return;
          const a = [`${r}=${encodeURIComponent(e)}`];
          l.isNumber(n) && a.push(`expires=${new Date(n).toUTCString()}`),
            l.isString(t) && a.push(`path=${t}`),
            l.isString(s) && a.push(`domain=${s}`),
            i === !0 && a.push('secure'),
            l.isString(o) && a.push(`SameSite=${o}`),
...
function Ut(r, e, n) {
  let t = !kr(e);
  return r && (t || n == !1) ? xr(r, e) : e;
}
const it = (r) => (r instanceof D ? { ...r } : r);
function X(r, e) {
  e = e || {};
  const n = {};
  function t(f, c, h, w) {
    return l.isPlainObject(f) && l.isPlainObject(c)
      ? l.merge.call({ caseless: w }, f, c)
      : l.isPlainObject(c)
        ? l.merge({}, c)
        : l.isArray(c)
          ? c.slice()
  ...
  function s(f, c, h, w) {
    if (l.isUndefined(c)) {
      if (!l.isUndefined(f)) return t(void 0, f, h, w);
    } else return t(f, c, h, w);
  }
  function i(f, c) {
  ...
  function a(f, c, h) {
    if (h in e) return t(f, c);
    if (h in r) return t(void 0, f);
  }
  const u = {
    url: i,
    method: i,
    ...
    responseEncoding: o,
    validateStatus: a,
    headers: (f, c, h) => s(it(f), it(c), h, !0),
  };
  return (
    l.forEach(Object.keys({ ...r, ...e }), function (c) {
      if (c === '__proto__' || c === 'constructor' || c === 'prototype') return;
      const h = l.hasOwnProp(u, c) ? u[c] : s,
        w = h(r[c], e[c], c);
...
const Bt = (r) => {
    ...
    if (
      ...
      (t && l.isFunction(t) && (t = t(e)), t || (t !== !1 && br(e.url)))
    ) {
      const u = s && i && wr.read(i);
      u && o.set(s, u);
    }
    return e;
  },
  ...
  Rr =
    ...
    function (r) {
      return new Promise(function (n, t) {
        ...
        let { responseType: a, onUploadProgress: u, onDownloadProgress: f } = s,
          c,
          h,
          w,
          d,
        ...
        'onloadend' in g
          ...
          (g.onabort = function () {
            g &&
              (t(new R('Request aborted', R.ECONNABORTED, r, g)), (g = null));
          }),
          (g.onerror = function (O) {
            const A = O && O.message ? O.message : 'Network Error',
              C = new R(A, R.ERR_NETWORK, r, g);
            (C.event = O || null), t(C), (g = null);
          }),
          (g.ontimeout = function () {
            let O = s.timeout
              ? 'timeout of ' + s.timeout + 'ms exceeded'
              : 'timeout exceeded';
            const A = s.transitional || Be;
            s.timeoutErrorMessage && (O = s.timeoutErrorMessage),
              t(
                new R(
                  O,
                  A.clarifyTimeoutError ? R.ETIMEDOUT : R.ECONNABORTED,
                  r,
                  g,
                ),
              ),
        ...
        if (E && L.protocols.indexOf(E) === -1) {
          t(new R('Unsupported protocol ' + E + ':', R.ERR_BAD_REQUEST, r));
          return;
        }
        g.send(i || null);
      });
    ...
    if (e || n) {
      ...
      const i = function (f) {
        if (!s) {
          ...
          t.abort(
            c instanceof R ? c : new le(c instanceof Error ? c.message : c),
          );
        }
      };
      let o =
        e &&
        setTimeout(() => {
          (o = null), i(new R(`timeout of ${e}ms exceeded`, R.ETIMEDOUT));
        }, e);
      const a = () => {
        r &&
          (o && clearTimeout(o),
  ...
  Er = function* (r, e) {
    ...
    let t = 0,
      s;
    for (; t < n; ) (s = t + e), yield r.slice(t, s), (t = s);
  },
  _r = async function* (r, e) {
    for await (const n of Tr(r)) yield* Er(n, e);
  },
  Tr = async function* (r) {
  ...
  at = 64 * 1024,
  { isFunction: ue } = l,
  Ar = (({ Request: r, Response: e }) => ({ Request: r, Response: e }))(
    l.global,
  ),
  { ReadableStream: lt, TextEncoder: ct } = l.global,
  ut = (r, ...e) => {
    try {
      return !!r(...e);
    } catch {
  ...
  Or = (r) => {
    r = l.merge.call({ skipUndefined: !0 }, Ar, r);
    const { fetch: e, Request: n, Response: t } = r,
      s = e ? ue(e) : typeof fetch == 'function',
      i = ue(n),
      o = ue(t);
    if (!s) return !1;
    const a = s && ue(lt),
      ...
      c = o && a && ut(() => l.isReadableStream(new t('').body)),
      h = { stream: c && ((p) => p.body) };
    s &&
    ...
    const w = async (p) => {
        if (p == null) return 0;
        if (l.isBlob(p)) return p.size;
        if (l.isSpecCompliantForm(p))
          return (
            await new n(L.origin, { method: 'POST', body: p }).arrayBuffer()
          ).byteLength;
        if (l.isArrayBufferView(p) || l.isArrayBuffer(p)) return p.byteLength;
    ...
    return async (p) => {
      ...
      let v = Sr([E, T && T.toAbortSignal()], O),
        H = null;
      const q =
        v &&
        v.unsubscribe &&
      ...
      try {
        if (
          ...
          let J = new n(m, { method: 'POST', body: S, duplex: 'half' }),
            Y;
          if (
            (l.isFormData(S) &&
            ...
            const [_e, ce] = rt(Ee, me(st(C)));
            S = ot(J.body, at, _e, ce);
          }
        }
        ...
        H = i && new n(m, ve);
        let V = await (i ? U(H, F) : U(m, ve));
        const Me = c && (k === 'stream' || k === 'response');
        if (c && (A || (Me && q))) {
          const J = {};
          ['status', 'statusText', 'headers'].forEach((He) => {
            J[He] = V[He];
          });
          const Y = l.toFiniteNumber(V.headers.get('content-length')),
            [_e, ce] = (A && rt(Y, me(st(A), !0))) || [];
          V = new t(
            ot(V.body, at, _e, () => {
              ce && ce(), q && q();
            }),
        ...
        k = k || 'text';
        let Wt = await h[l.findKey(h, k) || 'text'](V, p);
        return (
          !Me && q && q(),
          await new Promise((J, Y) => {
            Lt(J, Y, {
              data: Wt,
        ...
        throw (
          ...
          B && B.name === 'TypeError' && /Load failed|fetch/i.test(B.message)
            ? Object.assign(
                new R('Network Error', R.ERR_NETWORK, p, H, B && B.response),
                { cause: B.cause || B },
              )
            : R.from(B, B && B.code, p, H, B && B.response))
        );
      }
    };
  },
  ...
  It = (r) => {
    let e = (r && r.env) || {};
    const { fetch: n, Request: t, Response: s } = e,
      i = [t, s, n];
    let o = i.length,
      a = o,
      u,
    ...
    for (; a--; )
      (u = i[a]),
        (f = c.get(u)),
        f === void 0 && c.set(u, (f = a ? new Map() : Or(e))),
        (c = f);
    return f;
  };
It();
const De = { http: Hn, xhr: Rr, fetch: { get: It } };
l.forEach(De, (r, e) => {
  if (r) {
    try {
...
const ft = (r) => `- ${r}`,
  Cr = (r) => l.isFunction(r) || r === null || r === !1;
function Pr(r, e) {
  r = l.isArray(r) ? r : [r];
  const { length: n } = r;
  let t, s;
  ...
  for (let o = 0; o < n; o++) {
    ...
    if (
      ((s = t),
      !Cr(t) && ((s = De[(a = String(t)).toLowerCase()]), s === void 0))
    )
...
const Dt = { getAdapter: Pr, adapters: De };
function $e(r) {
  if (
...
function ht(r) {
  return (
    ...
    (r.data = Oe.call(r, r.transformRequest)),
    ['post', 'put', 'patch'].indexOf(r.method) !== -1 &&
      r.headers.setContentType('application/x-www-form-urlencoded', !1),
    Dt.getAdapter(
      r.adapter || ae.adapter,
      r,
    )(r).then(
      function (t) {
        return (
          $e(r),
          (t.data = Oe.call(r, r.transformResponse, t)),
      ...
      function (t) {
        return (
          Nt(t) ||
            ...
            t &&
              t.response &&
              ((t.response.data = Oe.call(r, r.transformResponse, t.response)),
              (t.response.headers = D.from(t.response.headers)))),
          Promise.reject(t)
        );
      },
    )
...
['object', 'boolean', 'number', 'function', 'string', 'symbol'].forEach(
  (r, e) => {
    Se[r] = function (t) {
      return typeof t === r || 'a' + (e < 1 ? 'n ' : ' ') + r;
    };
  },
);
const pt = {};
Se.transitional = function (e, n, t) {
  function s(i, o) {
    return (
      '[Axios v' +
      Ft +
...
const de = { assertOptions: zr, validators: Se },
  j = de.validators;
class Q {
  constructor(e) {
    (this.defaults = e || {}),
...
` + i);
  ...
  _request(e, n) {
    typeof e == 'string' ? ((n = n || {}), (n.url = e)) : (n = e || {}),
      (n = X(this.defaults, n));
    const { transitional: t, paramsSerializer: s, headers: i } = n;
    t !== void 0 &&
      de.assertOptions(
        t,
        {
    ...
    this.interceptors.request.forEach(function (m) {
      ...
      (u = u && m.synchronous),
        (n.transitional || Be).legacyInterceptorReqResOrdering
    ...
    if (!u) {
      ...
      for (
        p.unshift(...a), p.push(...f), w = p.length, c = Promise.resolve(n);
        h < w;
    ...
    for (h = 0, w = f.length; h < w; ) c = c.then(f[h++], f[h++]);
    return c;
  }
  getUri(e) {
    e = X(this.defaults, e);
...
l.forEach(['delete', 'get', 'head', 'options'], function (e) {
  Q.prototype[e] = function (n, t) {
    return this.request(
      X(t || {}, { method: e, url: n, data: (t || {}).data }),
    );
  };
});
...
class Fe {
  constructor(e) {
    ...
    this.promise.then((s) => {
      ...
      e(function (i, o, a) {
        t.reason || ((t.reason = new le(i, o, a)), n(t.reason));
      });
  }
  throwIfRequested() {
...
function qt(r) {
  const e = new Q(r),
    n = xt(Q.prototype.request, e);
  return (
    l.extend(n, Q.prototype, e, { allOwnKeys: !0 }),
...
z.mergeConfig = X;
z.AxiosHeaders = D;
z.formToJSON = (r) => Pt(l.isHTMLForm(r) ? new FormData(r) : r);
z.getAdapter = Dt.getAdapter;
z.HttpStatusCode = Ne;
z.default = z;
function jt() {
  return {
...
const vt = /[&<>"']/,
  Br = new RegExp(vt.source, 'g'),
  Mt = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,
  Ir = new RegExp(Mt.source, 'g'),
  Dr = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' },
  dt = (r) => Dr[r];
function N(r, e) {
  if (e) {
    if (vt.test(r)) return r.replace(Br, dt);
  } else if (Mt.test(r)) return r.replace(Ir, dt);
  return r;
}
const Fr = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;
function Ht(r) {
  return r.replace(
    Fr,
    (e, n) => (
...
function $(r, e) {
  ...
  const n = {
    replace: (t, s) => (
      (s = s.source || s), (s = s.replace(qr, '$1')), (r = r.replace(t, s)), n
    ),
...
function gt(r, e, n) {
  if (r) {
    let t;
    try {
      t = decodeURIComponent(Ht(n)).replace(jr, '').toLowerCase();
    } catch {
      return null;
    }
    if (
...
const be = { exec: function () {} };
function mt(r, e) {
  const n = r.replace(/\|/g, (i, o, a) => {
      let u = !1,
        f = o;
      for (; --f >= 0 && a[f] === '\\'; ) u = !u;
      return u ? '|' : ' |';
...
function bt(r, e) {
  if (e < 1) return '';
  let n = '';
  for (; e > 1; ) e & 1 && (n += r), (e >>= 1), (r += r);
  return n + r;
}
function wt(r, e, n, t) {
  const s = e.href,
    i = e.title ? N(e.title) : null,
    o = r[1].replace(/\\([\[\]])/g, '$1');
  if (r[0].charAt(0) !== '!') {
    t.state.inLink = !0;
    const a = {
  ...
  return { type: 'image', raw: n, href: s, title: i, text: N(o) };
}
function Kr(r, e) {
  const n = r.match(/^(\s+)(?:```)/);
  if (n === null) return e;
...
`,
    ...
    .map((s) => {
      ...
      if (i === null) return s;
      const [o] = i;
      return o.length >= t.length ? s.slice(t.length) : s;
    }).join(`
`);
}
class qe {
  ...
  blockquote(e) {
    ...
    if (n) {
      ...
      return (
        ...
        { type: 'blockquote', raw: n[0], tokens: i, text: t }
      );
    }
  }
  list(e) {
    ...
    if (n) {
      ...
      const E = new RegExp(`^( {0,3}${m})((?:[	 ][^\\n]*)?(?:\\n|$))`);
      for (
        ;
        e && ((p = !1), !(!(n = E.exec(e)) || this.rules.block.hr.test(e)));
...
`,
            ...
            this.options.pedantic &&
              (h = h.replace(/^ {1,4}(?=( {4})*[^ ])/g, '  ')),
            !(C.test(h) || k.test(h) || O.test(h) || A.test(e)));

          ) {
            if (h.search(/[^ ]/) >= o || !h.trim())
              d +=
                `
` + h.slice(o);
            else {
...
`),
      ...
      (S.items[S.items.length - 1].raw = t.trimRight()),
        (S.items[S.items.length - 1].text = d.trimRight()),
        (S.raw = S.raw.trimRight());
      const T = S.items.length;
      for (a = 0; a < T; a++)
        if (
          ((this.lexer.state.top = !1),
          (S.items[a].tokens = this.lexer.blockTokens(S.items[a].text, [])),
          !S.loose)
        ) {
          const O = S.items[a].tokens.filter((C) => C.type === 'space'),
            A = O.length > 0 && O.some((C) => /\n.*\n/.test(C.raw));
          S.loose = A;
        }
      if (S.loose) for (a = 0; a < T; a++) S.items[a].loose = !0;
      return S;
    }
  }
  html(e) {
    ...
    if (n) {
      ...
      if (this.options.sanitize) {
        const s = this.options.sanitizer
          ...
          : N(n[0]);
        (t.type = 'paragraph'), (t.text = s), (t.tokens = this.lexer.inline(s));
      }
      return t;
    }
  }
      ...
      const t = n[1].toLowerCase().replace(/\s+/g, ' '),
        ...
        i = n[3]
          ? n[3]
              ...
              .replace(this.rules.inline._escapes, '$1')
          : n[3];
      return { type: 'def', tag: t, raw: n[0], href: s, title: i };
    }
  }
  table(e) {
...
`)
      ...
      if (t.header.length === t.align.length) {
        ...
        for (s = t.rows.length, i = 0; i < s; i++)
          t.rows[i] = mt(t.rows[i], t.header.length).map((f) => ({ text: f }));
...
`
  ...
  escape(e) {
    ...
    if (n) return { type: 'escape', raw: n[0], text: N(n[1]) };
  }
  tag(e) {
  ...
  emStrong(e, n, t = '') {
    ...
    if (!i || (i && (t === '' || this.rules.inline.punctuation.exec(t)))) {
      ...
      for (
        h.lastIndex = 0, n = n.slice(-1 * e.length + o);
        (s = h.exec(n)) != null;
        ...
        if (((f -= u), f > 0)) continue;
        u = Math.min(u, u + f + c);
        const w = e.slice(0, o + s.index + (s[0].length - a.length) + u);
        if (Math.min(o, u) % 2) {
          const p = w.slice(1, -1);
          return {
            type: 'em',
  ...
  autolink(e, n) {
    ...
    if (t) {
      ...
      return (
        t[2] === '@'
          ? ((s = N(this.options.mangle ? n(t[1]) : t[1])), (i = 'mailto:' + s))
          : ((s = N(t[1])), (i = s)),
        {
          type: 'link',
          raw: t[0],
  ...
  url(e, n) {
    ...
    if ((t = this.rules.inline.url.exec(e))) {
      let s, i;
      if (t[2] === '@')
        (s = N(this.options.mangle ? n(t[0]) : t[0])), (i = 'mailto:' + s);
      else {
        let o;
        do (o = t[0]), (t[0] = this.rules.inline._backpedal.exec(t[0])[0]);
        while (o !== t[0]);
        (s = N(t[0])), t[1] === 'www.' ? (i = 'http://' + t[0]) : (i = t[0]);
      }
      return {
        type: 'link',
        raw: t[0],
        ...
        this.lexer.state.inRawBlock
          ? (s = this.options.sanitize
              ? this.options.sanitizer
                ...
                : N(t[0])
              : t[0])
          : (s = N(this.options.smartypants ? n(t[0]) : t[0])),
...
x.paragraph = $(x._paragraph)
  ...
  .replace('tag', x._tag)
  .getRegex();
x.blockquote = $(x.blockquote).replace('paragraph', x.paragraph).getRegex();
x.normal = { ...x };
x.gfm = {
  ...x.normal,
  table:
...
b._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~';
b.punctuation = $(b.punctuation)
  .replace(/punctuation/g, b._punctuation)
  .getRegex();
b.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g;
b.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g;
b._comment = $(x._comment).replace('(?:-->|$)', '-->').getRegex();
b.emStrong.lDelim = $(b.emStrong.lDelim)
  .replace(/punct/g, b._punctuation)
  .getRegex();
b.emStrong.rDelimAst = $(b.emStrong.rDelimAst, 'g')
  .replace(/punct/g, b._punctuation)
  .getRegex();
b.emStrong.rDelimUnd = $(b.emStrong.rDelimUnd, 'g')
  .replace(/punct/g, b._punctuation)
  .getRegex();
b._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g;
...
b.reflink = $(b.reflink)
  ...
  .getRegex();
b.nolink = $(b.nolink).replace('ref', x._label).getRegex();
b.reflinkSearch = $(b.reflinkSearch, 'g')
...
class Z {
  constructor(e) {
    (this.tokens = []),
      ...
      (this.options = e || G),
      (this.options.tokenizer = this.options.tokenizer || new qe()),
      (this.tokenizer = this.options.tokenizer),
      (this.tokenizer.options = this.options),
      (this.tokenizer.lexer = this),
      (this.inlineQueue = []),
      (this.state = { inLink: !1, inRawBlock: !1, top: !0 });
    const n = { block: x.normal, inline: b.normal };
    this.options.pedantic
      ? ((n.block = x.pedantic), (n.inline = b.pedantic))
      : this.options.gfm &&
        ((n.block = x.gfm),
  ...
  static lex(e, n) {
    return new Z(n).lex(e);
  }
  static lexInline(e, n) {
    return new Z(n).inlineTokens(e);
  }
  lex(e) {
    (e = e.replace(
      /\r\n|\r/g,
  ...
  inlineTokens(e, n = []) {
    ...
    if (this.tokens.links) {
      ...
      if (c.length > 0)
        for (
          ;
          (a = this.tokenizer.rules.inline.reflinkSearch.exec(o)) != null;
    ...
    for (; (a = this.tokenizer.rules.inline.escapedEmSt.exec(o)) != null; )
      (o =
        o.slice(0, a.index + a[0].length - 2) +
        '++' +
    ...
    for (; e; )
      if (
        ...
        if ((t = this.tokenizer.autolink(e, kt))) {
          (e = e.substring(t.raw.length)), n.push(t);
          continue;
        }
        if (!this.state.inLink && (t = this.tokenizer.url(e, kt))) {
          (e = e.substring(t.raw.length)), n.push(t);
          continue;
        }
        if (
          ...
          this.options.extensions.startInline.forEach(function (d) {
            (w = d.call({ lexer: this }, h)),
              typeof w == 'number' && w >= 0 && (c = Math.min(c, w));
          }),
            c < 1 / 0 && c >= 0 && (i = e.substring(0, c + 1));
        }
        if ((t = this.tokenizer.inlineText(i, Qr))) {
          (e = e.substring(t.raw.length)),
...
`;
  ...
  heading(e, n, t, s) {
    if (this.options.headerIds) {
      const i = this.options.headerPrefix + s.slug(t);
...
`
  ...
  link(e, n, t) {
    if (((e = gt(this.options.sanitize, this.options.baseUrl, e)), e === null))
      return t;
    let s = '<a href="' + e + '"';
...
class Jt {
  ...
  getNextSafeSlug(e, n) {
    ...
    return n || ((this.seen[e] = s), (this.seen[t] = 0)), t;
  }
  slug(e, n = {}) {
    ...
    for (s = 0; s < k; s++) {
      if (
        ...
        this.options.extensions &&
          ...
          ((C = this.options.extensions.renderers[d.type].call(
            { parser: this },
            d,
          )),
          C !== !1 ||
      ...
      switch (d.type) {
        ...
        case 'heading': {
          t += this.renderer.heading(
            ...
            d.depth,
            Ht(this.parseInline(d.tokens, this.textRenderer)),
            this.slugger,
          );
          continue;
        }
        case 'code': {
          t += this.renderer.code(d.text, d.lang, d.escaped);
          continue;
        }
        case 'table': {
          for (h = '', c = '', a = d.header.length, i = 0; i < a; i++)
            c += this.renderer.tablecell(this.parseInline(d.header[i].tokens), {
              header: !0,
              align: d.align[i],
            });
          for (
            h += this.renderer.tablerow(c), w = '', a = d.rows.length, i = 0;
            i < a;
            i++
          ) {
            for (f = d.rows[i], c = '', u = f.length, o = 0; o < u; o++)
              c += this.renderer.tablecell(this.parseInline(f[o].tokens), {
                header: !1,
                align: d.align[o],
              });
            w += this.renderer.tablerow(c);
          }
          t += this.renderer.table(h, w);
          continue;
        }
        case 'blockquote': {
          (w = this.parse(d.tokens)), (t += this.renderer.blockquote(w));
          continue;
        }
        case 'list': {
          for (
                    ...
                    ? ((E.tokens[0].text = A + ' ' + E.tokens[0].text),
                      E.tokens[0].tokens &&
                        ...
                        (E.tokens[0].tokens[0].text =
                          A + ' ' + E.tokens[0].tokens[0].text))
                    : E.tokens.unshift({ type: 'text', text: A })
                  : (S += A)),
              (S += this.parse(E.tokens, g)),
              (w += this.renderer.listitem(S, O, T));
          t += this.renderer.list(w, p, m);
          continue;
        }
        case 'html': {
          t += this.renderer.html(d.text);
          continue;
        }
        case 'paragraph': {
          t += this.renderer.paragraph(this.parseInline(d.tokens));
          continue;
        }
        case 'text': {
          for (
            w = d.tokens ? this.parseInline(d.tokens) : d.text;
            s + 1 < k && e[s + 1].type === 'text';
...
` + (d.tokens ? this.parseInline(d.tokens) : d.text));
          t += n ? this.renderer.paragraph(w) : w;
          continue;
        }
        default: {
          const _ = 'Token with "' + d.type + '" type was not found.';
          if (this.options.silent) {
            console.error(_);
            return;
...
Ve(we, 'passThroughHooks', new Set(['preprocess', 'postprocess']));
function Xr(r, e, n) {
  return (t) => {
    if (
      ((t.message += `
Please report this to https://github.com/markedjs/marked.`),
      ...
      const s =
        '<p>An error occurred:</p><pre>' + N(t.message + '', !0) + '</pre>';
...
function Zt(r, e) {
  return (n, t, s) => {
    ...
    if ((Wr(t), t.hooks && (t.hooks.options = t), s)) {
      const a = t.highlight;
      let u;
      try {
        t.hooks && (n = t.hooks.preprocess(n)), (u = r(n, t));
      } catch (h) {
        return o(h);
      }
      const f = function (h) {
        ...
        if (!h)
          try {
            t.walkTokens && y.walkTokens(u, t.walkTokens),
              (w = e(u, t)),
              t.hooks && (w = t.hooks.postprocess(w));
          } catch (d) {
            h = d;
          }
        return (t.highlight = a), h ? o(h) : s(null, w);
      };
      if (!a || a.length < 3 || (delete t.highlight, !u.length)) return f();
      let c = 0;
      y.walkTokens(u, function (h) {
        h.type === 'code' &&
          (c++,
          setTimeout(() => {
            a(h.text, h.lang, function (w, d) {
              if (w) return f(w);
              d != null && d !== h.text && ((h.text = d), (h.escaped = !0)),
                c--,
                c === 0 && f();
            });
          }, 0));
    ...
    if (t.async)
      return Promise.resolve(t.hooks ? t.hooks.preprocess(n) : n)
        .then((a) => r(a, t))
        .then((a) =>
          t.walkTokens
            ? Promise.all(y.walkTokens(a, t.walkTokens)).then(() => a)
            : a,
        )
        .then((a) => e(a, t))
        .then((a) => (t.hooks ? t.hooks.postprocess(a) : a))
        .catch(o);
    try {
      t.hooks && (n = t.hooks.preprocess(n));
      const a = r(n, t);
      t.walkTokens && y.walkTokens(a, t.walkTokens);
      let u = e(a, t);
      return t.hooks && (u = t.hooks.postprocess(u)), u;
    } catch (a) {
      return o(a);
    }
  };
...
function y(r, e, n) {
  return Zt(Z.lex, W.parse)(r, e, n);
}
y.options = y.setOptions = function (r) {
  return (y.defaults = { ...y.defaults, ...r }), Ur(y.defaults), y;
};
y.getDefaults = jt;
y.defaults = G;
y.use = function (...r) {
  const e = y.defaults.extensions || { renderers: {}, childTokens: {} };
  r.forEach((n) => {
    const t = { ...n };
    if (
      ((t.async = y.defaults.async || t.async || !1),
      n.extensions &&
      ...
      const s = y.defaults.renderer || new je();
      for (const i in n.renderer) {
        const o = s[i];
        s[i] = (...a) => {
          let u = n.renderer[i].apply(s, a);
          return u === !1 && (u = o.apply(s, a)), u;
        };
      }
      t.renderer = s;
    }
    if (n.tokenizer) {
      const s = y.defaults.tokenizer || new qe();
      for (const i in n.tokenizer) {
        const o = s[i];
        s[i] = (...a) => {
          let u = n.tokenizer[i].apply(s, a);
          return u === !1 && (u = o.apply(s, a)), u;
        };
      }
      t.tokenizer = s;
    ...
    if (n.hooks) {
      const s = y.defaults.hooks || new we();
      for (const i in n.hooks) {
        const o = s[i];
        we.passThroughHooks.has(i)
          ? (s[i] = (a) => {
              if (y.defaults.async)
                return Promise.resolve(n.hooks[i].call(s, a)).then((f) =>
                  o.call(s, f),
                );
              const u = n.hooks[i].call(s, a);
              return o.call(s, u);
            })
          : (s[i] = (...a) => {
              let u = n.hooks[i].apply(s, a);
              return u === !1 && (u = o.apply(s, a)), u;
            });
      }
      t.hooks = s;
    ...
    if (n.walkTokens) {
      const s = y.defaults.walkTokens;
      t.walkTokens = function (i) {
        let o = [];
        return (
          o.push(n.walkTokens.call(this, i)),
          s && (o = o.concat(s.call(this, i))),
          o
        );
      };
    }
...
y.walkTokens = function (r, e) {
  let n = [];
  for (const t of r)
    switch (((n = n.concat(e.call(y, t))), t.type)) {
      case 'table': {
        for (const s of t.header) n = n.concat(y.walkTokens(s.tokens, e));
        for (const s of t.rows)
          for (const i of s) n = n.concat(y.walkTokens(i.tokens, e));
        break;
      }
      case 'list': {
        n = n.concat(y.walkTokens(t.items, e));
        break;
      }
      default:
        y.defaults.extensions &&
        y.defaults.extensions.childTokens &&
        y.defaults.extensions.childTokens[t.type]
          ? y.defaults.extensions.childTokens[t.type].forEach(function (s) {
              n = n.concat(y.walkTokens(t[s], e));
            })
          : t.tokens && (n = n.concat(y.walkTokens(t.tokens, e)));
    }
  return n;
};
y.parseInline = Zt(Z.lexInline, W.parseInline);
y.Parser = W;
y.parser = W.parse;
y.Renderer = je;
y.TextRenderer = Vt;
