...
import { d as nt } from './arc-CUuCntrS.js';
...
var X = (function () {
  var n = s(function (f, i, a, d) {
    ...
    p = {
      ...
      performAction: s(function (i, a, d, u, y, o, S) {
        var k = o.length - 1;
        switch (y) {
          case 1:
            return o[k - 1];
          ...
          switch (N[0]) {
            ...
            case 2:
              ...
              M &&
                ...
                y.push(z.$),
                o.push(z._$),
                (et = S[d[d.length - 2]][d[d.length - 1]]),
                d.push(et);
              break;
            case 3:
              return !0;
...
` +
        ...
        next: s(function () {
          ...
          for (var y = this._currentRules(), o = 0; o < y.length; o++)
            if (
              ((d = this._input.match(this.rules[y[o]])),
              d && (!a || d[0].length > a[0].length))
            ) {
              if (((a = d), (u = o), this.options.backtrack_lexer)) {
                if (((i = this.test_match(d, y[o])), i !== !1)) return i;
                if (this._backtrack) {
                  a = !1;
                  continue;
                } else return !1;
...
` +
        ...
        performAction: s(function (a, d, u, y) {
          switch (u) {
            case 0:
              break;
            case 1:
...
var V = '',
  ...
  ot = s(() => kt, 'getCommonDb'),
  ct = s(function () {
    (Y.length = 0), (U.length = 0), (V = ''), (W.length = 0), _t();
  }, 'clear'),
  ht = s(function (n) {
    (V = n), Y.push(n);
  }, 'addSection'),
  ...
  Lt = s(function (n, t) {
    ...
    return (
      s(g, 'ambivalent'), t.score > 3 ? h(r) : t.score < 3 ? c(r) : g(r), l
    );
  }, 'drawFace'),
  $t = s(function (n, t) {
  ...
  mt = (function () {
    ...
    s(n, 'byText');
    function t(r, h, c, g, m, p, x, b, f) {
      const { taskFontSize: i, taskFontFamily: a } = b,
        d = r.split(/<br\s*\/?>/gi);
      for (let u = 0; u < d.length; u++) {
        const y = u * i - (i * (d.length - 1)) / 2,
          o = h
            .append('text')
            .attr('x', c + m / 2)
            .attr('y', g)
    ...
    s(t, 'byTspan');
    function e(r, h, c, g, m, p, x, b) {
      const f = h.append('switch'),
        a = f
  ...
  Wt = s(function (n, t, e, l) {
    ...
    f.forEach(function (E) {
      const v = {
        ...
        L = H.getVirtualNodeHeight(p, v, r);
    ...
    for (const [E, v] of x.entries()) {
      ...
      T.debug('taskHeight before draw', A),
        (a = Math.max(a, A + 20)),
        ($ = Math.max($, v.events.length));
      let R = 0;
    ...
    T.debug('maxSectionHeight before draw', i),
      ...
      f && f.length > 0
        ? f.forEach((E) => {
            const v = x.filter((F) => F.section === E),
              L = {
                number: S,
                descr: E,
                section: S,
            ...
            const A = p.append('g'),
              R = H.drawNode(A, L, S, r);
            T.debug('sectionNode output', R),
              A.attr('transform', `translate(${y}, ${u})`),
              (o += i + 50),
              v.length > 0 && st(p, v, S, y, o, a, r, $, P, i, !1),
              (y += 200 * Math.max(v.length, 1)),
              (o = u),
              S++;
          })
        : ((k = !1), st(p, x, S, y, o, a, r, $, P, i, !0));
    ...
    T.debug('bounds', B),
      ...
      vt(
        ...
        ((_ = r.timeline) == null ? void 0 : _.useMaxWidth) ?? !1,
      );
  }, 'draw'),
  st = s(function (n, t, e, l, r, h, c, g, m, p, x) {
    var b;
    for (const f of t) {
      const i = {
        descr: f.task,
      ...
      (l = l + 200),
        x && !((b = c.timeline) != null && b.disableMulticolor) && e++;
    }
    r = r - 10;
  }, 'drawTasks'),
  Bt = s(function (n, t, e, l, r, h) {
    let c = 0;
    const g = r;
    r = r + 100;
    for (const m of t) {
    ...
    for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
      (n['lineColor' + e] = n['lineColor' + e] || n['cScaleInv' + e]),
        wt(n['lineColor' + e])
          ...
          : (n['lineColor' + e] = Et(n['lineColor' + e], 20));
    for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
      const l = '' + (17 - 3 * e);
      t += `
...
`,
  ...
  qt = Gt,
  Dt = { db: at, renderer: Ot, parser: Tt, styles: qt };
