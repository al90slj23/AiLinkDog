...
import { i as cn } from './init-Gi6I4Gst.js';
function F(n, t) {
...
function _(n) {
  let t, e, r;
  n.length !== 2
    ? ((t = F), (e = (u, c) => F(n(u), c)), (r = (u, c) => n(u) - c))
    : ((t = n === F || n === hn ? n : ln), (e = n), (r = n));
...
function vn(n, t) {
  ...
  for (i in t) i in n ? (e[i] = B(n[i], t[i])) : (r[i] = t[i]);
  return function (f) {
...
function jn(n, t) {
  return function (e, r) {
    for (
      var i = e.length, f = [], a = 0, u = n[0], c = 0;
      i > 0 &&
      u > 0 &&
      (c + u + 1 > r && (u = Math.max(1, r - c)),
      f.push(e.substring((i -= u), i + u)),
      !((c += u + 1) > r));
...
var Pn =
  /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function D(n) {
  if (!(t = Pn.exec(n))) throw new Error('invalid format: ' + n);
  var t;
  return new C({
    fill: t[1],
    align: t[2],
...
function Fn(n, t) {
  ...
  var r = e[0],
    i = e[1],
    f = i - (nn = Math.max(-8, Math.min(8, Math.floor(i / 3))) * 3) + 1,
    a = r.length;
  return f === a
    ? r
    : f > a
      ? r + new Array(f - a + 1).join('0')
      : f > 0
...
function Rn(n) {
  var t =
      n.grouping === void 0 || n.thousands === void 0
        ? J
        : jn(K.call(n.grouping, Number), n.thousands + ''),
    e = n.currency === void 0 ? '' : n.currency[0] + '',
    r = n.currency === void 0 ? '' : n.currency[1] + '',
    i = n.decimal === void 0 ? '.' : n.decimal + '',
    f = n.numerals === void 0 ? J : zn(K.call(n.numerals, String)),
    a = n.percent === void 0 ? '%' : n.percent + '',
    u = n.minus === void 0 ? '−' : n.minus + '',
    c = n.nan === void 0 ? 'NaN' : n.nan + '';
  function o(h) {
    h = D(h);
    var m = h.fill,
      p = h.align,
    ...
    function V(l) {
      ...
      if (d === 'c') (g = O(l) + g), (l = '');
        ...
        if (
          ...
          for (x = -1, X = l.length; ++x < X; )
            if (((j = l.charCodeAt(x)), 48 > j || j > 57)) {
              (g = (j === 46 ? i + l.slice(x + 1) : l.slice(x)) + g),
                (l = l.slice(0, x));
              break;
            }
        }
      ...
      T && !k && (l = t(l, 1 / 0));
      var P = N.length + l.length + g.length,
        M = P < S ? new Array(S - P + 1).join(m) : '';
      switch (
        (T && k && ((l = t(M + l, M.length ? S - g.length : 1 / 0)), (M = '')),
        p)
      ) {
        case '<':
          l = N + l + g + M;
        ...
        case '=':
          ...
          break;
        case '^':
          l = M.slice(0, (P = M.length >> 1)) + N + l + g + M.slice(P);
          break;
        default:
          l = M + N + l + g;
          break;
  ...
  function s(h, m) {
    var p = o(((h = D(h)), (h.type = 'f'), h)),
      y = Math.max(-8, Math.min(8, Math.floor(v(m) / 3))) * 3,
      b = Math.pow(10, -y),
      k = Q[8 + y / 3];
    return function (S) {
      return p(b * S) + k;
...
function Tn(n, t) {
  return Math.max(
    0,
    Math.max(-8, Math.min(8, Math.floor(v(t) / 3))) * 3 - v(Math.abs(n)),
  );
}
function In(n, t) {
...
function Cn(n, t, e) {
  var r = n[0],
    ...
    a = t[1];
  return (
    i < r ? ((r = q(i, r)), (f = e(a, f))) : ((r = q(r, i)), (f = e(f, a))),
    function (u) {
      return f(r(u));
    }
  );
...
function Vn() {
  ...
  function h(m) {
    return m == null || isNaN((m = +m))
      ? f
      : (c || (c = u(n.map(r), t, e)))(r(a(m)));
  }
  return (
    (h.invert = function (m) {
      return a(i((o || (o = u(t, n.map(r), I)))(m)));
    }),
    (h.domain = function (m) {
      return arguments.length ? ((n = Array.from(m, qn)), s()) : n.slice();
    }),
    (h.range = function (m) {
      return arguments.length ? ((t = Array.from(m)), s()) : t.slice();
    }),
    (h.rangeRound = function (m) {
      return (t = Array.from(m)), (e = bn), s();
    }),
    (h.clamp = function (m) {
      return arguments.length ? ((a = m ? !0 : A), s()) : a !== A;
    }),
    (h.interpolate = function (m) {
      return arguments.length ? ((e = m), s()) : e;
    }),
...
function Un(n, t, e, r) {
  ...
  switch (((r = D(r ?? ',f')), r.type)) {
    case 's': {
      ...
      return (
        r.precision == null && !isNaN((f = Tn(i, a))) && (r.precision = f),
        rn(r, a)
      );
    }
    case '':
    ...
    case 'r': {
      r.precision == null &&
        !isNaN((f = In(i, Math.max(Math.abs(n), Math.abs(t))))) &&
...
function Zn() {
  ...
  return (
    ...
    cn.apply(n, arguments),
    Yn(n)
  );
}
export { On as a, _ as b, Xn as c, Zn as l, wn as t };
