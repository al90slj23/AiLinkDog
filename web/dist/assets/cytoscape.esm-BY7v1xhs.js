        ...
        (function () {
          ...
          (n = Math.floor),
            ...
            (u = function (p, m, b) {
              var w;
              return (
                b == null && (b = a), (w = p[0]), (p[0] = m), g(p, 0, b), w
              );
            }),
            (l = function (p, m, b) {
              var w;
...
var $c = Uc(),
  ...
  Ct = function (e, t, a, n, i, s, o) {
    return (
      (e -= i), (t -= s), (e /= a / 2 + o), (t /= n / 2 + o), e * e + t * t <= 1
    );
  },
    ...
    },
    {
      ...
      populate: function (e, t) {
        if (e.currentSubject != null && e.currentSubject !== t)
          return (
            Le('Redefinition of subject in selector `' + e.toString() + '`'), !1
          );
        e.currentSubject = t;
        var a = e[e.length - 1],
          n = a.checks[0],
...
Lr = Ov = {
  ...
  silentShift: function (e, t) {
    return (
      Pe(e) ? this.shift(e, !0) : fe(e) && te(t) && this.shift(e, t, !0), this
    );
  },
...
rf.prototype.run = function () {
  ...
  if (i.h === 0 || i.w === 0)
    ...
    var F = function (X, Q) {
      ...
      var ae = L[X.id()];
      if (ae) (Z = ae.col * m + m / 2 + i.x1), (re = ae.row * b + b / 2 + i.y1);
      else {
        for (; A(R, M); ) I();
...
hf.getCachedImage = function (r, e, t) {
  ...
  return (
    l || ((e = e === 'null' ? null : e), (s.crossOrigin = e)), (s.src = r), s
  );
};
var aa = {};
          ...
          j && j.activate();
          {
            if (j != null && r.nodeIsGrabbable(j)) {
              ...
              if ((f(j), !j.selected()))
                ...
                y(me, { addToList: ve }), j.emit(pe('grabon')), me.forEach(Ce);
              }
    ...
    return ft(r, [
      ...
      },
      {
        ...
        value: function (t) {
          ...
          return (
            i && this.invalidateKey(n), i || this.getNumberOfIdsForKey(n) === 0
          );
        },
      },
    ]);
