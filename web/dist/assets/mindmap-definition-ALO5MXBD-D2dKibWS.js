...
import { c as pt } from './cytoscape.esm-BY7v1xhs.js';
import { c as ot, g as xt } from './react-core-4ZwCPCju.js';
        ...
        (function (D, y) {
          ...
          return (function (f) {
            ...
            function y(r) {
              ...
              return (
                f[r].call(t.exports, t, t.exports, y), (t.l = !0), t.exports
              );
            }
            return (
              (y.m = f),
              ...
              (c.prototype.getNodes = function () {
                ...
                (c.prototype.remove = function (E) {
                  ...
                  if (E instanceof o) {
                    ...
                    for (
                      var m = T.edges.slice(), L, O = m.length, d = 0;
                      d < O;
                      d++
                    )
                      (L = m[d]),
                ...
                (c.prototype.calcEstimatedSize = function () {
                  for (
                    var E = 0, T = this.nodes, m = T.length, L = 0;
                    L < m;
                    L++
                  ) {
                    var O = T[L];
              ...
              (c.RANDOM_SEED = 1),
                ...
                (c.prototype.createDummyNodesForBendpoints = function (l) {
                  for (
                    var E = [],
                      T = l.source,
                      m = this.graphManager.calcLowestCommonAncestor(
                        l.source,
                        l.target,
                      ),
                      L = 0;
                ...
                (c.prototype.createBendpointsFromDummyNodes = function () {
                  ...
                  for (var E = 0; E < l.length; E++) {
                    ...
                    if (T.bendpoints.length > 0) {
                      for (
                        var m = this.edgeToDummyNodes.get(T), L = 0;
                        L < m.length;
                        L++
                      ) {
                        var O = m[L],
            ...
            function (f, D, y) {
              ...
              (r.seed = 1),
                ...
                (r.nextDouble = function () {
                  return (
                    (r.x = Math.sin(r.seed++) * 1e4), r.x - Math.floor(r.x)
                  );
                }),
                (f.exports = r);
            },
              ...
              (a.prototype.initParameters = function () {
                  ...
                  if (this.useFRGridVariant)
                    ...
                    for (l = 0; l < L.length; l++)
                      for (T = L[l], E = l + 1; E < L.length; E++)
                        (m = L[E]),
                          T.getOwner() == m.getOwner() &&
                            this.calcRepulsionForce(T, m);
                }),
                ...
                (a.prototype.calcGrid = function (n) {
                  ...
                  for (var E = new Array(c), T = 0; T < c; T++)
                    E[T] = new Array(l);
                  for (var T = 0; T < c; T++)
                    for (var m = 0; m < l; m++) E[T][m] = new Array();
                  return E;
                }),
                ...
                (a.prototype.calculateRepulsionForceOfANode = function (
                  ...
                  if (
                    ...
                    for (
                      var m, L = this.grid, O = n.startX - 1;
                      O < n.finishX + 2;
                      O++
                    )
        ...
        (function (D, y) {
          ...
          return (function (D) {
            ...
            function r(t) {
              ...
              return (
                D[t].call(e.exports, e, e.exports, r), (e.l = !0), e.exports
              );
            }
            return (
              (r.m = D),
            ...
            for (var d = L.length, N = 0; N < d; N++) {
              ...
              if (
                (s.outerWidth() != null && s.outerHeight() != null
                  ...
                  : (u = m.add(new g(this.graphManager))),
                (u.id = s.data('id')),
...
var _t = st,
  ...
  Ut = S(() => (Z.length > 0 ? Z[0] : null), 'getMindmap'),
  Pt = S((I, w, f, D) => {
    var i, o;
    z.info('addNode', I, w, f, D);
    const y = at();
    let r =
      ((i = y.mindmap) == null ? void 0 : i.padding) ?? tt.mindmap.padding;
    switch (D) {
      case W.ROUNDED_RECT:
      case W.RECT:
      case W.HEXAGON:
...
pt.use(Gt);
async function lt(I, w, f, D, y) {
  await ee(I, w, f, D, y),
    f.children &&
      (await Promise.all(
        f.children.map((r, t) => lt(I, w, r, D < 0 ? t : D, y)),
      ));
}
S(lt, 'drawNodes');
function Et(I, w) {
  ...
  se = S((I) => {
    ...
    for (let f = 0; f < I.THEME_COLOR_LIMIT; f++)
      (I['lineColor' + f] = I['lineColor' + f] || I['cScaleInv' + f]),
        It(I['lineColor' + f])
          ? (I['lineColor' + f] = Ct(I['lineColor' + f], 20))
          : (I['lineColor' + f] = Rt(I['lineColor' + f], 20));
    for (let f = 0; f < I.THEME_COLOR_LIMIT; f++) {
      const D = '' + (17 - 3 * f);
      w += `
...
`,
  ...
  oe = ae,
  de = { db: Vt, renderer: ne, parser: _t, styles: oe };
