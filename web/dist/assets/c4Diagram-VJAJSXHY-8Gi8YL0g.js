import { d as Se, g as De } from './chunk-D6G4REZN-XYBtJUst.js';
import {
  _ as g,
  a as Pe,
  b as Be,
  ...
  var e = g(function (_t, x, m, v) {
    ...
    qt = {
      ...
      table: [
        ...
        { 1: [2, 8] },
        e(Ct, [2, 15]),
        e(Qt, [2, 17], { 21: 22, 19: 130, 22: t, 23: s, 24: o, 26: l, 28: n }),
        e(Ct, [2, 37], {
          19: 20,
          20: 21,
          21: 22,
...
var Ue = Ft,
  ...
  ze = g(function (e, t, s, o, l, n, r, i, a) {
    if (
      e == null ||
      t === void 0 ||
      t === null ||
  ...
  Xe = g(function (e, t, s, o, l, n, r) {
    if (t === null || s === null) return;
    let i = {};
    const a = V.find((u) => u.alias === t);
    if (
      (a && t === a.alias ? (i = a) : ((i.alias = t), V.push(i)),
    ...
    (i.typeC4Shape = { text: e }), (i.parentBoundary = B), (i.wrap = mt());
  }, 'addPersonOrSystem'),
  We = g(function (e, t, s, o, l, n, r, i) {
    if (t === null || s === null) return;
    let a = {};
    const u = V.find((d) => d.alias === t);
    if (
      (u && t === u.alias ? (a = u) : ((a.alias = t), V.push(a)),
      s == null ? (a.label = { text: '' }) : (a.label = { text: s }),
      o == null)
    )
      a.techn = { text: '' };
    else if (typeof o == 'object') {
    ...
    (a.wrap = mt()), (a.typeC4Shape = { text: e }), (a.parentBoundary = B);
  }, 'addContainer'),
  Qe = g(function (e, t, s, o, l, n, r, i) {
    if (t === null || s === null) return;
    let a = {};
    const u = V.find((d) => d.alias === t);
    if (
  ...
  He = g(function (e, t, s, o, l) {
    ...
    let n = {};
    const r = X.find((i) => i.alias === e);
    if (
      (r && e === r.alias ? (n = r) : ((n.alias = e), X.push(n)),
      t == null ? (n.label = { text: '' }) : (n.label = { text: t }),
      s == null)
    )
      n.type = { text: 'system' };
    else if (typeof s == 'object') {
      let [i, a] = Object.entries(s)[0];
      n[i] = { text: a };
    } else n.type = { text: s };
    if (typeof o == 'object') {
      let [i, a] = Object.entries(o)[0];
      n[i] = a;
    } else n.tags = o;
    if (typeof l == 'object') {
      let [i, a] = Object.entries(l)[0];
      n[i] = a;
    } else n.link = l;
    (n.parentBoundary = B), (n.wrap = mt()), (F = B), (B = e), xt.push(F);
  ...
  Ge = g(function (e, t, s, o, l, n, r, i) {
    if (t === null || s === null) return;
    let a = {};
    const u = X.find((d) => d.alias === t);
    if (
      (u && t === u.alias ? (a = u) : ((a.alias = t), X.push(a)),
      s == null ? (a.label = { text: '' }) : (a.label = { text: s }),
      o == null)
    )
      a.type = { text: 'node' };
  ...
  Je = g(function (e, t, s, o, l, n, r, i, a, u, d) {
  ...
  Ze = g(function (e, t, s, o, l, n, r) {
    const i = It.find((a) => a.from === t && a.to === s);
    if (i !== void 0) {
      if (o != null)
        if (typeof o == 'object') {
          let [a, u] = Object.entries(o)[0];
          i[a] = u;
        } else i.textColor = o;
      if (l != null)
        if (typeof l == 'object') {
      ...
      if (n != null)
        if (typeof n == 'object') {
          ...
          i[a] = parseInt(u);
        } else i.offsetX = parseInt(n);
      if (r != null)
        if (typeof r == 'object') {
          let [a, u] = Object.entries(r)[0];
          i[a] = parseInt(u);
  ...
  y0 = g((e, t, s) => {
    ...
    let l = 0;
    for (let n of t) {
      let r = n.textColor ? n.textColor : '#444444',
        i = n.lineColor ? n.lineColor : '#444444',
        a = n.offsetX ? parseInt(n.offsetX) : 0,
        u = n.offsetY ? parseInt(n.offsetY) : 0,
        d = '';
      if (l === 0) {
        let y = o.append('line');
        y.attr('x1', n.startPoint.x),
          y.attr('y1', n.startPoint.y),
          y.attr('x2', n.endPoint.x),
          y.attr('y2', n.endPoint.y),
          y.attr('stroke-width', '1'),
          y.attr('stroke', i),
          y.style('fill', 'none'),
          n.type !== 'rel_b' &&
            y.attr('marker-end', 'url(' + d + '#arrowhead)'),
          (n.type === 'birel' || n.type === 'rel_b') &&
  ...
  g0 = g(function (e, t, s) {
    ...
    let l = t.bgColor ? t.bgColor : 'none',
      n = t.borderColor ? t.borderColor : '#444444',
      r = t.fontColor ? t.fontColor : 'black',
      i = { 'stroke-width': 1, 'stroke-dasharray': '7.0,7.0' };
  ...
  b0 = g(function (e, t, s) {
    ...
    let o = t.bgColor ? t.bgColor : s[t.typeC4Shape.text + '_bg_color'],
      ...
      n = t.fontColor ? t.fontColor : '#FFFFFF',
      r =
    ...
    switch (
      ...
      case 'person':
      case 'external_person':
        me(i, 48, 48, t.x + t.width / 2 - 24, t.y + t.image.Y, r);
        break;
    }
  ...
  Q = (function () {
    ...
    g(t, 'byTspan');
    function s(l, n, r, i, a, u, d, f) {
      const y = n.append('switch'),
        O = y
    ...
    g(s, 'byFo');
    function o(l, n) {
      for (const r in n) n.hasOwnProperty(r) && l.attr(r, n[r]);
    }
    return (
      g(o, '_setTextAttrs'),
      function (l) {
    ...
    ((Ot = class {
      ...
      insert(t) {
        ...
        (s >= this.data.widthLimit ||
          ...
          (this.nextData.stopy = n = l + t.height),
          (this.nextData.cnt = 1)),
          (t.x = s),
          (t.y = l),
          ...
          this.updateVal(this.data, 'stopy', n, Math.max),
          ...
          this.updateVal(this.nextData, 'stopy', n, Math.max);
      }
      init(t) {
        (this.name = ''),
          (this.data = {
  ...
  if (!t[e].width)
    if (s)
      (t[e].text = Ne(t[e].text, l, o)),
        ...
        (t[e].width = l),
        (t[e].height = de(t[e].text, o));
    else {
      let n = t[e].text.split($t.lineBreakRegex);
      t[e].textLines = n.length;
      let r = 0;
      (t[e].height = 0), (t[e].width = 0);
      for (const i of n)
        (t[e].width = Math.max(Tt(i, o), t[e].width)),
          (r = de(i, o)),
...
var ke = g(function (e, t, s) {
    ...
    let n = Tt(t.label.text, l);
    j('label', t, o, l, n), z.drawBoundary(e, t, _);
  }, 'drawBoundary'),
  Ae = g(function (e, t, s, o) {
    ...
    for (const n of o) {
      l = 0;
      const r = s[n];
      let i = Pt(_, r.typeC4Shape.text);
      switch (
        ((i.fontSize = i.fontSize - 2),
        (r.typeC4Shape.width = Tt('«' + r.typeC4Shape.text + '»', i)),
        (r.typeC4Shape.height = i.fontSize + 2),
  ...
  pe = g(function (e, t) {
    ...
    return (
      ...
      s > l && o < n
        ? f >= d
          ? (y = new Y(s, i + (d * e.width) / 2))
          : (y = new Y(r - ((a / u) * e.height) / 2, o + e.height))
        : s < l && o < n
          ? f >= d
            ? (y = new Y(s + e.width, i + (d * e.width) / 2))
            : (y = new Y(r + ((a / u) * e.height) / 2, o + e.height))
          : s < l && o > n
            ? f >= d
              ? (y = new Y(s + e.width, i - (d * e.width) / 2))
              : (y = new Y(r + ((e.height / 2) * a) / u, o))
            : s > l &&
              o > n &&
              (f >= d
                ? (y = new Y(s, i - (e.width / 2) * d))
                : (y = new Y(r - ((e.height / 2) * a) / u, o))),
      y
    );
  }, 'getIntersectPoint'),
  ...
  R0 = g(function (e, t, s, o) {
    ...
    for (let n of t) {
      ...
      o.db.getC4Type() === 'C4Dynamic' &&
        (n.label.text = l + ': ' + n.label.text);
      let u = Tt(n.label.text, i);
      j('label', n, r, i, u),
        n.techn &&
          n.techn.text !== '' &&
          ((u = Tt(n.techn.text, i)), j('techn', n, r, i, u)),
        n.descr &&
          n.descr.text !== '' &&
          ((u = Tt(n.descr.text, i)), j('descr', n, r, i, u));
      let d = s(n.from),
        f = s(n.to),
        y = O0(d, f);
      (n.startPoint = y.startPoint), (n.endPoint = y.endPoint);
    }
    z.drawRels(e, t, _);
  }, 'drawRels');
function se(e, t, s, o, l) {
  let n = new Ee(l);
  n.data.widthLimit = s.data.widthLimit / Math.min(ee, o.length);
  for (let [r, i] of o.entries()) {
    ...
    (i.image = { width: 0, height: 0, Y: 0 }),
      i.sprite &&
        ...
        (i.image.height = 48),
        (i.image.Y = a),
        (a = i.image.Y + i.image.height));
    let u = i.wrap && _.wrap,
      d = Ut(_);
    if (
      ((d.fontSize = d.fontSize + 2),
      (d.fontWeight = 'bold'),
      j('label', i, u, d, n.data.widthLimit),
      (i.label.Y = a + 8),
      (a = i.label.Y + i.label.height),
      i.type && i.type.text !== '')
    ) {
      i.type.text = '[' + i.type.text + ']';
      let O = Ut(_);
      j('type', i, u, O, n.data.widthLimit),
        (i.type.Y = a + 5),
        (a = i.type.Y + i.type.height);
    }
    if (i.descr && i.descr.text !== '') {
      let O = Ut(_);
      (O.fontSize = O.fontSize - 2),
        j('descr', i, u, O, n.data.widthLimit),
        (i.descr.Y = a + 20),
        (a = i.descr.Y + i.descr.height);
    }
    if (r == 0 || r % ee === 0) {
      let O = s.data.startx + _.diagramMarginX,
        S = s.data.stopy + _.diagramMarginY + a;
      n.setData(O, O, S, S);
    } else {
      let O =
          n.data.stopx !== n.data.startx
            ? n.data.stopx + _.diagramMarginX
            : n.data.startx,
        S = n.data.starty;
      n.setData(O, O, S, S);
    }
    n.name = i.alias;
    let f = l.db.getC4ShapeArray(i.alias),
      y = l.db.getC4ShapeKeys(i.alias);
    y.length > 0 && Ae(n, e, f, y), (t = i.alias);
    let E = l.db.getBoundarys(t);
    E.length > 0 && se(e, t, n, E, l),
      i.alias !== 'global' && ke(e, i, n),
      (s.data.stopy = Math.max(n.data.stopy + _.c4ShapeMargin, s.data.stopy)),
      (s.data.stopx = Math.max(n.data.stopx + _.c4ShapeMargin, s.data.stopx)),
...
var S0 = g(function (e, t, s, o) {
    ...
    l === 'sandbox' && (n = jt('#i' + t));
    const r =
      l === 'sandbox' ? jt(n.nodes()[0].contentDocument.body) : jt('body');
    let i = o.db;
    o.db.setWrap(_.wrap),
      (ve = i.getC4ShapeInRow()),
      (ee = i.getC4BoundaryInRow()),
      fe.debug(`C:${JSON.stringify(_, null, 2)}`);
    const a = l === 'sandbox' ? r.select(`[id="${t}"]`) : jt(`[id="${t}"]`);
    ...
    se(a, '', u, f, o),
      z.insertArrowHead(a),
      z.insertArrowEnd(a),
      z.insertArrowCrossHead(a),
      z.insertArrowFilledHead(a),
      R0(a, o.db.getRels(), o.db.getC4Shape, o),
      (u.data.stopx = Xt),
      (u.data.stopy = Wt);
    const y = u.data;
  ...
  ye = { drawPersonOrSystemArray: Ae, drawBoundary: ke, setConf: ne, draw: S0 },
  D0 = g(
    (e) => `.person {
